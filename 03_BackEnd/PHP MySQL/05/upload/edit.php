...
<?php
	...
	if( isset($_POST['akcija']) and $_POST['akcija']=='update' ){ 
		...
		$nivo_obrazovanja = $db->real_escape_string( $_POST['nivo_obrazovanja'] ); //radio
...
<body>
	<div class="container">
		<form method="post" action="edit.php" enctype="multipart/form-data">
			...
			<br/>
			Nivo obrazovanja
			<select name="nivo_obrazovanja">
				<option <?php if($red->nivo_obrazovanja=='nkv') echo 'selected'; ?> value="nkv">NKV</option>
				<option <?php if($red->nivo_obrazovanja=='kv') echo 'selected'; ?> value="kv">KV</option>
				<option <?php if($red->nivo_obrazovanja=='vkv') echo 'selected'; ?> value="vkv">VKV</option>
				<option <?php if($red->nivo_obrazovanja=='dr') echo 'selected'; ?> value="dr">Dr</option>
			</select><br/>
