...
public function setGodiste($g){
    ...
    ///metoda toString sluzi da podeli objekat u pojdinacne stringove.
    public function __toString()
    {
       return "Ime osobe je ".$this->getIme()." prezime osobo je: ".$this->getPrezime()." godiste osobe je: ".$this->getGodiste(); 
    }
