            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">                
                  ...
                  <!-- ovde je bilo dodavanje produkta -->
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <!-- isSeen je boolean, if prolazi ako nije isSeen == true (ili == 0) -->
                        <c:if test="${!reservation.isSeen}">                        
                        <!-- ubaceno iz admin/index.html  -->
                        <!-- kad se klikne, poziva se akcija: reservation-seen i salje id na koji je kliknuto -->
                    		<a href="reservation-seen?id=${reservation.id}" class="btn btn-block bg-gradient-primary">MARK AS SEEN</a>
                 	 	</c:if>
                 	 	
		              </td>                       
                    </tr>
                            <!-- ovde su bili dugmici za Delete i Update -->  
