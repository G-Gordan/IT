                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <article class="clearfix">
                                            <p class="center-block text-center">Prikazuje se: ${productList.size()} jela</p>
                                        </article>
                                    </div>
                                    <div class="col-sm-6">
                                        <article class="clearfix">
                                            <form class="center-block" role="form" action="products-page-order">
                                                <div class="form-group center-block text-center">
                                                    ...
                                                    <select class="form-control" id="sel1" name="orderBy">
                                                        <option value="0">By date created</option> <!-- sortira po id-ju kao da je vreme kreiranja -->
                                                        <option value="1">By name</option>
                                                        <option value="2">By price lower first</option>
                                                        <option value="3">By price higher first</option>
                                                        </select>
                                                    </li>
                                                    <li>                                                    
