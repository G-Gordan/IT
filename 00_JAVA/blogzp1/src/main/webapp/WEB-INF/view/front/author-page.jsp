        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <h2 class="mb-3 author d-flex align-items-center flex-wrap">
              ...
              <div class="avatar"><img src="${author.photo}" alt="..." class="img-fluid rounded-circle"></div>
                <div class="title">
            ...
            <div class="row">
             ...
             <c:forEach var="authorBlog" items="${authorBlogs}">              
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="blog-item-page?id=${authorBlog.id}"><img src="${authorBlog.image}" alt="..." class="img-fluid"></a></div>
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    <div class="date meta-last">${authorBlog.blogCreatTempForm}</div>
                    <div class="category"><a href="blog-page-filter?id=${authorBlog.category.id}&type=category">${authorBlog.category.name}</a></div>
                  </div>                  
                  <a href="blog-item-page?id=${authorBlog.id}">
                    <h3 class="h4">${authorBlog.blogTitle}</h3></a>
                  <p class="text-muted">${authorBlog.description}</p>
                  <footer class="post-footer d-flex align-items-center">
                  <a href="#" class="author d-flex align-items-center flex-wrap">
                      <div class="avatar"><img src="${authorBlog.author.photo}" alt="..." class="img-fluid"></div>
                      <div class="title"><span>${authorBlog.author.name}</span></div></a>                      
                    <div class="date"><i class="icon-clock"></i>${authorBlog.blogCreatTempForm}</div>
                    <div class="comments meta-last"><i class="icon-comment"></i>${authorBlog.commentNumb}</div>
                  </footer>
                </div>
              </div>              
 			</c:forEach>
