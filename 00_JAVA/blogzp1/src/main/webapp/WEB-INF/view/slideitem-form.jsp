...
<head>
  ...
  <title>Blog Project - Slide Item Form</title>
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Slide Item Form</h3>
              </div>
              <!-- /.card-header -->             
 
              <!-- form start -->
              <form:form role="form" action="slideitem-save" modelAttribute="slideitem">
              <form:hidden path="id"/>
              ...
              <div class="form-group">
                    ...
                    <form:input path="itemTitle" type="text" class="form-control" placeholder="Enter name"/>
                  	<form:errors class="text-danger" path="itemTitle"/>
              </div>
              ...
              <div class="form-group">
                    ...
                    <form:input path="bTitle" type="text" class="form-control" placeholder="Enter description"/>
                  	<form:errors class="text-danger" path="bTitle"/>
              </div>
                  
              <div class="form-group">
                    <label>Button Link</label>
                    <form:input path="bLink" type="text" class="form-control" placeholder="Enter description"/>
                  	<form:errors class="text-danger" path="bLink"/>
              </div>
              
              <div class="form-group">
                    <label>Order By Numbering</label>
                    <form:input path="numbering" type="text" class="form-control" placeholder="Enter number to line up"/>
                  	<form:errors class="text-danger" path="numbering"/>
              </div>
              
                  <!-- iskopirano iz index.html -->
				  <div class="custom-control custom-checkbox">
<!-- putanja je "enambed", znaci da podatke ubacuje u fild "enabled" objekta "slideitem" -->
                     <form:checkbox class="custom-control-input" id="customCheckbox1" path="enabled"/>
                     <label for="customCheckbox1" class="custom-control-label">Enabled</label>
                   </div>
