...
<head>
  ...
  <title>Blog Project - Blog List</title>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <form class="center-block" role="form" action="blog-sort">                   
                 <table class="table table-bordered">                
                  <tbody id="sort-list">                  
                    <tr>
                      <td style="width: 90%">                      
                           <select class="form-control" id="sel1" name="orderBy">
                           <option value="0">All Blogs By Id</option> <!-- sortira po id-ju kao da je vreme kreiranja -->
                           <option value="1">Sort By Category</option>
                           <option value="2">Sort By Author Username</option>
                           </select>
                      </td>
                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th style="width: 50%;">Blog Title</th>
                      <th style="width: 25%;">Blog Author (username)</th>
                  ...
                  <tbody id="sort-list">
                   ...
                   <c:forEach var="blog" items="${blogList}">
                    <tr>
                      ...
                      <td>
                        ${blog.author.name} ${blog.author.surname} (${blog.author.username})
                      </td>
