...
<head>
  ...
  <title>Blog Project - Blog Form</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Blog Form - NOTICE: Only bloggers can create a blog</h1>
          </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
			...
			<c:if test="${!isUserBloger}"> 
				<div class="alert alert-warning alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  <h5><i class="icon fas fa-info"></i> Alert!</h5>
                  Sorry but you should have read the warning above: Only bloggers can create a blog!
                </div>
			</c:if> 
                
                  <div class="form-group">
                    <label>Blog Title</label>
                    <form:input path="blogTitle" type="text" class="form-control" placeholder="Enter Blog Title"/>
                  	<form:errors class="text-danger" path="blogTitle"/>
                  </div>
 
                  <div class="form-group">
                    <label>Blog Text</label>
                    <form:textarea path="blogText" type="textarea" class="form-control" placeholder="Enter Blog Text"/>
                  </div>                  
                  ...
                  <div class="form-group">
                    ...
                    <form:select class="form-control" path="category.id" itemLabel="name" itemValue="id" items="${categoryList}"/>
                  </div>
                  
                  <div class="form-group">
                    <label>Blog Tags</label>                        
                    <form:select class="form-control" multiple="true" path="tags" itemLabel="name" itemValue="id" items="${tagList}"/>
				  </div>
                  
                  <!-- iskopirano iz index.html -->
				  <div class="custom-control custom-checkbox">
       <!-- putanja je "isImportant", znaci da podatke ubacuje u fild "isImportant" objekta "blog" -->
                     <form:checkbox class="custom-control-input" id="customCheckbox1" path="isImportant"/>
                     <label for="customCheckbox1" class="custom-control-label">Is Important</label>
                   </div>
                             
                  <!-- iskopirano iz index.html -->
				  <div class="custom-control custom-checkbox">
       <!-- putanja je "isOnPage", znaci da podatke ubacuje u fild "isOnPage" objekta "category" -->
                     <form:checkbox class="custom-control-input" id="customCheckbox2" path="isOnPage"/>
                     <label for="customCheckbox2" class="custom-control-label">Show on Page</label>
                   </div>
