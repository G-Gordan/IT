...
<head>
  ...
  <title>Blog Project - Message List</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">                 
                  ...
                  <a href="message-form" class="btn btn-success">
                ...
                <table class="table table-bordered">                
                  <thead>                  
                    <tr>
                      ...
                      <th class="text-center">Is Seen</th>
                    ...
                    <tr>
                      ...
                      <td>
                 	  ...
                 	  <td>
                        ${message.messText}
               		  ...
               		  <td>                     
                      <!-- isSeen je boolean, if prolazi ako nije isSeen == true (ili == 0) -->
                        ...
                        <!-- kad se klikne, poziva se akcija: message-seen i salje id na koji je kliknuto -->
                    		<a href="message-seen?id=${message.id}" class="btn btn-block bg-gradient-primary">IS SEEN</a>
                 	 	</c:if>                 	 	
		              </td>
		              ...
		              <td class="text-center">
                        <div class="btn-group">
                          ...
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${message.id}">
