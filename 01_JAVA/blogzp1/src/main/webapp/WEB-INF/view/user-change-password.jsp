...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge">
    ...
    <title>Blog Project - Change Password</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>User Change Password Form</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">User Change Password Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <!-- action -> salje podatke, modelAttribute -> prihvata podatke -->
              <form:form action="user-change-password-action" modelAttribute="changePassword" role="form">      
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <form:input type="password" class="form-control" placeholder="Confirm New Password" path="confirmPassword"/>
