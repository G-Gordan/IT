...
<html>
  <head>
    ...
    <title>Blog Project - Blogs Page</title>
          ...
          <div class="container">
            ...
            <c:forEach var="blog" items="${blogs}">     
              ...
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="blog-item-page?id=${blog.id}"><img src="${blog.image}" alt="..." class="img-fluid"></a></div>
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    <div class="date meta-last">${blog.blogCreatTempForm}</div>
                    <div class="category"><a href="blog-page-filter?id=${blog.category.id}&type=category">${blog.category.name}</a></div>
                  </div><a href="blog-item-page?id=${blog.id}">
                    <h3 class="h4">${blog.blogTitle}</h3></a>
                  <p class="text-muted">${blog.description}</p>
                  <footer class="post-footer d-flex align-items-center"><a href="author-page?username=${blog.author.username}" class="author d-flex align-items-center flex-wrap">
                      <div class="avatar"><img src="${blog.author.photo}" alt="..." class="img-fluid"></div>
                      <div class="title"><span>${blog.author.name}</span></div></a>
                    <div class="date"><i class="icon-clock"></i>${blog.blogCreatTempForm}</div>
                    <div class="comments meta-last"><i class="icon-comment"></i>${blog.commentNumb}</div>
                  </footer>
                </div>
              </div>
            </c:forEach>
