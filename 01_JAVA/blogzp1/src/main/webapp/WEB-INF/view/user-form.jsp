...
<head>
  ...
  <title>Blog Project - User Form</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card card-primary">
              ...
              <form:form role="form" action="user-save" modelAttribute="user">
                ...
                <div class="form-group">
              	...
              	<div class="form-group">
                    <label>Photo</label>
                    <form:input path="photo" type="text" class="form-control" placeholder="Enter Photo"/>
       ...
       <!-- putanja je "enabled", znaci da podatke ubacuje u fild "enabled" objekta "comment" -->
