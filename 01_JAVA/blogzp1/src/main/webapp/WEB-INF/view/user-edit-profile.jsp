...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge">
    ...
    <title>Blog Project - Edit Profile</title>
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">User Edit Profile Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label>Name</label>
                        <form:input class="form-control" placeholder="Edit Name" path="name"/>
                        <form:errors class="text-danger" path="name"/>
                      </div>
                      <div class="form-group">
                        <label>Surname</label>
                        <form:input class="form-control" placeholder="Edit Surname" path="surname"/>
                        <form:errors class="text-danger" path="surname"/>
                      </div>
                      <div class="form-group">
                        <label>Email</label>
                        <form:input class="form-control" placeholder="Edit Email" path="email"/>
                        <form:errors class="text-danger" path="email"/>
                      </div> 
                      <div class="form-group">
                        <label>Phone</label>
                        <form:input class="form-control" placeholder="Enter Surname" path="phone"/>
                        <form:errors class="text-danger" path="phone"/>
                      </div> 
                      <div class="form-group">
                        <label>Photo</label>
                        <form:input class="form-control" placeholder="Enter Surname" path="photo"/>
