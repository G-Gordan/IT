...
<head>
  ...
  <title>Blog Project - Slide Item List</title>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Slide Items</h3>
                <div class="card-tools">
                 
                    
                  <a href="slideitem-form" class="btn btn-success">
                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th style="width: 10%;">Button Title</th>
                      <th style="width: 20%;">Button Link</th>
                      <th style="width: 5%;">Numbering</th>
                      <th class="text-center">Actions</th>
                    </tr>
                  </thead>
                  <tbody id="sort-list">
                   
                   <c:forEach var="slideitem" items="${slideitemList}">
                    <tr>
                       <td>
                        ${slideitem.id}
                      </td>	                    
                      ...
                      <td>
                        <strong>${slideitem.bTitle}</strong>
                      </td>
                      <td>
                        ${slideitem.bLink}
                      </td>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="slideitem-form-update?id=${slideitem.id}" class="btn btn-info">
                            <i class="fas fa-edit"></i> <!-- dugme za menjenje - update -->
                          </a>
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${slideitem.id}">
                 ...
                 <!-- dijalog da samo sigurni da cemo da brisemo - DELETE -->
                    <div class="modal fade" id="delete-modal-${slideitem.id}">
				      <div class="modal-dialog">
				        <div class="modal-content">
				          <div class="modal-header">
				            <h4 class="modal-title">Delete Slide Item</h4>
				            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				              <span aria-hidden="true">&times;</span>
				            </button>
				          </div>
				          <div class="modal-body">
				            <p>Are you sure you want to delete Slide Item?</p>
				            <strong></strong>
				          </div>
				          <div class="modal-footer justify-content-between">
				            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
				            <a href="slideitem-delete?id=${slideitem.id}" class="btn btn-danger">Delete</a>
				          </div>
				        </div>
				        <!-- /.modal-content -->
				      </div>
