                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Name</label>
                        <!-- putanja je "name", znaci da podatke ubacuje u fild "name" objekta "product" -->
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <form:input type="text" class="form-control" placeholder="Enter recipe name" path="recept.name"/>
                        <form:errors class="text-danger" path="recept.name"/>
                      </div>
                      <div class="form-group">
                        <label>Recipe description</label>
                        <form:textarea class="form-control" placeholder="Enter recipe description" path="recept.description"/>
                        <form:errors class="text-danger" path="recept.description"/>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <!-- izbrisan ceo div sa starim tagovima na cekiranje -->
	                     ...
	                     <!-- iskopirano iz index.html - da li je na glavnoj strani (Main Page)-->
					  <div class="custom-control custom-checkbox">
	       <!-- putanja je "isOnMainPage", znaci da podatke ubacuje u fild "isOnMainPage" objekta "product" -->
	                     ...
	                     <label for="customCheckbox1" class="custom-control-label">Show on Main Page</label>
	                   	                     ...
	                   	                     <!-- checkbox - da li da bude u Meniju -->
					  <div class="custom-control custom-checkbox">
	       <!-- putanja je "isOnMenu", znaci da podatke ubacuje u fild "isOnMenu" objekta "product" -->
