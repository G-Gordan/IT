...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DateTimePicker2.Value = New Date(2016, 8, 18, 0, 0, 0, 0)
        '
        'Label13
        '
...
#End Region
    ...
    Private Sub Unos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If MasterAction = "Upd" Or RecordAction = "P" Then
            ...
            If mVrstaObracuna = "CO" Or mVrstaObracuna = "IC" Or mVrstaObracuna = "CD" Then 'novo 11.5.2011
    ...
    Private Sub btnUpis_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpis.Click
        ...
        End If
        '-----------------------------
        Dim Danas As Date = Today()
        Dim D1, D2 As DateTimePicker
        Dim D1T, D2T As Date
        D1 = DatumOtp
        D2 = DateTimePicker2
        ...
        'If ((D1T > Danas) Or (D2T > Danas) Or (D1T > D2T)) Then
