Module InitVar
    Friend i_Pronasao As Int32 = 0
    Friend mNizRidCo(16) As String
    Friend nmNarPos As Boolean = False
    Friend nmBrTelegram As String = "" 'Broj narocite posiljke a ne telegrama!

    Friend mPkola = False
    Friend nmBMV As Decimal = 0
    ...
    Friend _nmNakVER As String = ""
    Friend _mTipUti As String = ""
    Friend m_UicPrevozniPut As String = ""
    Friend nmUpravaNext As String = ""
    ...
    Friend nmNextOperater As String = ""
    ...
    Friend UicCol0a As DataColumn = dtUic.Columns.Add("Operater", Type.GetType("System.String")) 'test operater
    ...
    'Friend UicCol24 As DataColumn = dtUic.Columns.Add("Operater", Type.GetType("System.String")) 'operater
    ...
    Friend korCol10a As DataColumn = dtKorekcija.Columns.Add("NHMUTI", Type.GetType("System.String"))
    ...
    Friend dsDSKorekcija As New DataSet("dsKorekcijaDS") 'TEST dataseta!! 27,01,2012


    Friend dtUpdKorekcija As DataTable = New DataTable("UPDKOREKCIJA")
    Friend updCol0 As DataColumn = dtUpdKorekcija.Columns.Add("RBR", Type.GetType("System.Int32"))
    Friend updCol1 As DataColumn = dtUpdKorekcija.Columns.Add("Mesec", Type.GetType("System.String"))
    Friend updCol2 As DataColumn = dtUpdKorekcija.Columns.Add("Godina", Type.GetType("System.String"))
    Friend updCol3 As DataColumn = dtUpdKorekcija.Columns.Add("Ugovor", Type.GetType("System.String"))
    Friend updCol4 As DataColumn = dtUpdKorekcija.Columns.Add("Najava", Type.GetType("System.String"))
    Friend updCol5 As DataColumn = dtUpdKorekcija.Columns.Add("IBK", Type.GetType("System.String"))
    Friend updCol6 As DataColumn = dtUpdKorekcija.Columns.Add("Tara", Type.GetType("System.Int32"))
    Friend updCol7 As DataColumn = dtUpdKorekcija.Columns.Add("NHM", Type.GetType("System.String"))
    Friend updCol8 As DataColumn = dtUpdKorekcija.Columns.Add("Masa", Type.GetType("System.Int32"))
    Friend updCol9 As DataColumn = dtUpdKorekcija.Columns.Add("RecID", Type.GetType("System.Int32"))
    Friend updCol10 As DataColumn = dtUpdKorekcija.Columns.Add("KS", Type.GetType("System.Int32"))
    Friend updCol11 As DataColumn = dtUpdKorekcija.Columns.Add("RS", Type.GetType("System.Int32"))
    Friend dsDSUpdKorekcija As New DataSet("dsUpdKorekcijaDS")
    ...
    Friend rCol2 As DataColumn = dtNhm.Columns.Add("UTINHM", Type.GetType("System.String")) ' !!redosled:                     9 roba u konteneru [GRANICA]
    Friend rCol3 As DataColumn = dtNhm.Columns.Add("Masa", Type.GetType("System.Int32")) ' 15.                                2 Stvarna masa pošiljke
    Friend rCol4 As DataColumn = dtNhm.Columns.Add("R", Type.GetType("System.String")) ' 14.                                  3
    Friend rCol5 As DataColumn = dtNhm.Columns.Add("UTI", Type.GetType("System.String")) ' 18.                                5 tip 
    Friend rCol6 As DataColumn = dtNhm.Columns.Add("RID", Type.GetType("System.String")) ' 17.                                4
    Friend rCol7 As DataColumn = dtNhm.Columns.Add("UTIIB", Type.GetType("System.String")) '                                  6 Ind. broj kontenera [GRANICA]
    Friend rCol8 As DataColumn = dtNhm.Columns.Add("UTITara", Type.GetType("System.Int32")) '                                 7 tara kontenera [GRANICA]
    Friend rCol9 As DataColumn = dtNhm.Columns.Add("UTIRaster", Type.GetType("System.Decimal")) '                             8 primenjeni raster
    Friend rCol10 As DataColumn = dtNhm.Columns.Add("UTIBuletin", Type.GetType("System.String")) '                           10 predajni list [GRANICA]
    Friend rCol11 As DataColumn = dtNhm.Columns.Add("UTIPlombe", Type.GetType("System.String")) '                            11 broj plombi [GRANICA]
    ...
    Friend bNHM8606 As Boolean = False
    ...
    Friend bNPUkupno As Integer = 1
    Friend bNPKoef As Decimal = 1
    Friend bNPDodatak As Decimal = 0

    Friend bStavPoToni As Boolean
    Friend tObrMes As String

    Friend bNMV As Decimal = 0

    Friend bSvaPrivatna As Boolean = False

    Friend bSumaDinari As Decimal = 0
    Friend bOutKurs As Decimal = 0
