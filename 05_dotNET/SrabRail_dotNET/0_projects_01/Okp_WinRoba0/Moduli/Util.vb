...
Module Util
    ...
    Public Sub IzjavaZs_Ex_CO()
        ...
        NadjiKurs(bValuta, bVrstaKursa, mOtpDatum, mOutKurs, strRetVal)
                ...
                For Each KolaRed In dtKola.Rows
                    ...
                    If Left(KolaRed.Item("IndBrojKola"), 2) = "03" Or Left(KolaRed.Item("IndBrojKola"), 2) = "04" Or _
                       ...
                       Left(KolaRed.Item("IndBrojKola"), 2) = "88" Or Left(KolaRed.Item("IndBrojKola"), 2) = "89" Then
                        ...
                        If mBrojUg = "101001" Or mBrojUg = "101096" Or _
                           ...
                           mBrojUg = "811501" Or mBrojUg = "811596" Or _
                           mBrojUg = "601601" Then

                            If bSvaPrivatna = False Then
                                KolaRed.Item("Naknada") = -60               ' 1.6.2016
                            Else
                                KolaRed.Item("Naknada") = 0                 ' 1.6.2016
                            End If
                            'KolaRed.Item("Naknada") = -60                  ' 1.6.2016
                        End If
                    End If
                    ...
                    If KolaRed.Item("Vlasnik") = "Z" Then
                        If mBrojUg = "061433" Or mBrojUg = "801433" Or mBrojUg = "811433" Or mBrojUg = "981444" Or _
                           ...
                           mBrojUg = "801533" Or mBrojUg = "811533" Or mBrojUg = "981544" Or mBrojUg = "961533" Or mBrojUg = "111666" Or _
                           mBrojUg = "601633" Or mBrojUg = "961633" Or mBrojUg = "981633" Then
                            ...
                            Else
                                If mBrojUg = "961533" Then
                                    ...
                                    Else
                                        KolaRed.Item("Naknada") = 52
                                    End If
                                ElseIf mBrojUg = "111666" Then                                                  '21.04.2016
                                    If KolaRed.Item("Osovine") < 6 Then
                                        KolaRed.Item("Naknada") = 39
                                    Else
                                        KolaRed.Item("Naknada") = 52
                                    End If
                                ElseIf mBrojUg = "601633" Or mBrojUg = "961633" Or mBrojUg = "981633" Then      '21.04.2016
                                    If KolaRed.Item("Osovine") < 6 Then
    ...
    End Sub
    Public Sub bNadjiNetoMasuVoza(ByVal _mBrojUg As String, ByVal _mNajava As String, _
                                     ByRef _NetoMasaVoza As Decimal, ByRef _rv As String)
        ...
        If mCistUnos = "Da" Or AkcijaZaPreuzimanje = "Da" Then
            ...
            'Next
            For Each NHMRed In dtNhm.Rows
                mNetoMasaTmp = mNetoMasaTmp + NHMRed.Item("Masa")
            Next
        Else
            mNetoMasaTmp = 0
        End If
        ...
        'Dim spKomanda As New SqlClient.SqlCommand("dbo.NadjiBrutoMasuVoza", OkpDbVeza)
        Dim spKomanda As New SqlClient.SqlCommand("roba1708.NadjiNetoMasuVoza", OkpDbVeza)
        spKomanda.CommandType = CommandType.StoredProcedure
        ...
        exNetoMasa.Scale = 0
        exNetoMasa.Direction = ParameterDirection.Output
        spKomanda.Parameters("@outNetoMasa").Value = _NetoMasaVoza
        ...
        Try
            spKomanda.ExecuteScalar()
            _NetoMasaVoza = spKomanda.Parameters("@outNetoMasa").Value
            _NetoMasaVoza = _NetoMasaVoza + mNetoMasaTmp
        Catch SQLExp As SqlException
            _rv = SQLExp.Message & " Greska - Bruto masa voza!"
        Catch Exp As Exception
            _rv = Err.Description & " Greska - Bruto masa voza!"
