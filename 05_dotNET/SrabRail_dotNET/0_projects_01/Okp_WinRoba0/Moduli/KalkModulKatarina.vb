...
Module KalkModulKatarina             '09.01.2015
    Public Sub bNadjiPrevozninuROKP(ByRef kPrevoznina As Decimal, ByRef kPovVrROKP As String)
        ...
        Dim Tara As Integer '22/12/2014
        Dim MasaTemp1 As Integer
        Dim MasaTempT As Decimal = 0
        Dim MinRacMasa As Int16 = 5
        Dim MinMasa As Decimal = 0
        Dim RacMasaPoKolima As Integer
        Dim BrutoMasaPoKolima As Integer
        Dim BrutoMasaPoKolimaT As Integer
        Dim RacMasaPoKolimaZ As Decimal
        ...
        Dim PrevozninaPoUg, PrevozninaZaVoz, kPrevMin As Decimal
        ...
        Dim Voz As Decimal
        Dim BrutoMasa, kBrutoMasaOd, kBrutoMasaDo As Decimal
        ...
        Dim PomMasa1 As Integer = 0
        Dim PomMasa2 As Integer = 0
        'Dim MasaTempK As Integer = 0
        Dim KolaZ As String

        kSpecKola = "N"

        Dim Stavka As Integer = 1
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                kSpecKola = KolaRed.Item("Vrsta")

                If kVlasn = "Z" Then
                    KolaZ = Microsoft.VisualBasic.Mid(IBK, 3, 2)
                    'If KolaZ = "72" Then KolaZ = "00"
                Else : KolaZ = "00"
                End If
                ...
                If kSpecKola = "S" Or kSpecKola = "D" Then
                    kSpecKola = "D"
                Else
                    kSpecKola = "N"
                End If
                ...
                ' Tarifa 2015
                'bNadjiSveIzZSKoefPos(bVrstaSaobracaja, mTarifa, bVrstaPosiljke, bVrstaStanice, kVlasn, _
                '                      TovarenaPrazna, bMinPrevoznina, bDodPrevoznina, bKoef, bKoefNak, bKoefInd, bKoefInd1, bKoefRid, _
                '                      bPouzece, bPredujam, mDatumKalk, bRedovanOrocen, bValuta, bRetVal)


                kPrevMin = bMinPrevoznina * dtKola.Rows.Count
                ...
                If dtNhm.Rows.Count > 0 Then
                    ...
                    For Each NHMRed In dtNhm.Rows
                        ...
                        If NHMRed.Item("IndBrojKola") = IBK Then
                            ...
                            BrutoMasaPoKolimaT = BrutoMasaPoKolima / 1000
                            ...
                            ElseIf IzborSaobracaja = 3 Then
                                ...
                                DoStan = mStanica2
                            End If
                            If Microsoft.VisualBasic.Left(kNhm, 4) = "9921" Or Microsoft.VisualBasic.Left(kNhm, 4) = "9922" Or Microsoft.VisualBasic.Left(kNhm, 4) = "9931" Then
                                kStatus = "P"
                                OdStan = mStanica2
                                DoStan = mStanica1
                            Else
                            ...
                            If mVrstaPrevoza = "P" Then
                                k11NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, KolaZ, kStatus, OdStan, DoStan, _
                                                  kNacinObrac, bValuta, kBrOsov, kSpecKola, kIznosMinPrev, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU2, TipUTI, kPovVr)
                            ElseIf mVrstaPrevoza = "G" Then                                
                                k1GNadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, KolaZ, kStatus, OdStan, DoStan, _
                                                   kNacinObrac, bValuta, kBrOsov, kSpecKola, kIznosMinPrev, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU2, TipUTI, kPovVr)
                            Else                                           
                            ...
                            If kNacinObrac = 1 Then
                                ...
                                If mVrstaPrevoza = "P" Then
                                    ...
                                    PrevozninaPoUgP = Pojed
                                    bZaokruziNaDeseteNavise(PrevozninaPoUgP)
                                    PrevozninaPoUgP = PrevozninaPoUgP + PrevP
                                End If
                                If mVrstaPrevoza = "G" Then   'da li je ovo dobro???
                                    NHMRed.Item("VozarinskiStavNHM") = Grupa
                                    NHMRed.Item("RacMasaNHM") = MasaTemp
                                    PrevozninaPoUgG = Grupa
                                    bZaokruziNaDeseteNavise(PrevozninaPoUgG)
                                    PrevozninaPoUgG = PrevozninaPoUgG + PrevG
                                End If
                                If mVrstaPrevoza = "V" Then
                                    ...
                                    PrevozninaPoUgV = PrevozninaPoUgV + PrevV
                                End If
                                ...
                                If PrevozninaPoUg <= bMinPrevoznina Then
                                    PrevozninaPoUg = bMinPrevoznina
                                End If
                            ...
                            ElseIf kNacinObrac = 2 Then
                                ...
                                If mVrstaPrevoza = "P" Then
                                    bZaokruziNaDeseteNavise(PrevP)
                                    bZaokrMasuNaOsovineK(MasaTemp, bSvaTovarena, kBrOsov, MasaTempT)

                                    PrevP = MasaTempT * Pojed
                                    PrevozninaPoUg = PrevP
                                ...
                                If mVrstaPrevoza = "G" Then
                                    bZaokrMasuNaOsovineK(MasaTemp, bSvaTovarena, kBrOsov, MasaTempT)
                                    PrevG = MasaTempT * Grupa
                                    bZaokruziNaDeseteNavise(PrevozninaPoUg)
                                    If PrevG <= bMinPrevoznina Then
                                        PrevG = bMinPrevoznina
                                    End If
                                    PrevozninaPoUg = PrevG
                                ...
                                If mVrstaPrevoza = "V" Then
                                    bZaokrMasuNaOsovineK(MasaTemp, bSvaTovarena, kBrOsov, MasaTempT)
                                    PrevV = MasaTempT * Voz
                                    bZaokruziNaDeseteNavise(PrevV)
                                    PrevozninaPoUg = PrevV
                                ...
                                If PrevozninaPoUg <= bMinPrevoznina Then
                                    PrevozninaPoUg = bMinPrevoznina
                                    'PrevozninaPoUg = kPrevMin
                                    'kPrevoznina = PrevozninaPoUg
                                End If
                                kPrevoznina = kPrevoznina + PrevozninaPoUg

                                '3. cena po tonskom stavu ( date su cene za 10-to tonski stav, 15-to tonski stav, ... )
                                ...
                                '                          kBrOsov, kSpecKola, kIznosMinPrev, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU1, TipUTI, kTonskiStav, kPovVr)
                            ...
                            ElseIf kNacinObrac = 3 Then
                                ...
                                If mVrstaPrevoza = "P" Then
                                    ...
                                    bZaokrMasuNaOsovineK(MasaTemp, bSvaTovarena, kBrOsov, MasaTempT)
                                    If MasaTempT <= outStav Then
                                        MasaTempT = outStav
                                        MasaTemp = MasaTempT * 1000
                                    End If
                                ...
                                If mVrstaPrevoza = "G" Then   'izmenjeno 12.7.16.'
                                    PomMasa2 = RacMasaPoKolima
                                    PomMasa1 = PomMasa2 / dtKola.Rows.Count
                                    RMax = 1
                                    bZaokruziMasuNa100k(PomMasa1)
                                    bNadjiMasuIStavGM("122", PomMasa1, bTkm, RMax, PomMasa3, outStav, PV)  ' proveriti da li je Rmax
                                    kTonskiStav = outStav
                                    MasaTemp = PomMasa1
                                    bZaokrMasuNaOsovineK(MasaTemp, bSvaTovarena, kBrOsov, MasaTempT)
                                    ...
                                    'PrevG = MasaTempT * Grupa
                                    PrevG = MasaTempT * Grupa * dtKola.Rows.Count
                                    bZaokruziNaDeseteNavise(PrevG)
                                    PrevozninaPoUg = PrevG
                                    bVozarinskiStavPoKolima = Grupa
                                ...
                                If mVrstaPrevoza = "V" Then     'izmenjeno 12.7.16.'
                                    PomMasa2 = RacMasaPoKolima
                                    PomMasa1 = PomMasa2 / dtKola.Rows.Count
                                    RMax = 1
                                    bZaokruziMasuNa100k(PomMasa1)
                                    ...
                                    'Mandic gde treba da zaokruzi masu?
                                    'bZaokruziMasuNa100k(MasaTemp)
                                    bZaokrMasuNaOsovineK(MasaTemp, bSvaTovarena, kBrOsov, MasaTempT)
                                    If MasaTempT <= outStav Then
                                        MasaTempT = outStav
                                    ...
                                    PrevV = MasaTempT * Voz * dtKola.Rows.Count
                                    PrevozninaPoUg = PrevV
                                    bZaokruziNaDeseteNavise(PrevV)
                                    bVozarinskiStavPoKolima = Voz
                                    RacMasaPoKolimaZ = MasaTemp
                                ...
                                ElseIf kNacinObrac = 4 Then
                                    ...
                                    KolaRed.Item("RacunskaMasa") = RacMasaPoKolima
                                    If RacMasaPoKolima < MinRacMasa Then
                                        RacMasaPoKolima = MinRacMasa
                                    End If
                                    KolaRed.Item("VozarinskiStav") = bVozarinskiStavPoKolima
                                    kPrevoznina = kPrevoznina + PrevozninaPoUg


                                    ' 5. cena po kontejnerima (univerzalno)
                                    '==========================
                                ElseIf kNacinObrac = 5 Then
                                    ...
                                    k3NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, KolaZ, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
                                        kBrOsov, kSpecKola, kIznosMinPrev, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU2, TipUTI, MasaTempT, kPovVr)
                                    MasaUti = MasaTemp
                                    ...
                                    ElseIf mVrstaPrevoza = "V" Then
                                        ...
                                        bVozarinskiStavPoKolima = Voz
                                    End If
                                    PrevozninaPoUg = PrevozninaPoKolima + PrevozninaPoUg
                                    KolaRed.Item("RacunskaMasa") = RacMasaPoKolima
                                    KolaRed.Item("VozarinskiStav") = bVozarinskiStavPoKolima
                                    ...
                                    ' 5. cena po kontejnerima (kombinovano)
                                    '==========================
                                ElseIf kNacinObrac = 6 Then
                                    ...
                                    If dtNhm.Rows.Count = 2 Then
                                        If (dtNhm.Rows(0).Item("UTI") = "20") And (dtNhm.Rows(1).Item("UTI") = "20") Then
                                            kUTI = "2 * 20"
                                            PrevozninaPoUg = 0
                                        ElseIf (dtNhm.Rows(0).Item("UTI") = "30") And (dtNhm.Rows(1).Item("UTI") = "30") Then
                                            kUTI = "2 * 30"
                                            PrevozninaPoUg = 0
                                        End If
                                    End If

                                    If dtNhm.Rows.Count = 4 Then
                                        If (dtNhm.Rows(0).Item("UTI") = "20") And (dtNhm.Rows(1).Item("UTI") = "20") And (dtNhm.Rows(2).Item("UTI") = "20") And (dtNhm.Rows(2).Item("UTI") = "20") Then
                                            kUTI = "4 * 20"
                                            PrevozninaPoUg = 0
                                        End If
                                    End If
                                ...
                                End If              'za naèin obraèuna
                                If kNacinObrac = 7 Then
                                bZaokruziMasuNa100k(MasaTemp)
                                
                            End If
                           
                        End If   ' kraj od dtNhm.Rows.Count > 0  za odredjena kola

                        ''  verovatno End If   ' kraj od dtNhm.Rows.Count > 0  za odredjena kola

                    Next    'sledeæa roba na kolima

                End If      'od dtNhm.Rows.Count>0 
            ...
            ' If (kNacinObrac = 2 Or kNacinObrac = 3) And (mVrstaPrevoza = "V" Or mVrstaPrevoza = "G") Then
            If (kNacinObrac = 2) And (mVrstaPrevoza = "V" Or mVrstaPrevoza = "G") Then
                bZaokruziMasuNa100k(RacMasaPoKolima)
                RacMasaPoKolimaZ = RacMasaPoKolima / 1000
                PrevozninaPoUg = RacMasaPoKolimaZ * bVozarinskiStavPoKolima
                ' Testiraj na minimalnu prevozninu  
            ElseIf (kNacinObrac = 3) And (mVrstaPrevoza = "V") Then
                For Each KolaRed In dtKola.Rows
                    KolaRed.Item("RacunskaMasa") = MasaTemp
                    KolaRed.Item("VozarinskiStav") = bVozarinskiStavPoKolima
                Next
                ...
                Next
                PrevozninaPoUg = PrevV
            ElseIf (kNacinObrac = 3) And (mVrstaPrevoza = "G") Then
                For Each KolaRed In dtKola.Rows
                    KolaRed.Item("RacunskaMasa") = MasaTemp
                    KolaRed.Item("VozarinskiStav") = bVozarinskiStavPoKolima
                Next
                ...
                PrevozninaPoUg = PrevG
            End If
            If PrevozninaPoUg <= kPrevMin Then
                PrevozninaPoUg = kPrevMin
            End If
            kPrevoznina = PrevozninaPoUg
        End If    'od dtKola
        ...
        If kNacinObrac = 7 Then
            Tara = 0
            Dim NhmRoba2 As DataRow
            For Each NhmRoba2 In dtNhm.Rows
                NHMRed.Item("VozarinskiStavNHM") = kPrevoznina
                'Tara = KolaRed.Item("Tara") + Tara
                'Tara = Tara / 1000
            Next
        End If
    ...
    Public Sub k1NadjiSveKomPovl(ByVal inBrojUgovora As String, _
        ...
        If DbVeza.State = ConnectionState.Closed Then
            DbVeza.Open()
        End If
        Dim spKomanda As New SqlClient.SqlCommand("k1NadjiSveKomPovl", DbVeza)
        spKomanda.CommandType = CommandType.StoredProcedure
    ...
    Public Sub kNadjiMasu(ByVal inBrojUgovora As String, _
                                          ByRef outAneks As Integer, _
                                          ByRef outStavka As Integer, _
                                          ByVal inOdStanica As String, _
                                          ByVal inDoStanica As String, _
                                          ByRef outVoz As Decimal, _
                                          ByRef outBrutoMasaOd As Decimal, _
                                          ByRef outBrutoMasaDo As Decimal, _
                                          ByRef inMasaPoKolima As Decimal, _
                                          ByRef outPovVred As String)
        ...
        If DbVeza.State = ConnectionState.Closed Then
            DbVeza.Open()
        End If
        Dim spKomanda As New SqlClient.SqlCommand("roba214kp.kNadjiMasu", DbVeza)
        spKomanda.CommandType = CommandType.StoredProcedure
        ...
        'Dim ulStavka As SqlClient.SqlParameter = spKomanda.Parameters.Add(New SqlClient.SqlParameter("@inStavka", SqlDbType.Int))
        'ulStavka.Direction = ParameterDirection.Input
        'spKomanda.Parameters("@inStavka").Value = inStavka

        Dim izStavka As SqlClient.SqlParameter = spKomanda.Parameters.Add(New SqlClient.SqlParameter("@outStavka", SqlDbType.Int))
        izStavka.Direction = ParameterDirection.Output
        spKomanda.Parameters("@outStavka").Value = outStavka
        ...
        Dim izlMasa As SqlClient.SqlParameter = spKomanda.Parameters.Add(New SqlClient.SqlParameter("@outBrutoMasaOd", SqlDbType.Decimal))
        izlMasa.Size = 11
        izlMasa.Precision = 9
        izlMasa.Scale = 2
        izlMasa.Direction = ParameterDirection.Output
        spKomanda.Parameters("@outBrutoMasaOd").Value = outBrutoMasaOd

        Dim izlMasaDo As SqlClient.SqlParameter = spKomanda.Parameters.Add(New SqlClient.SqlParameter("@outBrutoMasaDo", SqlDbType.Decimal))
        izlMasaDo.Size = 11
        izlMasaDo.Precision = 9
        izlMasaDo.Scale = 2
        izlMasaDo.Direction = ParameterDirection.Output
        spKomanda.Parameters("@outBrutoMasaDo").Value = outBrutoMasaDo

        Dim ulMasaT As SqlClient.SqlParameter = spKomanda.Parameters.Add(New SqlClient.SqlParameter("@inMasaPoKolima", SqlDbType.Decimal))
        ulMasaT.Size = 11
        ulMasaT.Precision = 9
        ulMasaT.Scale = 2
        ulMasaT.Direction = ParameterDirection.Input
        spKomanda.Parameters("@inMasaPoKolima").Value = inMasaPoKolima
        ...
        Try
            ...
            outAneks = spKomanda.Parameters("@outAneks").Value
            outVoz = spKomanda.Parameters("@outVoz").Value
            outBrutoMasaOd = spKomanda.Parameters("@outBrutoMasaOd").Value
            outBrutoMasaDo = spKomanda.Parameters("@outBrutoMasaDo").Value
            outPovVred = spKomanda.Parameters("@outPovVred").Value
