...
Module KalkModulCO
    ...
    Public Sub bNadjiPrevozninuCO()
        ...
        ElseIf ((Microsoft.VisualBasic.Right(mBrojUg, 2) = "01") Or _
                ...
                (Microsoft.VisualBasic.Right(mBrojUg, 2) = "55") Or _
            ...
            If IzborSaobracaja = "4" Then
                If mBrojUg = "961633" Or mBrojUg = "971633" Or mBrojUg = "981633" Then
                    bNadjiPrevozninu33TR(mPrevoznina)
                Else
        ...
        ElseIf Microsoft.VisualBasic.Right(mBrojUg, 2) = "22" Or _
               mBrojUg = "301623" Or mBrojUg = "301624" Or _
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima 
                ...
                If Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "10" Or _
                    ...
                    Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "15" Or _
                    Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "16" Then
                    Razred = "0"
                End If
                ...
                If Tabela = "173" Then            ' ****00
                    ...
                    If Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "10" Or _
                        ...
                        Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "14" Or _
                        Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "15" Or _
                        Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "16" Then      '#nesa#
            ...
            For Each KolaRed In dtKola.Rows
                ...
                If (bNHM8606 Or bNHMKao8606) Then
                    If TovPraMP = "" Then
                        TovPraMP = "TK"
                    End If
                    bNadjiSveIzZSKoefPos(bVrstaSaobracaja, "36", bVrstaPosiljke, bVrstaStanice, VlasnMP, _
                ...
                If dtNhm.Rows.Count > 0 Then
                    ...
                    If mVrstaObracuna = "CO" And mObrGodina = "2016" Then
                        Masa1R = Masa1R + Masa2R + Masa3R
                        Masa2R = 0
                        Masa3R = 0
                    End If


                    bNadjiPrevKoefCOUI(PrevKoef)                    '27.04.2016


                    bNadjiVozarinskiStavkmCO("000000", Tabela, mDatumKalk, MasaTemp, bTkm, "0", "0", "1", VozarinskiStav, PV)

                    If mVrstaObracuna = "CO" And mObrGodina = "2016" Then
                        VozarinskiStav = VozarinskiStav * PrevKoef      '27.04.2016
                        bZaokruziNaDeseteNavise(VozarinskiStav)         '27.04.2016
                    End If
                    ...
                    'bNadjiPrevKoefCOUI(PrevKoef)                                  pod komentar 27.04.2016. ; poslato naviše 
                    ...
                    If Not (mVrstaObracuna = "CO" And mObrGodina = "2016") Then                    
                    ...
                    Dim rv1 As String = ""
                    bNadjiMasuIStavGM(Tabela, tmpMasa, bTkm, Razred, tmpMasa, outStav, rv1)
                    ' $#$#$#$#$ Dodato formalno za probu
                    ...
                    If mBrojUg = "401601" And Vlasnistvo = "P" And ugCena <> 0 Then
                        Dim bAneksTg As String = ""
                        Dim ugCena1, ugTipCene1, sqlVlasnistvoKola1 ' formalno

                        bNadjiTg(mBrojUg, bVrstaSaobracaja, mStanica1, mStanica2, _
                                       BrOsovina, mVrstaPrevoza, Vlasnistvo, Stitna, _
                                       mDatumKalk, nmBMV, Microsoft.VisualBasic.Left(NHMTemp, 4), _
                                       ugUslovZaStav, ugCena1, ugTipCene1, sqlVlasnistvoKola1, bAneksTg, ugRetVal)

                        If Microsoft.VisualBasic.Left(bAneksTg, 6) = "Aneks1" Then
                            ugCena = 0.9 * ugCena
                    ...
                    ' CO 401600,401601 Aneks1 za NHM : Glava 72 i 73 osim 7204
                    '
                    Dim bNHM2 As String = Microsoft.VisualBasic.Left(NHMTemp, 2)
                    Dim bNHM4 As String = Microsoft.VisualBasic.Left(NHMTemp, 4)

                    If mBrojUg = "401601" And ((bNHM2 = "72" Or bNHM2 = "73") And Not (bNHM4 = "7204")) And _
                          (mDatumKalk >= #5/12/2016# And mDatumKalk <= #12/31/2016#) Then
                        If ((bVrstaSaobracaja = 2) And (mStanica1 = "12498") And (mStanica2 = "13603")) Or _
                            ((bVrstaSaobracaja = 3) And (mStanica1 = "13603") And (mStanica2 = "12498")) Then
                            ugCena = 8.5
                            If Vlasnistvo = "P" And ugRetVal <> "" Then
                                ugCena = 0.9 * ugCena
                                bZaokruziNaDeseteNavise(ugCena)
                            End If
                            ugTipCene = 2
                    ...
                    ' mail 7.9.2016 Slavica
                    If mBrojUg = "401600" And Not (bNHM4 = "7204") And _
                                            (mDatumKalk >= #5/12/2016# And mDatumKalk <= #12/31/2016#) Then
                        If ((bVrstaSaobracaja = 2) And (mStanica1 = "12498") And (mStanica2 = "13603")) Or _
                            ((bVrstaSaobracaja = 3) And (mStanica1 = "13603") And (mStanica2 = "12498")) Then
                            If Vlasnistvo = "Z" And ugRetVal <> "" Then
                                ugCena = 9
                            ElseIf Vlasnistvo = "P" And ugRetVal <> "" Then
                                'ugCena = 0.9 * ugCena
                                ugCena = 8.1
                                'bZaokruziNaDeseteNavise(ugCena)
                            End If
                    ...
                    ' CO 078601 Osn.ugovor za NHM : osim za koks NHM 2704
                    '
                    If mBrojUg = "078601" And Not (bNHM4 = "2704") And _
                          (mDatumKalk >= #7/1/2016# And mDatumKalk <= #12/31/2016#) Then
                        If ((bVrstaSaobracaja = 2) And (mStanica1 = "23499") And (mStanica2 = "13603")) Or _
                            ((bVrstaSaobracaja = 3) And (mStanica1 = "13603") And (mStanica2 = "23499")) Then
                            ugCena = 8.4
                            If Vlasnistvo = "P" And ugRetVal <> "" Then
                                ugCena = 0.9 * ugCena
                                bZaokruziNaDeseteNavise(ugCena)
                    ...
                    'If mBrojUg = "401600" And ((bNHM2 = "72" Or bNHM2 = "73") And Not (bNHM4 = "7204")) And _
                    '      (mDatumKalk >= #5/12/2016# And mDatumKalk <= #12/31/2016#) Then
                    '    If ((bVrstaSaobracaja = 2) And (mStanica1 = "12498") And (mStanica2 = "13603")) Or _
                    '        ((bVrstaSaobracaja = 3) And (mStanica1 = "13603") And (mStanica2 = "12498")) Then
                    '        ugCena = 9
                    ...
                    If (ugRetVal = "") Then
                        ...
                        'If (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Then       ' e-mail Z.Mandic 30.08.2016
                        '    If RacMasaZaAneks < 5000 * BrOsovina Then
                        '        RacMasaZaAneks = 5000 * BrOsovina                      zasto je ovo komentarisano?
                        '    End If
                        'End If


                        If RacMasaZaAneks < 5000 * BrOsovina Then                       ' Vukobrat 15.09.2016
                            RacMasaZaAneks = 5000 * BrOsovina
                        End If
                    ...
                    If ugTipCene = 4 Or ugTipCene = 5 Or ugTipCene = 23 Then
                        bMinPrevoznina = 0
                    End If
                ...
                For Each NHMRed In dtNhm.Rows
                    If NHMRed.Item("IndBrojKola") = IBK Then
                        ...
                        '--------------------------------------------------
                        If ugTipCene = 4 Or ugTipCene = 5 Or ugTipCene = 23 Or ugTipCene = 14 Or ugTipCene = 15 Then
                        ...
                        ' test 24/3 NHMRed.Item("RacMasaNHM") = bRacunskaMasaNHM
    ...
    Public Sub bNadjiPrevozninuICF(ByRef Prevoznina As Decimal)          ' ICF
        ...
        If ((mTabelaCena = "220") Or (mTabelaCena = "221")) Then            ' pojedinacne
            ...
            For Each NHMRed In dtNhm.Rows                                                ' petlja po robi za jedna kola
                If NHMRed.Item("IndBrojKola") = IBK Then
                    ...
                    'If mBrojUg = "844514" Or mBrojUg = "844517" Then
                    '    bNadjiRasterAKombi(DuzinaKontTemp, MasaTemp, RasterTemp)
                    'End If
        ...
        ElseIf ((mTabelaCena = "201") Or (mTabelaCena = "202")) Then       ' vozovi
            ...
            BrutoMasa = 0
            'bNadjiNetoMasu(NetoMasa, bPkolKoef)
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                Next
            Next
        ElseIf (mTabelaCena = "333") Then       ' Adria combi ( nisu samo pojedinacne )
            Dim Dodatak As Decimal = 0
            IBK = dtKola.Rows(0).Item("IndBrojKola")
            Vlasnistvo = dtKola.Rows(0).Item("Vlasnik")
            bMinPrevoznina = 0
            ...
            For Each NHMRed In dtNhm.Rows                                                ' petlja po robi za jedna kola
                If NHMRed.Item("IndBrojKola") = IBK Then
                    ...
                    ElseIf mBrojUg = "844517" Then 'AdriaCombi                        
                        ...
                        ElseIf mObrGodina = "2105" Or (mObrGodina = "2106" And mDatumKalk < ("1.4.2016")) Then               ' Sid gr.-  Presevo - 363; Sid gr. - Prijepolje gr. - 364   ?
                            If mStanica1 = "16517" And mStanica2 = "11028" Then
                                IzStav = 363
                            ElseIf mStanica1 = "16517" And mStanica2 = "15723" Then
                                IzStav = 364
                            End If
                        ElseIf (mObrGodina = "2106" And mDatumKalk >= ("1.4.2016")) Then
                            If mStanica1 = "16517" And mStanica2 = "11028" Then
                                IzStav = 400
                    ...
                    'End If
                    If mBrojUg = "835745" Or mBrojUg = "835758" Then 'AdriaCombi
                        PrevozninaPoKolima = PrevozninaPoKolima + PrevozninaZaUTI
                    ElseIf mBrojUg = "844517" Then              'AdriaCombi
                        PrevozninaPoKolima = PrevozninaPoKolima + (PrevozninaZaUTI + Dodatak) * RasterTemp
                    ElseIf mBrojUg = "931817" Then 'Eurolog
                        PrevozninaPoKolima = 2772 'cena po vozu
                    End If
                End If
    ...
    Public Sub bNadjiPrevozninu01CO(ByRef Prevoznina As Decimal)          ' vozovi
        ...
        ' * * * * *  ANEKS  * * * * *
        Dim tempPrevoznina As Decimal = 0
        For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                If NHMRed.Item("IndBrojKola") = IBK Then
                    ...
                    If (ugRetVal = "") Then
                        ...
                        If ugTipCene = 5 Or ugTipCene = 14 Or ugTipCene = 15 Then
                            'mPrevoznina = PrevozninaPoKolima
                            tempPrevoznina = PrevozninaPoKolima
                        Else
                            'mPrevoznina = mPrevoznina + PrevozninaPoKolima
                            tempPrevoznina = tempPrevoznina + PrevozninaPoKolima
                        End If
            ...
            If tempPrevoznina > 0 Then
                mPrevoznina = tempPrevoznina
            End If
            ...
            For Each KolaRed In dtKola.Rows
                ...
                If dtNhm.Rows.Count > 0 Then
                    ...
                    If (ugRetVal = "") Then
                        ...
                        If (ugTipCene = 24) And (bVrstaSaobracaja = 3) And (mVrstaSaobracaja = "4") Then
    ...
    Public Sub bNadjiPrevozninu11CO(ByRef Prevoznina As Decimal)
        ...
        If dtKola.Rows.Count > 0 Then
            For Each KolaRed In dtKola.Rows
                ...
                If ugTipCene > 0 And ugTipCene <> 10 And ugTipCene <> 23 Then 'minimalna prevoznina
                    If PrevozninaPoKolima <= bMinPrevoznina Then
                        PrevozninaPoKolima = bMinPrevoznina
                    End If
                End If
    ...
    Public Sub bNadjiPrevozninu22CO(ByRef Prevoznina As Decimal)          ' Proodos kontejnerski vozovi
        ...
        If (mVrstaPrevoza = "V" Or mVrstaPrevoza = "G") And Not (mBrojUg = "301524" Or mBrojUg = "301124" Or _
            mBrojUg = "301224" Or mBrojUg = "301324" Or mBrojUg = "301424" Or mBrojUg = "301624" Or mBrojUg = "301622" Or mBrojUg = "301623" Or mBrojUg = "081622") Then                ' kontejnerski voz Proodos
            'bNadjiSveIzZSKoefPos(bVrstaSaobracaja, mTarifa, bVrstaPosiljke, bVrstaStanice, Vlasnistvo, _
            '       TovarenaPrazna, bMinPrevoznina, bDodPrevoznina, bKoef, bKoefNak, bKoefInd, bKoefInd1, bKoefRid, _
            '       bPouzece, bPredujam, mDatumKalk, bRedovanOrocen, bValuta, bRetVal)
            ...
            If IzborSaobracaja = "4" Then
                ...
                ElseIf Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "15" Then
                    ...
                    Else
                        ...
                        If intkm > 350 Then outDodatak = 210
                    End If
                ElseIf Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "16" Then
                    If Microsoft.VisualBasic.Left(mBrojUg, 2) = "11" Or Microsoft.VisualBasic.Left(mBrojUg, 2) = "12" Then
                        ''If intkm < 101 Then outDodatak = 57 '59
                        ''If (intkm > 100) And (intkm < 351) Then outDodatak = 169 '173
                        ''If intkm > 350 Then outDodatak = 210 '216
                    Else
                        If intkm < 101 Then outDodatak = 60 '59
                        If (intkm > 100) And (intkm < 351) Then outDodatak = 170 '169
                        If intkm > 350 Then outDodatak = 210
                    End If
                End If
            End If
    ...
    Public Sub bNadjiPrevKoefCOUI(ByRef outPrevKoefCOUI As Decimal)
        ...
        If Microsoft.VisualBasic.Right(mBrojUg, 2) = "02" Then      ' grupe kola
            ...
            ElseIf Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "15" Then
                If IzborSaobracaja = "2" Then
                    If Microsoft.VisualBasic.Left(mVlasnik, 1) = "Z" And Microsoft.VisualBasic.Mid(mIBK, 3, 2) <> "72" And nmRIV = False Then
                        outPrevKoefCOUI = 1
                    Else
                        outPrevKoefCOUI = 0.95
                    End If
                Else
                    If Microsoft.VisualBasic.Left(mVlasnik, 1) = "P" Or Microsoft.VisualBasic.Mid(mIBK, 3, 2) = "72" Then
                        outPrevKoefCOUI = 0.95
                    Else
                        outPrevKoefCOUI = 1
                    End If
    ...
    Public Sub bKorigujPoAneksu(ByVal inVrstaKorekcije As Integer, ByVal inPrevoznina As Decimal, ByVal inKoeficijent As Decimal, _
        ...
        Select Case inVrstaKorekcije
            ...
            Case 2, 12, 13, 25     'Cena po toni, Cena po toni za stvarnu masu . . .                             
            ...
            Case 4, 5, 15, 23      'Cena po kolima, Cena po vozu, Cena po vozu za BMV 
                outIzlaz = inCena
            Case 6
    ...
    Public Sub bNadjiRacMasuZaAneks(ByVal inIBK As String, ByVal inVrstaKorekcije As Integer, ByRef outRacunskaMasa As Integer)
        ...
        Select Case inVrstaKorekcije
            ...
            Case 12     ' isto kao pod 2, samo za stvarnu masu, zbog aneksa T518 za 090801, gde je "stvarna masa kola"
                outRacunskaMasa = MasaPoKolima
            Case 25
                bZaokruziMasuNa100k(bNMV)
                outRacunskaMasa = bNMV
        End Select
    End Sub
    ...
    Public Sub bNadjiPrevozninu05COUI(ByVal Tabela As String, ByRef Prevoznina As Decimal)
        ...
        If dtKola.Rows.Count > 0 Then
            For Each KolaRed In dtKola.Rows
                ...
                bNadjiSveIzZSKoefPos(bVrstaSaobracaja, "00", bVrstaPosiljke, bVrstaStanice, VlasnMP, _
                                     TovPraMP, bMinPrevoznina, bDodPrevoznina, bKoef, bKoefNak, bKoefInd, bKoefInd1, bKoefRid, _
                                     bPouzece, bPredujam, mDatumKalk, bRedovanOrocen, bValuta, bRetVal)
    ...
    Public Sub bNadjiPrevozninu844514(ByRef Prevoznina As Decimal)          ' AdriaKombi pojedinacne
        ...
        For Each NHMRed In dtNhm.Rows                                                ' petlja po robi za jedna kola
            If NHMRed.Item("IndBrojKola") = IBK Then
                ...
                If (DuzinaKontTemp = "50") And (NHMTemp = 993100) Then
                    RasterTemp = 0.42
                End If

                'If (NHMTemp = 993100) Then
                '    If (DuzinaKontTemp = "20") Then
                '        RasterTemp = 0.37
                '    ElseIf (DuzinaKontTemp = "25") Then
                '        RasterTemp = 0.37
                '    ElseIf (DuzinaKontTemp = "30") Then
                '        RasterTemp = 0.5
                '    ElseIf (DuzinaKontTemp = "40") Then
                '        RasterTemp = 0.7
                '    ElseIf (DuzinaKontTemp = "70") Then
                '        RasterTemp = 0.7
                '    End If
                'End If
    ...
    Public Sub NadjiAneksNovo(ByVal inUgovor As String, ByVal inSaobracaj As String, _
        ...
        End Try
    End Sub
    Public Sub bNadjiRasterAKombi(ByVal inDuzinaKont As String, ByVal inStvMasa As Integer, ByRef outRaster As Decimal)
    ...
    End Sub
    Public Sub bNadjiPrevozninu33TR(ByVal mPrevoznina)             'kont. vozovi - Tour Retour
        Dim bIzborABCD As String
        Dim bABCD As Integer ' String
        Dim bCenaPoVozu00, bCenaPoVozuOt, bCenaPoVozuUp As Decimal
        Dim bCena As Decimal
        ...
        Dim bRBrVozaUGodini As Integer = 0
        Dim bRBrVozaUMesecu As Integer = 0

        mProcenatBM = 0 'postavlja na nulu

        ' - odrediti smer   "A" ili "R"
        ' - za "A"  :
        '           naæi redni broj tekuæeg voza u godini
        '           naæi redni broj tekuæeg voza u mesecu
        '           naæi bruto masu tekuæeg voza
        '           naæi da li postoji odgovarajuæi "R" voz
        '               ako ne postoji, upisati cenu za "R" voz od 1200t
        '               ako postoji, 



        bNadjiRedniBrojVozaUGodini(mBrojUg, mObrGodina, mStanica1, mStanica2, bRBrVozaUGodini)

        bNadjiRedniBrojVozaUMesecu(mBrojUg, mObrGodina, mObrMesec, mStanica1, mStanica2, bRBrVozaUMesecu)
    ...
    End Sub
    Public Sub bNadjiRedniBrojVozaUGodini(ByRef inmBrojUg, ByRef inmObrGodina, ByRef inmStanica1, ByRef inmStanica2, ByVal bRBrVozaUGodini)

    End Sub
    Public Sub bNadjiRedniBrojVozaUMesecu(ByRef inmBrojUg, ByRef inmObrGodina, ByRef inmObrMesec, ByRef inmStanica1, ByRef inmStanica2, ByVal bRBrVozaUGodini)
