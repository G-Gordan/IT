...
Module KalkModul
        ...
        For Each KolaRed In dtKola.Rows                   ' petlja po kolima
            ...
            For Each NHMRed In dtNhm.Rows
                If IBK = NHMRed.Item("IndBrojKola") Then
                    ...
                    If Microsoft.VisualBasic.Left(mBrojUg, 4) = "0316" Then
                        bNadjiRasterAGIT(DuzinaKont, StvMasa, Raster)       ' AGIT
                    Else
                        bNadjiRasterTEA(DuzinaKont, StvMasa, Raster)        ' ostali
                    End If
                    ...
                    ' ========================== NadjiAneks ============================
                    ' 8.6.2016 If mBrojUg = "031022" Or mBrojUg = "031122" Or mBrojUg = "031222" Or mBrojUg = "031322" Or mBrojUg = "031422" Or mBrojUg = "031522" Or mBrojUg = "031622" Then
                    ...
                    If Microsoft.VisualBasic.Right(mBrojUg, 2) = "22" Or _
                        ...
                        If (ugretval = "") Then         ' dodato 8.6.2016 zbog tel.62 od 1.3.2016
                            If ugtipcene = 20 Then                                      'cena po utiju, tabela kao raster
                                ...
                                PrevozninaPoKont = ugcena
                                VozarinskiStav = ugcena
                                If mBrojUg = "031442" Or mBrojUg = "031542" Or mBrojUg = "031642" Then
                                    AgitAneks = True
                                End If
    ...
    Public Sub bNadjiPrevozninuGlavni()
        ...
        If mVrstaPrevoza = "V" Then
            Dim rvco As String
            Dim K As Decimal = 1
            bNadjiNetoMasuVoza(mBrojUg, mNajava, bNMV, rvco)
                ...
                ElseIf mTarifa = "00" Then   ' Ugovori
                    ...
                    If mVrstaObracuna = "IC" Then   'proveriti
                        ...
                        Else
                            ...
                            End If
                        End If
                    ElseIf mVrstaObracuna = "CO" Or mVrstaObracuna = "CD" Then                  '31.05.2016
                        bNadjiPrevozninuCO()
    ...
    Public Sub bNadjiBrutoMasu(ByRef BrutoMasa As Decimal, ByRef KoefPKola As Decimal)
        ...
        If dtKola.Rows.Count > 0 Then
            For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                If (VlasnikTemp = "Z") Then
                    KoefPKola = 1                   ' ako su bar jedna "Z" 
                    bSvaPrivatna = False
                End If
        ...
        Else
            If MasterAction = "New" Then                                    'izmenjeno 1.6.2016
                BrutoMasa = BrutoMasa + tmp_Neto + tmp_Tara
            Else
                BrutoMasa = tmp_Neto + tmp_Tara
            End If
            'BrutoMasa = BrutoMasa + tmp_Neto + tmp_Tara                    izmenjeno 1.6.2016
        End If
