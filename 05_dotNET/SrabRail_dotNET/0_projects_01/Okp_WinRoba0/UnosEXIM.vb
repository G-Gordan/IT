...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents tbSumaRSD_CD As System.Windows.Forms.TextBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.tbSumaRSD_CD = New System.Windows.Forms.TextBox
        ...
        Me.Panel1.Controls.Add(Me.tbSumaRSD_CD)
        ...
        'tbSumaRSD_CD
        '
        Me.tbSumaRSD_CD.BackColor = System.Drawing.SystemColors.GrayText
        Me.tbSumaRSD_CD.Enabled = False
        Me.tbSumaRSD_CD.Font = New System.Drawing.Font("Microsoft Sans Serif", 10.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(238, Byte))
        Me.tbSumaRSD_CD.Location = New System.Drawing.Point(86, 288)
        Me.tbSumaRSD_CD.Name = "tbSumaRSD_CD"
        Me.tbSumaRSD_CD.Size = New System.Drawing.Size(112, 23)
        Me.tbSumaRSD_CD.TabIndex = 98
        Me.tbSumaRSD_CD.Text = ""
        Me.tbSumaRSD_CD.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        Me.tbSumaRSD_CD.Visible = False
        '
        'PictureBox1
        '
...
#End Region
    ...
    Private Sub Unos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'If (mTarifa = "68" Or kSifTar = 68) Or ((Microsoft.VisualBasic.Right(mBrojUg, 2) = "92" Or Microsoft.VisualBasic.Right(mBrojUg, 2) = "93") And mVrstaObracuna = "CO") Then         22.08.2016
        If (mTarifa = "68" Or kSifTar = 68) Or ((Microsoft.VisualBasic.Right(mBrojUg, 2) = "92" Or Microsoft.VisualBasic.Right(mBrojUg, 2) = "93") And ((mVrstaObracuna = "CO") Or (mVrstaObracuna = "CD"))) Then
            lblTEA.Visible = True
            tbTEA.Visible = True
        Else
        ...
        'If Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786" Then            6.9.2016
        ' 6.9.2016
        If ((Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Or _
                              (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0186") Or _
                              (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0386") Or _
                              (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0586")) Then

            lblTEA.Visible = True
            lblTEA.Text = "Suma RSD"
            tbSumaRSD_CD.Visible = True
        End If
        ...
        lbl_TipUti.Text = _mTipUti  '" LC/CL "
        ...
        If IzborSaobracaja = 2 Then ' UVOZ
            ...
            Label33.Visible = True                     '?? ukinuto, pa vraceno zbog SK
            Me.btnUpravaPr.Enabled = False             'ukinuto, pa vraceno zbog SK

            If (CInt(mObrMesec) >= 10 And CInt(mObrGodina) >= 2015) Or (CInt(mObrGodina) >= 2016) Then
                mPrUprava = "2172" 'mOtpUprava = "72"
                Me.tbUpravaPr.Text = "2172"
                Me.Label14.Text = "SK"
            Else
                mPrUprava = "0072" 'mOtpUprava = "72"
                Me.tbUpravaPr.Text = "0072"
                Me.Label14.Text = "ZS"
            End If

            Me.tbUpravaPr.Enabled = False               ' ukinuto pa vraceno zbog SK

            'If CInt(mObrMesec) >= 10 And CInt(mObrGodina) >= 2015 Then
            '    Me.Label14.Text = "SK"
            'Else
            '    Me.Label14.Text = "ZS"
            'End If
        ...
        ElseIf IzborSaobracaja = 3 Then ' IZVOZ
            ...
            If (CInt(mObrMesec) >= 10 And CInt(mObrGodina) >= 2015) Or (CInt(mObrGodina) >= 2016) Then
                mOtpUprava = "2172" 'mOtpUprava = "72"
                Me.tbUpravaOtp.Text = "2172"
                Label11.Text = "SK"
            Else
            ...
            Me.tbUpravaOtp.Enabled = False                              ' ukinuto pa vraceno, zbog SK
            'If CInt(mObrMesec) >= 10 And CInt(mObrGodina) >= 2015 Then
            '    Label11.Text = "SK"
            'Else
            '    Label11.Text = "ZS"
        ...
        If mTarifa = "00" And (mVrstaObracuna = "CO" Or mVrstaObracuna = "IC" Or mVrstaObracuna = "CD") Then
            If mVrstaPrevoza <> "P" Then
                ...
                If mVrstaObracuna = "CD" Then                       '24.08.2016  
                    tbKolauNajavi.Text = ""
                    tbKolauNajavi.Enabled = False
                    tbKolaRealizovano.Text = ""
        ...
        If MasterAction = "Upd" Then  ''kako moze izmena u bazi i preuzimanje: Or RecordAction = "P" Then
            ...
            tbSumaRSD_CD.Text = Format(bSumaDinari, "###,###,##0.00")
        Else  'PREUZIMANJE PODATAKA IZ WINROBA
            If mTarifa = "00" And (mVrstaObracuna = "CO" Or mVrstaObracuna = "IC" Or mVrstaObracuna = "CD") Then ' ugovor centralni obracun
                'If mTarifa = "00" And (mVrstaObracuna = "CO" Or mVrstaObracuna = "IC" ) Then ' ugovor centralni obracun  27.05.2016
            ...
            If AkcijaZaPreuzimanje = "Da" Then
                ...
                If mVrstaPrevoza <> "P" And mTarifa = "00" And (mVrstaObracuna = "CO" Or mVrstaObracuna = "CD" Or mVrstaObracuna = "IC") Then
                    Me.cbNajava.Focus()
                Else
                    Me.tbBrojPr.Focus()
                End If
    ...
    Private Sub btnUpis_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpis.Click
        ...
        If dtError.Rows.Count = 0 Then ' nema gresaka
            ...
            Try
                ...
                If Microsoft.VisualBasic.Mid(mBrojUg, 5, 2) = "01" Then
                    'If mVrstaObracuna = "CO" Then              22.08.2016
                ...
                ' 14.9.2016
                Dim SFRRSD As Decimal = 0
                Dim SUPRSD As Decimal = 0
                If IzborSaobracaja = 2 Then
                    SFRRSD = 0
                    SUPRSD = mSumaDinari
                ElseIf IzborSaobracaja = 3 Then
                ...
                'If Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786" Then                6.9.2016 + 14.9.2016
                ' 6.9.2016 + 14.9.2016
                If ((Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Or _
                              (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0186") Or _
                              (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0386") Or _
                    ...
                    mSumaDinari = bSumaDinari

                    If (upis_f_suma <> 0) And (upis_u_suma = 0) Then
                        SFRRSD = mSumaDinari
                        SUPRSD = 0
                    End If
                ...
                If IzborSaobracaja = 2 Then
                    Upis.UpisSlogKalkUI(slogTrans, mAkcija, Microsoft.VisualBasic.Mid(StanicaUnosa, 5, 5), tbUpravaOtp.Text, _
                            ...
                            bValuta, upis_f_suma, upis_u_suma, SFRRSD, SUPRSD, upis_f_prev, upis_u_prev, upis_f_nak, upis_u_nak, _
                ...
                ' dodato "CD"       3.8.2016
                If (mVrstaObracuna = "CO" Or mVrstaObracuna = "IC" Or mVrstaObracuna = "CD") And _
    ...
    Private Sub UnosTrz_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        ...
        If mPrikazKalkulacije = "D" Then
            ...
            ElseIf _OpenForm = "Uic" Then
                ...
                'bSumaDinari = (mPrevoznina + mSumaNak) * bOutKurs           '23.08.2016
                'tbSumaRSD_CD.Text = Format(bSumaDinari, "###,###,##0.00")
            ...
            ElseIf _OpenForm = "Info" Then
                ...
                End If
                'Me.tbBlagajna.Focus()
                bZaokruziNaDeseteNavise(bSumaDinari)
                tbSumaRSD_CD.Text = Format(bSumaDinari, "###,###,##0.00")
            Else
                tbTL.Focus()
            End If
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnosNaknade.Click
        ...
        'If mVrstaObracuna = "CO" Or mVrstaObracuna = "IC" Then             22.08.2016
        If mVrstaObracuna = "CO" Or mVrstaObracuna = "CD" Or mVrstaObracuna = "IC" Then
            If mVrstaPrevoza <> "P" Then
    ...
    Private Sub Button15_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button15.Click
        ...
        If IzborSaobracaja = 2 Then ' UVOZ
            ...
            Me.btnUpravaPr.Enabled = False       'ukinuto, pa vraceno zbog SK i Vukobrata
            ...
            Me.tbUpravaPr.Enabled = False        'ukinuto, pa vraceno zbog SK i Vukobrata
        ...
        If mTarifa = "00" And (mVrstaObracuna = "CO" Or mVrstaObracuna = "CD" Or mVrstaObracuna = "IC") Then
            If mVrstaPrevoza <> "P" Then
                Me.cbNajava.Enabled = True
                Me.tbKolaRealizovano.Visible = True
                Me.tbKolauNajavi.Visible = True
        ...
        If MasterAction = "Upd" Then 'Or RecordAction = "P" Then 'dodato: Or RecordAction = "P"
            ...
            End If
        Else
            'If mTarifa = "00" And (mVrstaObracuna = "CO" Or mVrstaObracuna = "IC") Then ' ugovor centralni obracun             22.08.2016
            If mTarifa = "00" And (mVrstaObracuna = "CO" Or mVrstaObracuna = "CD" Or mVrstaObracuna = "IC") Then ' ugovor centralni obracun
                If Microsoft.VisualBasic.Mid(mBrojUg, 5, 2) = "01" Then
                    gbKolauVozu.Visible = True
                    tbKolauVozu.Text = "1"
                Else
