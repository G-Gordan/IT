...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents lblNazivNaknade2 As System.Windows.Forms.Label
    Friend WithEvents lblNazivNaknade As System.Windows.Forms.TextBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lblNazivNaknade2 = New System.Windows.Forms.Label
        Me.Label18 = New System.Windows.Forms.Label
        Me.dtPickDatumNaknade = New System.Windows.Forms.DateTimePicker
        Me.GroupBox1 = New System.Windows.Forms.GroupBox
        Me.lblNazivNaknade = New System.Windows.Forms.TextBox
        ...
        Me.cbSifPlacanja.Location = New System.Drawing.Point(920, 0)
        ...
        Me.Label6.Location = New System.Drawing.Point(246, 203)
        ...
        'lblNazivNaknade2
        '
        Me.lblNazivNaknade2.Font = New System.Drawing.Font("Microsoft Sans Serif", 10.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(238, Byte))
        Me.lblNazivNaknade2.ForeColor = System.Drawing.Color.DimGray
        Me.lblNazivNaknade2.Location = New System.Drawing.Point(976, 104)
        Me.lblNazivNaknade2.Name = "lblNazivNaknade2"
        Me.lblNazivNaknade2.Size = New System.Drawing.Size(32, 28)
        Me.lblNazivNaknade2.TabIndex = 35
        '
        'Label18
        '
        ...
        'lblNazivNaknade
        '
        Me.lblNazivNaknade.BackColor = System.Drawing.SystemColors.Control
        Me.lblNazivNaknade.BorderStyle = System.Windows.Forms.BorderStyle.None
        Me.lblNazivNaknade.Location = New System.Drawing.Point(392, 36)
        Me.lblNazivNaknade.Multiline = True
        Me.lblNazivNaknade.Name = "lblNazivNaknade"
        Me.lblNazivNaknade.Size = New System.Drawing.Size(352, 133)
        Me.lblNazivNaknade.TabIndex = 63
        ...
        Me.fxIznosNak.Location = New System.Drawing.Point(136, 197)
        ...
        Me.btnIndKol.Size = New System.Drawing.Size(48, 23)
        Me.btnIndKol.TabIndex = 58
        Me.btnIndKol.Text = "IndKol"
        ...
        Me.btnDodajNak.Location = New System.Drawing.Point(304, 456)
        ...
        Me.fxIznosNak1.Location = New System.Drawing.Point(856, 32)
        ...
        'Button2Nak
        '
        Me.Button2Nak.Location = New System.Drawing.Point(864, 56)
        ...
        'Button3
        '
        Me.Button3.Location = New System.Drawing.Point(48, 184)
        ...
        Me.Button4.Location = New System.Drawing.Point(48, 216)
        ...
        Me.Controls.Add(Me.Button2Nak)
        Me.Controls.Add(Me.fxIznosNak1)
        Me.Controls.Add(Me.Label5)
        Me.Controls.Add(Me.cbSifPlacanja)
        Me.Controls.Add(Me.lblNazivNaknade2)
        Me.KeyPreview = True
...
#End Region
    ...
    Private Sub tbIvicniBroj_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles tbIvicniBroj.KeyPress
        If e.KeyChar() = Microsoft.VisualBasic.ChrW(13) Then
            'If CType(bPodBroj, Int16) > 0 And CType(bPodBroj, Int16) < 10 Then
            '    upit = "NAKPB"
    ...
    Private Sub tbIvicniBroj_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles tbIvicniBroj.Validating
        ...
        Dim bNakretVal
        Dim nmErrorNak As Boolean = False
        ...
        If IsNumeric(tbIvicniBroj.Text) = True Then
            ...
            If tbSifraNaknade.Text <> "35" And tbSifraNaknade.Text <> "36" Then
                ...
                If (mDatumKalk >= (#1/15/2015#)) Then ' NOVI
                    If mTarifa = "00" Then
                        'mTarifa = "36"
                        bNadjiSveIzZSNaknada(bSifraNaknade, bIvicniBroj, 0, "36", mDatumKalk, _
                                             "17", bNazivNaknade, bPodBroj, bIznos1, bIznos2, bIznos3, bMinimum, bNakretVal)
                    Else
                        'mTarifa = mTarifa
                        bNadjiSveIzZSNaknada(bSifraNaknade, bIvicniBroj, 0, mTarifa, mDatumKalk, _
                                             "17", bNazivNaknade, bPodBroj, bIznos1, bIznos2, bIznos3, bMinimum, bNakretVal)
                    End If
                Else
                    If mTarifa = "00" Then
                        'mTarifa = "36"
                        bNadjiSveIzZSNaknada(bSifraNaknade, bIvicniBroj, CInt(IzborSaobracaja), "36", mDatumKalk, _
                                             "17", bNazivNaknade, bPodBroj, bIznos1, bIznos2, bIznos3, bMinimum, bNakretVal)
                    Else
                        'mTarifa = mTarifa
                        bNadjiSveIzZSNaknada(bSifraNaknade, bIvicniBroj, CInt(IzborSaobracaja), mTarifa, mDatumKalk, _
                                             "17", bNazivNaknade, bPodBroj, bIznos1, bIznos2, bIznos3, bMinimum, bNakretVal)
                    End If
                End If
                ...
                If mTarifa = "68" Then
                    If bIznos1 = 0 Then
                        bNadjiSveIzZSNaknada(bSifraNaknade, bIvicniBroj, CInt(IzborSaobracaja), "36", bbDatum, _
                                             bValuta, bNazivNaknade, bPodBroj, bIznos1, bIznos2, bIznos3, bMinimum, bNakretVal)
                    End If
                End If

                If Len(bNazivNaknade) = 0 Then
                    nmErrorNak = True
                Else
                    nmErrorNak = False
                    '---------------------------------- Podbroj ---------------------------------
                    If Val(bPodBroj) > 0 And Val(bPodBroj) < 9 Then
                        If bSifraNaknade <> "46" Or (bSifraNaknade = "46" And (Microsoft.VisualBasic.Left(_mNHM, 4) = "9941" Or Microsoft.VisualBasic.Left(_mNHM, 4) = "9931")) Then

                            'bSifraNaknade = "46" And Microsoft.VisualBasic.Left(_mNHM, 4) = "9941" And Microsoft.VisualBasic.Left(_mNHM, 4) = "9931" Then
            ...
            Else                ' koloseci
                ...
                If Len(mManipulativnoMesto) = 5 Then
                    tmp_MMStanica1 = mManipulativnoMesto
                    ind_Stanica = "72" & mManipulativnoMesto
                Else
                    If IzborSaobracaja = "2" Then
                        tmp_MMStanica1 = mStanica2
                ...
                Else
                    bDupliKoloseci = False
                    bNadjiIndKol(ind_Stanica, bIvicniBroj, mDatumKalk, bNazivNaknade, bIznos1, bIznos2, bIznos3, bNakretVal)
                ...
                If Microsoft.VisualBasic.Left(mBrojUg, 4) = "0314" And Microsoft.VisualBasic.Left(_mNHM, 4) = "9931" Then
                    bIznos1 = 0
                    bIznos2 = 0
                    bIznos3 = 0
                End If
            ...
            Else
                ...
                '-os. opterecenje ----------------------------------------------------------------------------
                If tbSifraNaknade.Text = "88" And (tbIvicniBroj.Text = "01" Or tbIvicniBroj.Text = "02") Then
                    nmOptDec = bIznos1 * CDec(dtNhm.Compute("SUM(Masa)/1000", String.Empty))
                    bZaokruziNaDeseteNavise(nmOptDec)
                    fxIznosNak.Text = nmOptDec
                End If
                '---------------------------------------------------------------------------------------------
        ...
        End If
    End Sub
    Private Sub bNadjiSveIzZSNaknada(ByVal inSifraNaknade As String, ByVal inIvicniBroj As String, ByVal inVrstaSaobracaja As Integer, ByVal inTarifa As String, _
                                     ByVal inDatum As DateTime, ByRef outSifraValute As String, ByRef outNazivNaknade As String, ByRef outPodBroj As String, _
                                     ByRef outIznos1 As Decimal, ByRef outIznos2 As Decimal, ByRef outIznos3 As Decimal, ByRef outMinimum As Decimal, _
        ...
        Dim izlNazivNaknade As SqlClient.SqlParameter = spKomanda.Parameters.Add(New SqlClient.SqlParameter("@outNazivNaknade", SqlDbType.VarChar, 255))
    ...
    Private Sub nudKolicina_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles nudKolicina.Validating
        ...
        '-os. opterecenje ----------------------------------------------------------------------------
        If tbSifraNaknade.Text = "88" And (tbIvicniBroj.Text = "01" Or tbIvicniBroj.Text = "02") Then
            'fxIznosNak.Text = bIznos1 * CDec(dtNhm.Compute("SUM(Masa)/1000", String.Empty))
            nmOptDec = bIznos1 * CDec(dtNhm.Compute("SUM(Masa)/1000", String.Empty))
            bZaokruziNaDeseteNavise(nmOptDec)
            fxIznosNak.Text = nmOptDec
        Else
        ...
        '    If bSifraNaknade = "82" And bIvicniBroj = "13" Then
        '        'bIznosNakn = bIznosNakn + 1
        '    End If
        'End If
        'fxIznosNak.Text = bIznosNakn
    End Sub
    ...
    Private Sub btnPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrihvati.Click
        ...
        If dtNaknade.Rows.Count > 0 Then
            ...
            'mSumaNak = dtNaknade.Compute("SUM(Iznos)", String.Empty)
            mSumaNak = dtNaknade.Compute("SUM(Iznos)", "Action <> 'D'")

            Try
                mSumaNakCo = dtNaknade.Compute("SUM(Iznos)", "Action <> 'D' AND Obracun = 'C'")
            Catch ex As Exception
                mSumaNakCo = 0
            End Try

            mSumaNakRo = mSumaNak - mSumaNakCo
            Me.Close()
        Else
            mSumaNak = 0
    ...
    Private Sub tbSifraNaknade_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles tbSifraNaknade.Validating
        ...
        Else
            If IsNumeric(tbSifraNaknade.Text) = True Then
                ...
                End If
                If tbSifraNaknade.Text = "35" Or tbSifraNaknade.Text = "36" Or _
                   tbSifraNaknade.Text = "40" Or tbSifraNaknade.Text = "42" Or tbSifraNaknade.Text = "46" Then
    ...
    '        bNadjiSveIzZSNaknada(bSifraNaknade, bIvicniBroj, bVrstaSaobracaja, mTarifa, bDatum, _
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If mTarifa = "00" And (mVrstaObracuna = "CO" Or mVrstaObracuna = "IC" Or mVrstaObracuna = "CD") Then
    ...
    Private Sub fxIznosNak_Validating1(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles fxIznosNak.Validating
        btnDodajNak.Focus()
