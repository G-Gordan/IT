...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnKB
        '
        Me.btnKB.Location = New System.Drawing.Point(240, 112)
        Me.btnKB.Name = "btnKB"
        Me.btnKB.Size = New System.Drawing.Size(32, 23)
        Me.btnKB.TabIndex = 8
        Me.btnKB.Text = "KB"
        '
        'UpdateForm
...
#End Region
    ...
    Private Sub btnPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrihvati.Click
        ...
        If RecordAction = "N" Then   ' 1. ================== Azuriranje u OkpWinRoba + Makis ==========================
            ...
            Else       ' ---------- Uvoz, Izvoz
                ...
                'If Microsoft.VisualBasic.Left(izUgovor, 4) = "0786" Then                6.9.2016
                '6.9.2016
                If (Microsoft.VisualBasic.Left(izUgovor, 4) = "0786") Or _
                    (Microsoft.VisualBasic.Left(izUgovor, 4) = "0186") Or _
                    (Microsoft.VisualBasic.Left(izUgovor, 4) = "0386") Or _
                    (Microsoft.VisualBasic.Left(izUgovor, 4) = "0586") Then
                ...
                If IzborSaobracaja = "2" Then
                    ...
                    'If Not (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Then          6.9.2016

                    '6.9.2016
                    If Not ((Microsoft.VisualBasic.Left(izUgovor, 4) = "0786") Or _
                        (Microsoft.VisualBasic.Left(izUgovor, 4) = "0186") Or _
                        (Microsoft.VisualBasic.Left(izUgovor, 4) = "0386") Or _
                        (Microsoft.VisualBasic.Left(izUgovor, 4) = "0586")) Then
    ...
    Private Sub UpdateForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'NumericUpDown4.Text = mObrMesec                            30.03.2016
    ...
    Private Sub btnPreuzmi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreuzmi.Click
        ...
        If Me.cbCORO.Visible = True Then
            If Me.cbCORO.Checked = True Then        '!!! razgraniciti po ugovorima - "CO" ili "CD"
                mVrstaObracuna = "CO"
            Else
                mVrstaObracuna = "RO"
            End If
        ...
        If mVrstaObracuna = "CO" Or mVrstaObracuna = "CD" Then
            ...
            If mBrojUg = "101344" Or mBrojUg = "101345" Then
                mVrstaPrevoza = "V"
            End If
            If mBrojUg = "600300" Or mBrojUg = "600301" Or mBrojUg = "600302" Or mBrojUg = "600311" Then
                If rbP.Checked = True Then
                    mVrstaPrevoza = "P"
                End If
                If Me.rbG.Checked = True Then
                ...
                End If
            End If
            If mBrojUg = "061600" Or mBrojUg = "061601" Or mBrojUg = "061622" Or mBrojUg = "061611" Then
                If rbP.Checked = True Then
                    mVrstaPrevoza = "P"
                End If
                If Me.rbG.Checked = True Then
    ...
    Private Sub cbCORO_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbCORO.Leave
        If Me.cbCORO.Visible = True Then
            If Me.cbCORO.Checked = True Then
                mVrstaObracuna = "CO"       '!!! razgraniciti po ugovorima "CO" ili "CD"
            Else
                mVrstaObracuna = "RO"
            End If
        End If
    ...
    Private Sub TextBox3_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TextBox3.Validating
        ...
        '    b5Modul(TextBox3.Text, KB5)
        '    MessageBox.Show("Za " & TextBox3.Text & " kontrolni broj je " & KB5 & " .", "Kontrolni broj", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '    'TextBox3.Focus()
        'End If
        btnPrihvati.Focus()
    End Sub

    Private Sub btnKB_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnKB.Click
        Dim KB5 As String
        If (TextBox3.TextLength <= 5) And (TextBox3.Text <> "0") And (TextBox3.Text <> " ") Then
            b5Modul(TextBox3.Text, KB5)
            MessageBox.Show("Za " & TextBox3.Text & " kontrolni broj je " & KB5 & " .", "Kontrolni broj", MessageBoxButtons.OK, MessageBoxIcon.Information)
            'TextBox3.Focus()
        End If
