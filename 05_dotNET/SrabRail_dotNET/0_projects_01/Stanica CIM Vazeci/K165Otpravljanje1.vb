...
Public Class K165Otpravljanje
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DatumOt As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedK165Otpravljanje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As K165Otpravljanje = New K165Otpravljanje
        rpt.Site = Me.Site
        Return rpt
    End Function
