...
Public Class StampaIzvestajWinRoba
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "StampaIzvestajWinRoba.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Štampa As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedStampaIzvestajWinRoba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StampaIzvestajWinRoba = New StampaIzvestajWinRoba
        rpt.Site = Me.Site
        Return rpt
    End Function
