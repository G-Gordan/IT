        ...
        Try
            ...
            Do Until EOF(1)
                ...
                Select Case parNaziv
                    ...
                    Case "FTP2"
                        FolderFtp2 = parVrednost
                    Case "ECIM"
                        eCimDa = parVrednost
                    Case "RD"
                        eRD = parVrednost
                    Case "BORDER" 'TLSNET
                        GranicnaStanica = parVrednost
                    Case Else
