...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'lblUser
        '
        Me.lblUser.Location = New System.Drawing.Point(224, 48)
        ...
        Me.tbUser.Size = New System.Drawing.Size(80, 24)
        ...
        Me.btnPrihvati.Location = New System.Drawing.Point(224, 168)
        ...
        'lblPass
        '
        Me.lblPass.Location = New System.Drawing.Point(224, 96)
        ...
        Me.tbPass.Location = New System.Drawing.Point(312, 96)
        Me.tbPass.MaxLength = 6
        Me.tbPass.Name = "tbPass"
        Me.tbPass.PasswordChar = Microsoft.VisualBasic.ChrW(42)
        Me.tbPass.Size = New System.Drawing.Size(80, 24)
        ...
        Me.btnOtkazi.Location = New System.Drawing.Point(312, 168)
        ...
        Me.PictureBox1.Size = New System.Drawing.Size(199, 144)
        ...
        Me.Panel1.Size = New System.Drawing.Size(410, 25)
        ...
        Me.Label3.Size = New System.Drawing.Size(199, 14)
        ...
        Me.Text = "Prijavljivanje na sistem - eCIM"
...
#End Region
    ...
    Private Sub btnPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrihvati.Click
        ...
        Else
            ...
            form2s.Text = Microsoft.VisualBasic.Right(StanicaUnosa, Len(StanicaUnosa) - 10)
            form2s.ShowDialog()
            Close()
    ...
    Private Sub login_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'clsProcess.StartInfo.Arguments = "10.0.4.31"
        'clsProcess.Start()
        'Dim sOutput As String = clsProcess.StandardOutput.ReadToEnd()
        'clsProcess.WaitForExit()

        'Dim clsWriter As System.IO.TextWriter = System.IO.File.AppendText("C:\output.txt")
        'clsWriter.WriteLine(sOutput)
        'clsWriter.Flush()
        'clsWriter.Close()
        ''clsWriter.Dispose()
        ...
        Try
            ...
            If opPovVrednost = "" Then
                ...
                End If
                Label3.Text = "Stanica unosa: " & RTrim(Microsoft.VisualBasic.Mid(StanicaUnosa, 11, Len(StanicaUnosa) - 10))
            Else
