...
Module Util
    ...
    Public Sub IzjavaZs_Ex()
        ...
        If (mTarifa = "68" Or kSifTar = 68) Or (Microsoft.VisualBasic.Right(mBrojUg, 2) = "92" And mVrstaObracuna = "CO") Or ((mBrojUg = 517902 Or mBrojUg = 517903) And mVrstaObracuna = "RO") Then
