...
#End Region
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf upit = "UIC_GR" Then
            strUpit = "SELECT SifraPrelaza AS [Sifra prelaza], Naziv AS [Naziv prelaza] " _
                    & "FROM UicPrelazi " _
                    & "WHERE (Uprava1 = '" & mUicPrelaz & "')" & " AND (Uprava2 = '" & nmUpravaNext & "')" & " AND (LEFT(SifraPrelaza, 1) = '0')"
        ...
        ElseIf upit = "UIC_OP" Then
            strUpit = "SELECT SifraOperatera, Oznaka, Naziv FROM UicOperateri WHERE (SifraOperatera <> '0000') AND (SifraUprave = '" & nmUic & "') ORDER BY SifraOperatera"
            Me.DataGrid1.CaptionText = "UIC operateri"
        ElseIf upit = "UPR1" Then
            strUpit = "SELECT SifraOperatera as Operater, Oznaka, Naziv, SifraUprave AS Zemlja FROM UicOperateri WHERE (SifraOperatera <> '0000')"
            'strUpit = "SELECT Operater, SifraUprave, Oznaka, Naziv FROM dbo.UicOperateri"
            Me.DataGrid1.CaptionText = "UIC operateri"
        ElseIf upit = "UPR2" Then
            strUpit = "SELECT SifraOperatera as Operater, Oznaka, Naziv, SifraUprave AS Zemlja FROM UicOperateri WHERE (SifraOperatera <> '0000')"
            'strUpit = "SELECT  SifraOperatera, Oznaka, Naziv, Zemlja AS Zemlja FROM UicOperateri WHERE (SifraUprave <> '00')"
            Me.DataGrid1.CaptionText = "UIC operateri"
        ...
        ElseIf upit = "NAK" Then
            strUpit = "SELECT Sifra, IvicniBroj, Naziv FROM dbo.ZsNaknade WHERE (SifraVS = '0')" ' nove naknade
        ...
        ElseIf upit = "INDKOL" Then
            ...
            If IzborSaobracaja = "2" Then
                strUpit = "SELECT SifraKoloseka, Firma, Iznos1Eur, Iznos2Eur, Iznos3Eur, VaziOd, VaziDo " _
                       & " FROM ZsIndKoloseci " _
                       & " WHERE (SifraStanice = '72" & tmp_MMStanica1 & "')"
            Else
                strUpit = "SELECT SifraKoloseka, Firma, Iznos1Eur, Iznos2Eur, Iznos3Eur, VaziOd, VaziDo " _
                                       & " FROM ZsIndKoloseci " _
                                       & " WHERE (SifraStanice = '72" & tmp_MMStanica1 & "')"
        ...
        ElseIf upit = "VPP" Then
            strUpit = "SELECT SIFRA, TKM, SKM, VIA " _
    ...
    Private Sub DataGrid1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.DoubleClick
        ...
        ElseIf upit = "UPR1" Then
            mIzlaz1 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 0) 'sifra
            mIzlaz2 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 1) 'naziv
            mIzlaz1add = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 3) 'zemlja
        ...
        ElseIf upit = "UPR2" Then
            ...
            ''mIzlaz1 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 0) '+ DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 1) 'sifra
            ''mIzlaz2 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 1) 'naziv
            'mIzlaz4 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 3) 'zemlja
        ElseIf upit = "NAKPB" Then
        ...
        ElseIf upit = "NAK" Then
            ...
            mIzlaz2 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 1) 'naziv
        ElseIf upit = "NAK2" Then
            mIzlaz2 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 0) '
            mIzlaz3 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 1) '
        ElseIf upit = "INDKOL" Then
            'mIzlaz1 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 0) 'sifra
            ...
            mIzlaz1 = bIzlaz1
            bIzlazNazivKoloseka = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 1) 'naziv
