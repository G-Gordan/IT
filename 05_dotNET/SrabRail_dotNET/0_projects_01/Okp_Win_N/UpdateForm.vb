    ...
    Private Sub btnPreuzmi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreuzmi.Click
        ...
        If mVrstaObracuna = "CO" Then
            ...
            If mBrojUg = "101205" Or mBrojUg = "101206" Or _
               ...
               mBrojUg = "801405" Or mBrojUg = "801406" Or mBrojUg = "801506" Then
                mVrstaPrevoza = "V"
            End If
            ...
            If mBrojUg = "301422" Or mBrojUg = "301522" Or mBrojUg = "301322" Then
                mVrstaPrevoza = "P"
            End If
            If mBrojUg = "301423" Or mBrojUg = "301523" Or mBrojUg = "301323" Then
                mVrstaPrevoza = "G"
            End If
            If mBrojUg = "301424" Or mBrojUg = "301524" Or mBrojUg = "301324" Then
                mVrstaPrevoza = "V"
            End If
    ...
    Private Sub idVrstaObracuna()
        ...
        Else
            ...
            If tbUgovor.Text = "835753" Or tbUgovor.Text = "955401" Or tbUgovor.Text = "835771" Then
                ...
                mVrstaPrevoza = "V"
            End If
            If tbUgovor.Text = "301522" Or tbUgovor.Text = "301222" Or tbUgovor.Text = "301322" Or tbUgovor.Text = "301422" Then
                Me.gbVrP.Visible = True
                Me.rbP.Enabled = True
                Me.rbP.Checked = True
                Me.rbG.Enabled = False
                ...
                mVrstaPrevoza = "P"
            End If
            If tbUgovor.Text = "301523" Or tbUgovor.Text = "301323" Or tbUgovor.Text = "301423" Then
                Me.gbVrP.Visible = True
                Me.rbP.Enabled = False
                Me.rbG.Enabled = True
                Me.rbG.Checked = True
