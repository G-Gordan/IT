...
Module KalkModulKatarina
    Public Sub bNadjiPrevozninuROKP(ByRef kPrevoznina As Decimal, ByRef kPovVrROKP As String)
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' pocetak petlje po kolima
                ...
                If dtNhm.Rows.Count > 0 Then
                    ...
                    For Each NHMRed In dtNhm.Rows
                        If NHMRed.Item("IndBrojKola") = IBK Then
                            ...
                            '**********
                            '*****Bato, ovo proveri ovako je kod mene!*****
                ...
                If kNacinObrac = 1 Then
                    ...
                    ' *********** Bato ja sam prebacila moje do kraja racunanja po nacinu obracuna, a tvoje sam stavila pod komentar*******
                ...
                ElseIf kNacinObrac = 2 Then
                    ...
                    If PrevozninaPoUg <= bMinPrevoznina Then
                        PrevozninaPoUg = bMinPrevoznina
                        kPrevMin = kPrevMin + PrevozninaPoUg
                        'Else : kPrevMin = kPrevoznina + PrevozninaPoUg
                    End If
                    'kPrevoznina = PrevozninaPoUg
                ...
                ElseIf kNacinObrac = 3 Then
                    ...
                    '                                   kBrOsov, kIznosMinPrev, Uprava, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU1, TipUTI, kTonskiStav, kPovVr)
                    k2NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, KolaZ, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
                ...
                ElseIf kNacinObrac = 5 Then
                    ...
                    '      kBrOsov, kIznosMinPrev, Uprava, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU2, TipUTI, MasaTempT, kPovVr)
                    k3NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, KolaZ, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
        ...
        If (kNacinObrac = 2 Or kNacinObrac = 3) And mVrstaPrevoza = "V" Then
            bZaokruziMasuNa100k(RacMasaPoKolima)
        ...
        ElseIf kNacinObrac = 2 Then
            ...
            '3. cena po toni za odreðeni tonski stav ( date su cene za 10-to tonski stav, 15-to tonski stav, ... )
        ElseIf kNacinObrac = 3 Then
            Aneks = 0
            kNacinObrac = 0
            kIznosMinPrev = 0
            ...
            ElseIf kNacinObrac = 0 Then
                ...
                Else
                    mTabelaCena = "122"
                End If
                bNadjiVozarinskiStav(mTabelaCena, mDatumKalk, MasaTempT, bTkm, bRazred, VozarinskiStav, PV)
            ...
            If dtNhm.Rows.Count > 0 Then
                For Each NHMRed In dtNhm.Rows
                    If NHMRed.Item("IndBrojKola") = IBK Then
                        ...
                        'k3NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, KolaZ, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
                        '                  kBrOsov, kIznosMinPrev, Uprava, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU2, TipUTI, MasaTemp / 1000, kPovVr)
                        MasaUti = MasaTemp
...
'                k1NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, KolaZ, kStatus, OdStan, DoStan, kNacinObrac, _
'                                  bValuta, kBrOsov, kIznosMinPrev, Uprava, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU2, TipUTI, kPovVr)
