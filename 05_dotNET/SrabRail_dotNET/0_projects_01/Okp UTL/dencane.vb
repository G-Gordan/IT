...
#End Region
    ...
    Private Sub btnPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrihvati.Click
        ...
        _OpenForm = "RobaDencane"
        Close()
    End Sub

    Private Sub tbDenMasa_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles tbDenMasa.Validating
        If tbDenMasa.Text = "" Or tbDenMasa.Text = "0" Then
            btnPrihvati.Focus()
        End If
    End Sub
End Class
