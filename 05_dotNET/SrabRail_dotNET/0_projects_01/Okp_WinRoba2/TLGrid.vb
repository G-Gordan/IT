...
#End Region
    ...
    Private Sub TLGrid_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If AkcijaZaPreuzimanje = "Ne" Then 'Izmena u bazi
            If OkpDbVeza.State = ConnectionState.Closed Then
                OkpDbVeza.Open()
            End If
        Else 'Preuzimanje sa granice
        ...
        Dim sql_UpitPregled As String = "SELECT SlogKalk.OtpUprava AS Operater, SlogKalk.OtpStanica AS Stanica, SlogKalk.OtpBroj AS Broj, SlogKalk.OtpDatum AS Datum, " & _
                                        ...
                                        "WHERE (SlogKalk.OtpUprava = '" & mOtpUprava & "') AND (SlogKalk.OtpStanica = '" & mOtpStanica & "') AND (SlogKalk.OtpBroj = " & mOtpBroj & " ) AND Saobracaj <> '1'"
        '"WHERE (SlogKalk.Saobracaj = '" & Microsoft.VisualBasic.Mid(StanicaUnosa, 9, 1) & "')  AND (SlogKalk.OtpUprava = '" & mOtpUprava & "') AND (SlogKalk.OtpStanica = '" & mOtpStanica & "') AND (SlogKalk.OtpBroj = " & mOtpBroj & " )"
