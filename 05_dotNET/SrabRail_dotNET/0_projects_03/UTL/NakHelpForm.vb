...
#End Region
    ...
    Private Sub NakHelpForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If mTarifa = "68" Then
            Dim adNakHelp As New SqlDataAdapter("SELECT Sifra, IvicniBroj, Podbroj,Naziv,Iznos1 From ZsNaknade " _
                                                                    & "WHERE (Sifra = '" & bSifraNaknade & "')" & " AND (IvicniBroj = '" & bIvicniBroj & "')" & " AND (SifraValute = '" & bValuta & "')" _
    ...
    Private Sub DataGrid1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.DoubleClick
        ...
        mIzlaz3 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 4) 'iznos
        bIzlaz1 = DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 2) 'podbroj
        Close()
    End Sub
