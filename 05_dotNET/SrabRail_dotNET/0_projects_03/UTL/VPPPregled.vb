...
Public Class VPPPregled
    ...
    Dim bSifraVPP1 As Integer = 0
    Dim bSifraVPP2 As Integer = 0
    Dim bbSkm As Integer = 0
    Dim bbTkm As Integer = 0
    Dim bbOpisVPP As String = ""
    Dim bNazivStanice1, bNazivStanice2, bPP As String
...
#End Region
    ...
    Private Sub VPPPregled_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        bNadjiNazivStanice72L(St1, bNazivStanice1, Povrvrednost)
        bNadjiNazivStanice72L(St2, bNazivStanice2, Povrvrednost)
        ...
        string1 = "SELECT     SifraVPP, Skm, Tkm " & _
                "FROM   Dalj_VPP " & _
                "WHERE  (Stanica1 = '" & St1 & "') And (Stanica2 = '" & St2 & "')"
