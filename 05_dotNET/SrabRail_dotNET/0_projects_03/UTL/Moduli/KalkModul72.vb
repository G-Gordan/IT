        ...
        If bVrstaSaobracaja = 0 Then                    'RSD
            ...
            ElseIf mVrstaPrevoza = "V" Then
                ...
                Else
                    'nema ni kola ni prevoznine
                End If
                outPrevoznina = RacMasaZaAneks * ugCena / 1000
                bZaokruziNaDeseteNavise(outPrevoznina)

                If outPrevoznina < bMinPrevoznina * dtKola.Rows.Count Then
                    outPrevoznina = bMinPrevoznina * dtKola.Rows.Count
                End If
        ...
        ElseIf (bVrstaSaobracaja <> 0) Then             'EUR
            ...
            If dtKola.Rows.Count > 0 Then
                ...
                For Each KolaRed In dtKola.Rows    ' petlja po kolima
                    ...
                    If (ugTipCene <> 5 And ugTipCene <> 10 And ugTipCene <> 15) And Not (bSmartCargoSmedRadTR) Then
                        If PrevozninaPoKolima <= bMinPrevoznina Then
                            PrevozninaPoKolima = bMinPrevoznina
                        End If
                    End If
