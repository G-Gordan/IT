...
Module KalkModulKatarina '25.01.2010
    Public Sub bNadjiPrevozninuROKP(ByRef kPrevoznina As Decimal, ByRef kPovVrROKP As String)
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                bNadjiSveIzZSKoefPos(IzborSaobracaja, "36", bVrstaPosiljke, "M", kVlasn, _
                ...
                'za testiranje vozova i u tab Ugovori izmeniti Saobr


                ' dodato za unutrasnji ( i u bazi uvek Uprava = "72" 

                Uprava = "72"

                ' dodato za unutrasnji

                k1NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
                kBrOsov, kIznosMinPrev, Uprava, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU2, TipUTI, kPovVr)
                ...
                If kStatus = "P" Then
                    ...
                    End If
                    k1NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
                                    kBrOsov, kIznosMinPrev, Uprava, _mNHM, Pojed, Grupa, Voz, MasaU1, MasaU2, tUTI, kPovVr)
                End If
                        ...
                        If NHMRed.Item("IndBrojKola") = IBK Then
                            ...
                            ElseIf kNacinObrac = 2 Then
                                ...
                                If mVrstaPrevoza = "V" Then
                                    ...
                                    'If PrevV <= bMinPrevoznina Then
                                    '    PrevV = bMinPrevoznina
                                    'End If
                                    PrevozninaPoUg = PrevV
                                    bVozarinskiStavPoKolima = Voz
                                End If
                            ...
                            ElseIf kNacinObrac = 3 Then
                                ...
                                k2NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
                            ...
                            ElseIf kNacinObrac = 5 Then
                                ...
                                k3NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
                            ...
                            'KolaRed.Item("VozarinskiStav") = dtNhm.Rows(0).Item("VozarinskiStavNHM")
        ...
        '    End If
        'Next
        '    KolaRed.Item("RacunskaMasa") = bRacunskaMasaNHM
        '    KolaRed.Item("VozarinskiStav") = bVozarinskiStavPoKolima
        'Next
