...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.NumericUpDown3.Minimum = New Decimal(New Integer() {2006, 0, 0, 0})
        ...
        Me.NumericUpDown3.Value = New Decimal(New Integer() {2008, 0, 0, 0})
        '
        'tbUgovor
        '
        ...
        'Button1
        '
        Me.Button1.Location = New System.Drawing.Point(330, 608)
...
#End Region
    ...
    Private Sub btnPreuzmi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreuzmi.Click
        ...
        If mVrstaObracuna = "CO" Then
            ...
            If mBrojUg = "101070" Or mBrojUg = "111070" Or mBrojUg = "121070" Then
                mVrstaPrevoza = "G"
            End If
            If mBrojUg = "301122" Then
                mVrstaPrevoza = "P"
            End If
            If mBrojUg = "300823" Or mBrojUg = "300923" Or mBrojUg = "301023" Or mBrojUg = "301123" Then
                mVrstaPrevoza = "G"
            End If
            If mBrojUg = "300824" Or mBrojUg = "300924" Or mBrojUg = "301024" Or mBrojUg = "301124" Then
                mVrstaPrevoza = "V"
            End If
    ...
    Private Sub tbUgovor_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbUgovor.Leave
        ...
        Else
            ...
            If tbUgovor.Text = "301122" Then
                ...
                mVrstaPrevoza = "P"
            End If
            If tbUgovor.Text = "300823" Or tbUgovor.Text = "300923" Or tbUgovor.Text = "301023" Or tbUgovor.Text = "301123" Then
                Me.gbVrP.Visible = True
            ...
            If tbUgovor.Text = "101070" Or tbUgovor.Text = "111070" Or tbUgovor.Text = "121070" Then
                ...
                mVrstaPrevoza = "G"
            End If
            If tbUgovor.Text = "300824" Or tbUgovor.Text = "300924" Or tbUgovor.Text = "301024" Or tbUgovor.Text = "301124" Then
                Me.gbVrP.Visible = True
                Me.rbP.Enabled = False
                Me.rbG.Enabled = False
                Me.rbV.Enabled = True
