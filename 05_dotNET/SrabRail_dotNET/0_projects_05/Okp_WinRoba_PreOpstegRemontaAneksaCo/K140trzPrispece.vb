...
Public Class K140trzPrispece
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_UlDatum As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedK140trzPrispece
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As K140trzPrispece = New K140trzPrispece
        rpt.Site = Me.Site
        Return rpt
    End Function
