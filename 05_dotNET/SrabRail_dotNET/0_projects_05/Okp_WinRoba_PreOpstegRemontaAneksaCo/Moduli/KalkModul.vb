...
Module KalkModul
    ...
    Public Sub bNadjiPrevozninuTEA(ByVal Tabela As String, ByRef Prevoznina As Decimal)
        ...
        For Each KolaRed In dtKola.Rows                ' glavna petlja po kolima za racunanje prevoznine; tu se racunaju i tovarena stitna kola
            ...
            If Microsoft.VisualBasic.Left(NHMRed.Item("NHM"), 4) = "8606" Then
                DaLiJe8606 = "DA"
            Else
                DaLiJe8606 = "NE"
            End If
        ...
        For Each KolaRed In dtKola.Rows                                         ' petlja po kolima
            ...
            For Each NHMRed In dtNhm.Rows
                If IBK = NHMRed.Item("IndBrojKola") Then
                    ...
                    If (mBrojUg = "031022" Or mBrojUg = "031122") Then
                        'If ((mBrojUg = "030722") Or (mBrojUg = "030822") Or (mBrojUg = "030922") Or (mBrojUg = "031022") Or (mBrojUg = "031122")) And (mDatumKalk >= #2/1/2008#) Then
                        bNadjiVozarinskiStavAgit(VozarinskiStav)
                        bNadjiRasterCO(DuzinaKont, StvMasa, Raster) ' samo za 16050,16051,21001!
                        ...
                        Else
                            ...
                            NadjiAneks(mBrojUg, bVrstaSaobracaja, mStanica1, mStanica2, _
                               BrOsovina, mVrstaPrevoza, Vlasnistvo, Stitna, mDatumKalk, Microsoft.VisualBasic.Left(NHM, 4), 20, _
                               ugCena, ugTipCene, ugRetVal)

                            If ugTipCene = 9 Then ' ne vazi raster
                                KolKoef = 1
                                bPrevozninaKoef = 1
                                bMinPrevoznina = 0
                                PrevozninaPoKont = ugCena
                                VozarinskiStav = ugTipCene
                            End If
                    ...
                    '    NadjiAneks(mBrojUg, bVrstaSaobracaja, mStanica1, mStanica2, _
                    '                BrOsovina, mVrstaPrevoza, Vlasnistvo, Stitna, mDatumKalk, Microsoft.VisualBasic.Left(NHM, 4), DuzinaKont, _
                    '                ugCena, ugTipCene, ugRetVal)

                    '    ' u Aneksima pise da masa UTI-ja mora da bude izmedju 16500 i 22000:
                    '    If (ugRetVal = "") And (StvMasa >= 16500) And (StvMasa <= 22000) Then
                ...
                If (mBrojUg = "030722") Or (mBrojUg = "030822") Or (mBrojUg = "030922") Or (mBrojUg = "031022") Or (mBrojUg = "031122") Then ' Agit
            ...
            Next        ' For Each NHMRed In dtNhm.Rows


            '============================ Militzer&Munch ==================================

            ' aneks T389f  (za '08) T510(za '09) T171(2011) (MMAneks)
            If ((mBrojUg = "300822") Or (mBrojUg = "300823") Or (mBrojUg = "300824") Or _
                (mBrojUg = "300922") Or (mBrojUg = "300923") Or (mBrojUg = "300924") Or _
                (mBrojUg = "301022") Or (mBrojUg = "301023") Or (mBrojUg = "301024") Or _
                (mBrojUg = "301122") Or (mBrojUg = "301123") Or (mBrojUg = "301124")) Then
                ...
                If (mBrojUg = "300822") Or (mBrojUg = "300922") Or (mBrojUg = "301022") Or (mBrojUg = "301122") Then
                ...
                If (mBrojUg = "300823") Or (mBrojUg = "300824") Or _
                   (mBrojUg = "300923") Or (mBrojUg = "300924") Or _
            ...
            ElseIf IzborSaobracaja = "4" Then      ' --------------- T R A N Z I T ----------------
                ...
                ElseIf mTarifa = "00" Then 'Ugovori
                    ...
                    If mVrstaObracuna = "IC" Then
                        ...
                        If mBrojUg = "835753" Then                   ' Adria Kombi
    ...
    Public Sub bNadjiBrutoMasu(ByRef BrutoMasa As Decimal, ByRef KoefPKola As Decimal)
        ...
        KoefPKola = 0.7 'vazi za sve ugovore u 2008. godini (sem Prodos, Sh, Exp)
