...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ToolBar1.Size = New System.Drawing.Size(1028, 96)
        ...
        Me.ToolBar2.Size = New System.Drawing.Size(1028, 42)
        ...
        Me.lbl_smasa.Location = New System.Drawing.Point(443, 50)
        Me.lbl_smasa.Name = "lbl_smasa"
        Me.lbl_smasa.Size = New System.Drawing.Size(88, 23)
        Me.lbl_smasa.TabIndex = 90
        Me.lbl_smasa.Text = "0"
        Me.lbl_smasa.TextAlign = System.Drawing.ContentAlignment.TopCenter
        '
        'lbl_nhm
        '
        ...
        Me.lbl_nhm.Location = New System.Drawing.Point(355, 50)
        Me.lbl_nhm.Name = "lbl_nhm"
        Me.lbl_nhm.Size = New System.Drawing.Size(72, 23)
        Me.lbl_nhm.TabIndex = 89
        Me.lbl_nhm.Text = "0"
        Me.lbl_nhm.TextAlign = System.Drawing.ContentAlignment.TopCenter
        '
        'lbl_tara
        '
        ...
        Me.lbl_tara.Location = New System.Drawing.Point(259, 50)
        Me.lbl_tara.Name = "lbl_tara"
        Me.lbl_tara.Size = New System.Drawing.Size(81, 23)
        Me.lbl_tara.TabIndex = 88
        Me.lbl_tara.Text = "0"
        Me.lbl_tara.TextAlign = System.Drawing.ContentAlignment.TopCenter
        '
        'lbl_ibk
        '
        ...
        Me.lbl_ibk.Location = New System.Drawing.Point(131, 50)
        Me.lbl_ibk.Name = "lbl_ibk"
        Me.lbl_ibk.Size = New System.Drawing.Size(128, 23)
        Me.lbl_ibk.TabIndex = 87
        Me.lbl_ibk.Text = "0"
        Me.lbl_ibk.TextAlign = System.Drawing.ContentAlignment.TopCenter
        '
        'L_SMasa
        '
        ...
        Me.L_SMasa.Location = New System.Drawing.Point(435, 26)
        Me.L_SMasa.Name = "L_SMasa"
        Me.L_SMasa.Size = New System.Drawing.Size(112, 23)
        ...
        Me.L_NHM.Location = New System.Drawing.Point(371, 26)
        Me.L_NHM.Name = "L_NHM"
        Me.L_NHM.Size = New System.Drawing.Size(48, 23)
        ...
        Me.L_Tara.Location = New System.Drawing.Point(275, 26)
        Me.L_Tara.Name = "L_Tara"
        Me.L_Tara.Size = New System.Drawing.Size(72, 23)
        ...
        Me.l_Kola.Location = New System.Drawing.Point(131, 26)
        Me.l_Kola.Name = "l_Kola"
        Me.l_Kola.Size = New System.Drawing.Size(128, 23)
        Me.l_Kola.TabIndex = 83
        Me.l_Kola.Text = "Individualni broj kola"
        '
        'lbl_PkolaProdos
        '
        Me.lbl_PkolaProdos.Font = New System.Drawing.Font("Microsoft Sans Serif", 40.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(238, Byte))
        Me.lbl_PkolaProdos.ForeColor = System.Drawing.Color.Red
        Me.lbl_PkolaProdos.Location = New System.Drawing.Point(80, 21)
        Me.lbl_PkolaProdos.Name = "lbl_PkolaProdos"
        Me.lbl_PkolaProdos.Size = New System.Drawing.Size(52, 64)
        ...
        Me.ClientSize = New System.Drawing.Size(1028, 705)
...
#End Region
                ...
                If mVrstaPrevoza = "V" Then
                    ...
                    Else
                        If UpisPoKolima = False Then ' redovan upis cena za vozove - na prvim kolima
                            If CDec(tbKolaRealizovano.Text) > 0 Then
                                '***
                                'Upis zaostalih kola iz prethodnog ili istog meseca
                                'PROVERITI MAKIS!!

                                If Info_ObrMesec <> mObrMesec Then
                                    If Info_ObrIzvos <> mPrevoznina Then
                                        fxPrevoznina.Text = Math.Abs(Info_ObrIzvos - mPrevoznina)
                                    Else
                                        fxPrevoznina.Text = 0
                                    End If
                                Else
                        ...
                        If UpisPoKolima = False Then
                            ...
                            If Info_ObrMesec <> mObrMesec Then
                                If Info_ObrIzvos <> mPrevoznina Then
                                    ...
                                    '''''''''''''''.Text = Math.Abs(Info_ObrIzvos - mPrevoznina)
                                    .Text = Format(mPrevozninaRazlika, "###,###,##0.00")   '.ToString !! !!!!!!!!!!!!!!!!!!!!!!!!!1
                                Else
                                    .Text = 0
                                End If
                            Else
                                .Text = 0
                                'Korekciju cene za isti mesec radi posle upisa
                            End If
                            '======================================================================================

                            'pre ubacivanja Korekcije cene: .Text = 0
                        Else
                            '''''''''.Text = mPrevoznina

                            .Text = Format(mPrevoznina, "###,###,##0.00")   '.ToString !! !!!!!!!!!!!!!!!!!!!!!!!!!1
                        End If
                    Else
                        '''''''''''''''''''''''.Text = mPrevoznina   '.ToString
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        If dtKola.Rows.Count > 0 And dtNhm.Rows.Count > 0 Then
                ...
                For Each KolaRed In dtKola.Rows
                    ...
                    If KolaRed.Item("Vlasnik") = "Z" Then
                        ...
                        ElseIf mBrojUg = "931817" Then  'Eurolog
                            ...
                            ElseIf KolaRed.Item("Osovine") = 4 Then
                                KolaRed.Item("Naknada") = 52
                            Else ' nedefinisano ugovorom 2011
                                KolaRed.Item("Naknada") = 52
                            End If
                        Else                            'Intercontainer
            ...
            If mVrstaObracuna = "CO" Then
                ...
                Dim temp_Ibk As String
                For Each KolaRed In dtKola.Rows
                    If KolaRed.Item("Vlasnik") = "P" Then
                        If mBrojUg = "100901" Or mBrojUg = "100996" Or mBrojUg = "100997" Or _
                           mBrojUg = "101001" Or mBrojUg = "101096" Or mBrojUg = "101101" Or mBrojUg = "101196" Then    'Proodos     #$#
    ...
    Private Sub cbNajava_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cbNajava.Validating
        ...
        If MasterAction = "New" And RecordAction <> "P" Then
            ...
            ' 16092010 -------------------- Obracunski mesec u kome je fakturisan iznos  ----------------
            If OkpDbVeza.State = ConnectionState.Closed Then
                OkpDbVeza.Open()
            End If
            ...
            Catch ex As Exception
                MsgBox(ex)
            End Try
            ' 16092010 -------------------- Obracunski mesec u kome je fakturisan iznos  END ----------------

            ' podesavanje granicnih prelaza 
            Select Case _cbStanica1
                Case "7223499"
                    cbSmer1.Text = "1 - 23499 Subotica"
                Case "7222899"
                    cbSmer1.Text = "2 - 22899 Kikinda"
                Case "7221099"
                    cbSmer1.Text = "3 - 21099 Vrsac"
                Case "7212498"
                    cbSmer1.Text = "4 - 12498 Dimitrovgrad"
                Case "7211028"
                    cbSmer1.Text = "5 - 11028 Presevo"
                Case "7215723"
                    cbSmer1.Text = "6 - 15723 Prijepolje Teretna"
                Case "7216319"
                    cbSmer1.Text = "7 - 16319 Brasina"
                Case "7216517"
                    cbSmer1.Text = "8 - 16517 Sid"
                Case "7216201"
                    cbSmer1.Text = "9 - 16201 Beograd Ranzirna"
                Case "7225471"
                    cbSmer1.Text = "10- 25471 Bogojevo"
            End Select
            Select Case _cbStanica2
                Case "7223499"
                    cbSmer2.Text = "1 - 23499 Subotica"
                Case "7222899"
                    cbSmer2.Text = "2 - 22899 Kikinda"
                Case "7221099"
                    cbSmer2.Text = "3 - 21099 Vrsac"
                Case "7212498"
                    cbSmer2.Text = "4 - 12498 Dimitrovgrad"
                Case "7211028"
                    cbSmer2.Text = "5 - 11028 Presevo"
                Case "7215723"
                    cbSmer2.Text = "6 - 15723 Prijepolje Teretna"
                Case "7216319"
                    cbSmer2.Text = "7 - 16319 Brasina"
                Case "7216517"
                    cbSmer2.Text = "8 - 16517 Sid"
                Case "7216201"
                    cbSmer2.Text = "9 - 16201 Beograd Ranzirna"
                Case "7225471"
                    cbSmer2.Text = "10- 25471 Bogojevo"
            End Select
    ...
    Private Sub dgError_Navigate(ByVal sender As System.Object, ByVal ne As System.Windows.Forms.NavigateEventArgs) Handles dgError.Navigate
