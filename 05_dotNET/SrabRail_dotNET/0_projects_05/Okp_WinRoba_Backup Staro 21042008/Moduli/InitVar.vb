Module InitVar
    ...
    Friend mak1Col2 As DataColumn = dtMakis1.Columns.Add("Izlaz", Type.GetType("System.String"))
    ...
    Friend korCol3 As DataColumn = dtKorekcija.Columns.Add("Izlaz", Type.GetType("System.Int32"))
    ...
    Friend korCol11 As DataColumn = dtKorekcija.Columns.Add("NakZaZKola", Type.GetType("System.Decimal"))
    ...
    Friend kCol3 As DataColumn = dtKola.Columns.Add("Uprava", Type.GetType("System.String"))
    ...
    Friend kCol7 As DataColumn = dtKola.Columns.Add("Osovine", Type.GetType("System.Int16"))
    ...
    Friend rCol3 As DataColumn = dtNhm.Columns.Add("R", Type.GetType("System.String")) ' 14.                                     3
    Friend rCol4 As DataColumn = dtNhm.Columns.Add("RID", Type.GetType("System.String")) ' 17.                                  4
    Friend rCol6 As DataColumn = dtNhm.Columns.Add("UTI", Type.GetType("System.String")) ' 18.                                  5 tip 
    ...
    'dsSlogKola.Tables(0).Rows(jj).Item(1), 
    'dsSlogKola.Tables(0).Rows(jj).Item(13), 
    'dsSlogKola.Tables(0).Rows(jj).Item(15), _
    'dsSlogKola.Tables(0).Rows(jj).Item(14), 
    'dsSlogKola.Tables(0).Rows(jj).Item(17), _
    'dsSlogKola.Tables(0).Rows(jj).Item(18), 
    '"", 
    '0, 
    '0, 
    '"", 
    '"", 
    '"", 
    'dsSlogKola.Tables(0).Rows(jj).Item(16), 
    'dsSlogKola.Tables(0).Rows(jj).Item(20), 
    '"U"}
    ...
    Friend dkCol0 As DataColumn = dtK211.Columns.Add("Sifra", Type.GetType("System.String"))
