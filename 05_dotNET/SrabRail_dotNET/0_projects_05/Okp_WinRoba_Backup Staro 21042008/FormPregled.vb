...
#End Region
    ...
    Private Sub btnPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrihvati.Click
        ...
        If rbSve.Checked = True Then
            sql_UpitPregled = "SELECT OtpUprava, OtpStanica, OtpBroj, OtpDatum, ZsUlPrelaz, UlEtiketa, ZsIzPrelaz, IzEtiketa, PrUprava, PrStanica, Ugovor, Najava, UkupnoKola, tlSumaFr, tlPrevFr, tlNakFr, tlNakCo82 " & _
                                         "FROM dbo.SlogKalk " & _
        ...
        If rbUgovori.Checked = True Then
            sql_UpitPregled = "SELECT Ugovor, Najava, OtpUprava, OtpStanica, OtpBroj, OtpDatum, ZsUlPrelaz, UlEtiketa, ZsIzPrelaz, IzEtiketa, PrUprava, PrStanica,  UkupnoKola, tlSumaFr, tlPrevFr, tlNakFr, tlNakCo82 " & _
                                         "FROM dbo.SlogKalk " & _
        ...
        If rbUgovor.Checked = True Then
            If TextBox1.Text <> "" Then
                ...
                If TextBox2.Text <> "" Then
                    ...
                    If Microsoft.VisualBasic.Mid(mNajava, 1, 1) = "X" Then
                        sql_UpitPregled = "SELECT dbo.SlogKalk.Najava, dbo.SlogKalk.OtpUprava, dbo.SlogKalk.OtpStanica, dbo.SlogKalk.OtpBroj, " & _
                                                     ...
                                                     "UkupnoKola, dbo.SlogKola.IBK, dbo.SlogKola.Tara, dbo.SlogRoba.SMasa, dbo.SlogKalk.rSumaFr, dbo.SlogKalk.rPrevFr, dbo.SlogKalk.rNakFr " & _
                    ...
                    Else
                        sql_UpitPregled = "SELECT dbo.SlogKalk.Najava, dbo.SlogKalk.OtpUprava, dbo.SlogKalk.OtpStanica, dbo.SlogKalk.OtpBroj, " & _
                                                     "dbo.SlogKalk.ZsUlPrelaz, dbo.SlogKalk.UlEtiketa, dbo.SlogKalk.ZsIzPrelaz, dbo.SlogKalk.IzEtiketa, dbo.SlogKalk.PrUprava, dbo.SlogKalk.PrStanica, " & _
                                                     "UkupnoKola, dbo.SlogKola.IBK, dbo.SlogKola.Tara, dbo.SlogRoba.SMasa, dbo.SlogKalk.tlSumaFr, dbo.SlogKalk.tlPrevFr, dbo.SlogKalk.tlNakFr, dbo.SlogKalk.tlNakCo82 " & _
                                                     "FROM dbo.SlogKalk INNER JOIN " & _
                                                     "dbo.SlogKola ON dbo.SlogKalk.RecID = dbo.SlogKola.RecID AND dbo.SlogKalk.Stanica = dbo.SlogKola.Stanica INNER JOIN " & _
                                                     "dbo.SlogRoba ON dbo.SlogKola.RecID = dbo.SlogRoba.RecID AND dbo.SlogKola.Stanica = dbo.SlogRoba.Stanica AND " & _
                                                     "dbo.SlogKola.KolaStavka = dbo.SlogRoba.KolaStavka " & _
                ...
                Else
                    sql_UpitPregled = "SELECT OtpUprava, OtpStanica, OtpBroj, OtpDatum, ZsUlPrelaz, UlEtiketa, ZsIzPrelaz, IzEtiketa, PrUprava, PrStanica, Najava, UkupnoKola, tlSumaFr, tlPrevFr, tlNakFr, tlNakCo82 " & _
                                                 "FROM dbo.SlogKalk " & _
                                                 "WHERE (Saobracaj = '" & IzborSaobracaja & "') AND (ObrGodina = '" & qObrGodina & "') AND (ObrMesec = '" & qObrMesec & "')  " & _
