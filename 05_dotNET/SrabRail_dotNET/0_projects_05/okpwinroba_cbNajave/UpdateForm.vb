...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnPrihvati.Location = New System.Drawing.Point(384, 568)
        ...
        Me.btnOtkazi.Location = New System.Drawing.Point(502, 568)
        ...
        Me.gbOstalo.Location = New System.Drawing.Point(24, 296)
        Me.gbOstalo.Name = "gbOstalo"
        Me.gbOstalo.Size = New System.Drawing.Size(240, 208)
        ...
        Me.Label7.Text = "Mozete izmeniti podatke o pojedinacnom tovarnom listu ili pozvati sve tovarne lis" & _
        "tove za odredjenu grupu kola ili voz."
        '
        'GroupBox3
        '
        ...
        Me.gbTranzit.Location = New System.Drawing.Point(272, 63)
        ...
        Me.cb_Tip.Location = New System.Drawing.Point(112, 24)
        ...
        Me.cbSmer1.Location = New System.Drawing.Point(112, 73)
        ...
        Me.tbNalepnica.Location = New System.Drawing.Point(112, 128)
        ...
        Me.gbPosiljka.Location = New System.Drawing.Point(352, 584)
        ...
        Me.gbSaobracaj.Location = New System.Drawing.Point(24, 63)
        Me.gbSaobracaj.Name = "gbSaobracaj"
        Me.gbSaobracaj.Size = New System.Drawing.Size(240, 233)
        ...
        Me.btnPreuzmi.Location = New System.Drawing.Point(400, 568)
        ...
        Me.LblKomitent.Location = New System.Drawing.Point(24, 520)
        ...
        Me.gbTarifa.Location = New System.Drawing.Point(272, 296)
        ...
        Me.cb22.Location = New System.Drawing.Point(352, 552)
        Me.cb22.Name = "cb22"
        ...
        Me.gbProdos.Location = New System.Drawing.Point(24, 560)
        Me.gbProdos.Name = "gbProdos"
        Me.gbProdos.Size = New System.Drawing.Size(296, 72)
        ...
        Me.ClientSize = New System.Drawing.Size(602, 648)
...
#End Region
    ...
    Private Sub btnPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrihvati.Click
        ...
        If RecordAction = "N" Then   ' 1. Azuriranje u OkpWinRoba + Makis
            ...
            MasterAction = "Upd"
            '----------------------- deklarisati sve izlazne promenljive -----------------------------
            ...
            If Me.gbTranzit.Enabled = True Then ' ---------- Tranzit
                ...
                NadjiTovarniListTrz(Microsoft.VisualBasic.Mid(cb_Tip.Text, 1, 1), Microsoft.VisualBasic.Mid(cbSmer1.Text, 5, 5), tbNalepnica.Text, _
            ...
            Else                    ' ---------- Uvoz, Izvoz
                ...
                NadjiTovarniList(mOtpUprava, mOtpStanica, mOtpBroj, mOtpDatum, _
                                 ...
                                 izSifraTarife, izUgovor, bValuta, updPrevFr, updPrevUp, updNakFr, updNakUp, _
        ...
        ElseIf RecordAction = "D" Then ' 2. Brisanje u OkpWinRoba
            ...
            Else
                ...
                ''NadjiTovarniList(mOtpUprava, mOtpStanica, mOtpBroj, mOtpDatum, _
                ''                 mRecID, mStanicaRecID, izPrUprava, izPrStanica, _
                ''                 izSaobracaj, izZsUlPrelaz, izZsIzPrelaz, izNajava, izNajava2, _
                ''                 nm_LomStanica, mSifraIzjave, mUkljucujuci, mDoPrelaza, mIncoterms, _
                ''                 izSifraTarife, izUgovor, _
                ''                 mRetVal)
                ...
                'NadjiTovarniList(mOtpUprava, mOtpStanica, mOtpBroj, mOtpDatum, _
                '                mRecID, mStanicaRecID, izPrUprava, izPrStanica, mManipulativnoMesto, _
                '                izSaobracaj, izZsUlPrelaz, izZsIzPrelaz, izNajava, izNajava2, _
                '                LomStanica, mSifraIzjave, mUkljucujuci, mDoPrelaza, mIncoterms, _
                '                izSifraTarife, izUgovor, _
                '                mRetVal)
        ...
        ElseIf RecordAction = "P" Then  ' 3. Preuzimanje iz WinRoba
            ...
            If Me.gbTranzit.Enabled = True Then ' -------------------------- T R A N Z I T ----------------------
                ...
                NadjiTovarniListTrzGranica(Microsoft.VisualBasic.Mid(cb_Tip.Text, 1, 1), Microsoft.VisualBasic.Mid(cbSmer1.Text, 5, 5), tbNalepnica.Text, _
                                             mRecID, mStanicaRecID, otUprava, otStanica, otBroj, otDatum, izPrUprava, izPrStanica, izPrDatum, _
    ...
    Private Sub btnPreuzmi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreuzmi.Click
        ...
        If mVrstaObracuna = "CO" Then
            If Microsoft.VisualBasic.Mid(mBrojUg, 5, 2) = "00" Or _
                ...
                mVrstaPrevoza = "P"
            ElseIf Microsoft.VisualBasic.Mid(mBrojUg, 5, 2) = "01" Or _
                   Microsoft.VisualBasic.Mid(mBrojUg, 5, 2) = "05" Then
                mVrstaPrevoza = "V"
            ElseIf Microsoft.VisualBasic.Mid(mBrojUg, 5, 2) = "22" Then
