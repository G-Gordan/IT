...
#End Region
    ...
    Private Sub NajavePregled_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If mPregledUnosa = "T" Then
            string1 = "SELECT   dbo.NajavaVoza.BrUgovora AS UGOVOR, dbo.NajavaVoza.KomBrojVoza AS NAJAVA, dbo.ZsStanice.Naziv AS [UL.PRELAZ], ZsStanice_1.Naziv AS [IZ.PRELAZ], " & _
                                          "dbo.NajavaVoza.SumaKola AS [NAJAVLJENO], COUNT(dbo.NajavaKola.Realizovano) AS NEREALIZOVANO " & _
                           "FROM    dbo.NajavaVoza INNER JOIN " & _
                                          ...
                                          "dbo.ZsStanice ON dbo.NajavaVoza.Stanica1 = dbo.ZsStanice.SifraStanice INNER JOIN " & _
                                          "dbo.ZsStanice ZsStanice_1 ON dbo.NajavaVoza.Stanica2 = ZsStanice_1.SifraStanice " & _
                            "WHERE   (dbo.NajavaVoza.SumaKola <> dbo.NajavaVoza.Realizovano) AND (dbo.NajavaKola.Realizovano = '0') " & _
                            "GROUP BY dbo.NajavaVoza.SumaKola, dbo.NajavaVoza.Realizovano, " & _
                                          "dbo.ZsStanice.Naziv, ZsStanice_1.Naziv, dbo.NajavaVoza.BrUgovora, " & _
                                          "dbo.NajavaVoza.KomBrojVoza " & _
        ...
        ElseIf mPregledUnosa = "BR" Then
            string1 = "SELECT   dbo.NajavaVoza.BrUgovora AS UGOVOR, dbo.NajavaVoza.KomBrojVoza AS NAJAVA, dbo.ZsStanice.Naziv AS [UL.PRELAZ], ZsStanice_1.Naziv AS [IZ.PRELAZ], " & _
                           ...
                           "FROM    dbo.NajavaVoza INNER JOIN " & _
                                          ...
                                          "dbo.ZsStanice ON dbo.NajavaVoza.Stanica1 = dbo.ZsStanice.SifraStanice INNER JOIN " & _
                                          "dbo.ZsStanice ZsStanice_1 ON dbo.NajavaVoza.Stanica2 = ZsStanice_1.SifraStanice " & _
                            "WHERE   (Left(dbo.NajavaVoza.KomBrojVoza,1)='X') AND (dbo.NajavaVoza.SumaKola <> dbo.NajavaVoza.Realizovano) AND (dbo.NajavaKola.Realizovano = '0') " & _
                            "GROUP BY dbo.NajavaVoza.SumaKola, dbo.NajavaVoza.Realizovano, " & _
                                          "dbo.ZsStanice.Naziv, ZsStanice_1.Naziv, dbo.NajavaVoza.BrUgovora, " & _
                                          "dbo.NajavaVoza.KomBrojVoza " & _
                            "ORDER BY dbo.NajavaVoza.BrUgovora, dbo.NajavaVoza.KomBrojVoza"
