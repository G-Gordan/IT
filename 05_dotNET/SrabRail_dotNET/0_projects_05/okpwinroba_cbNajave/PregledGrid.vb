...
#End Region
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf mPregledUnosa = "TKN" Then
            ...
            sql_UpitPregled = "SELECT dbo.NajavaVoza.BrUgovora AS UGOVOR, dbo.NajavaVoza.KomBrojVoza AS NAJAVA, dbo.NajavaVoza.SumaKola AS [UKUPNO KOLA], dbo.NajavaVoza.Realizovano AS [REALIZOVANO KOLA] " & _
