...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.gbUti.Location = New System.Drawing.Point(8, 304)
        Me.gbUti.Name = "gbUti"
        ...
        'Button4
        '
        Me.Button4.Location = New System.Drawing.Point(304, 80)
        ...
        'Label14
        '
        Me.Label14.Location = New System.Drawing.Point(267, 241)
        ...
        Me.btnDodajKola.Location = New System.Drawing.Point(142, 167)
...
#End Region
    ...
    Private Sub btnDodajKola_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDodajKola.Click
        ...
        Try
            ...
            Else
                ErrorProvider1.SetError(fxIBK, "")
                dtKola.NewRow()
                dtKola.Rows.Add(New Object() {GridIBK, mTara, mUprava, mVlasnik, mSerija, mVrsta, mOsovine, mGranTov, mStitna, mTipKola, mPrevoznina, mNaknada, mICF, mIBK_KB, "I"})
            End If
            dgKola.Refresh()
            Me.tbRbrKola.Text = dtKola.Rows.Count
    ...
    Private Sub btnDodajRobu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDodajRobu.Click
        ...
        dtNhm.Rows.Add(New Object() {GridIBK, SifraRobe, MasaRobe, Tr, TrRid, TipUti, UtiIB, UtiTara, UtiRaster, UtiNHM, UtiPredajniList, UtiBrPlombe, "I"})
    ...
    Private Sub dgRoba_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgRoba.Click
        ...
        Try
            ...
            tbRazred.Text = dr(3, DataRowVersion.Current.Current).ToString()
    ...
    Private Sub dgKola_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgKola.Click
        ...
        tbUprava.Text = currRowKola(2, DataRowVersion.Current).ToString()
        ...
        tbOsovine.Text = currRowKola(6, DataRowVersion.Current).ToString()
    ...
    Private Sub tbMasa_AcceptsTabChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbMasa.AcceptsTabChanged
