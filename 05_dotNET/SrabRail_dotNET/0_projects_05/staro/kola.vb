...
Public Class kola
    ...
    Public tmp_FromKola As Boolean = True
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.chbNarocitaPosiljka.Location = New System.Drawing.Point(432, 8)
        Me.chbNarocitaPosiljka.Name = "chbNarocitaPosiljka"
        Me.chbNarocitaPosiljka.Size = New System.Drawing.Size(168, 24)
        ...
        Me.tbUprava.Location = New System.Drawing.Point(271, 43)
        ...
        Me.gbUti.Location = New System.Drawing.Point(8, 296)
        Me.gbUti.Name = "gbUti"
        Me.gbUti.Size = New System.Drawing.Size(392, 208)
        Me.gbUti.TabIndex = 7
        ...
        Me.tbVrsta.Location = New System.Drawing.Point(297, 21)
        ...
        Me.tbOsovine.Location = New System.Drawing.Point(369, 43)
        ...
        Me.tbSerija.Location = New System.Drawing.Point(321, 21)
        ...
        Me.tbVlasnik.Location = New System.Drawing.Point(272, 21)
        ...
        Me.btnDodajKola.Location = New System.Drawing.Point(141, 167)
        ...
        Me.btnDodajRobu.Location = New System.Drawing.Point(144, 520)
...
#End Region
                ...
                If uspKomanda.Parameters("@ipPovratnaVrednost").Value = "" Then 'OK
                    ...
                    For Each KolaRed In dtKola.Rows
                        If mIBK = KolaRed.Item("IndBrojKola") Then
                            ...
                            End If
                            If Microsoft.VisualBasic.Left(tbNHM.Text, 4) = "8606" Then
                                KolaRed.Item("Tip") = "1"
                            End If
    ...
    Private Sub btnDodajRobu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDodajRobu.Click
        ...
        dtNhm.Rows.Add(New Object() {GridIBK, SifraRobe, MasaRobe, TipUti, TrRid, UtiIB, Tr, UtiTara, UtiRaster, UtiNHM, UtiPredajniList, UtiBrPlombe, "I"})
    ...
    Private Sub dgRoba_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgRoba.Click
        ...
        'Dim tRow As DataRow
        'Dim bm As BindingManagerBase = DataGrid1.BindingContext(DataGrid1.DataSource, DataGrid1.DataMember)
        'Dim dr As DataRow = CType(bm.Current, DataRowView).Row

        Try
            'Dim currRowNhm As DataRow
            'currRowNhm = CType(dgRoba.DataSource, DataTable).Rows(dgRoba.CurrentCell.RowNumber)


            ''mIBK = currRowNhm(0, DataRowVersion.Current).ToString()
            'GridIBK = currRowNhm(0, DataRowVersion.Current).ToString()
            'tbNHM.Text = currRowNhm(1, DataRowVersion.Current).ToString()
            'tbMasa.Text = currRowNhm(2, DataRowVersion.Current).ToString()
            'tbRazred.Text = currRowNhm(3, DataRowVersion.Current).ToString()
            'tbRazredRid.Text = currRowNhm(4, DataRowVersion.Current).ToString()
            'Me.cbTipUti.Text = currRowNhm(5, DataRowVersion.Current).ToString()
            ...
            tbMasa.Text = dr(2, DataRowVersion.Current.Current).ToString()

            tbRazred.Text = dr(6, DataRowVersion.Current.Current).ToString()
            tbRazredRid.Text = dr(4, DataRowVersion.Current.Current).ToString()
            'tbRazred.Text = dr(5, DataRowVersion.Current.Current).ToString()
            'tbRazredRid.Text = dr(4, DataRowVersion.Current.Current).ToString()

            Me.cbTipUti.Text = dr(3, DataRowVersion.Current.Current).ToString()
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    ...
    Private Sub btnPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrihvati.Click
        ...
        If dtKola.Rows.Count > 0 And IzborSaobracaja = "2" Then
            Kola_Validating()
            KontrolaNHM()
        End If
    ...
    Public Sub KontrolaNHM()
        ...
        Next
        uspKomanda.Parameters("@upSifraRobe").Value() = tmp_nhm
    ...
    End Sub
    ''Public Sub SirinaKolona1()
    ''    ' Make a DataGridTableStyle to map this DataTable.
    ''    Dim table_style As New DataGridTableStyle
    ''    table_style.MappingName = dtNhm.TableName

    ''    ' The first column is a Boolean.
    ''    Dim s_ibk As New DataGridTextBoxColumn 'DataGridBoolColumn
    ''    s_ibk.Alignment = HorizontalAlignment.Center
    ''    s_ibk.MappingName = "IndBrojKola"
    ''    s_ibk.HeaderText = "IndBrojKola"
    ''    s_ibk.Width = 90
    ''    'selected_style.AllowNull = False
    ''    table_style.GridColumnStyles.Add(s_ibk)

    ''    ' The second column is a string.
    ''    Dim s_nhm As New DataGridTextBoxColumn
    ''    s_nhm.Alignment = HorizontalAlignment.Left
    ''    s_nhm.MappingName = "NHM"
    ''    s_nhm.HeaderText = "NHM"
    ''    s_nhm.Width = 70
    ''    table_style.GridColumnStyles.Add(s_nhm)

    ''    ' The third column is an integer.
    ''    Dim s_masa As New DataGridTextBoxColumn
    ''    s_masa.Alignment = HorizontalAlignment.Right
    ''    s_masa.MappingName = "Masa"
    ''    s_masa.HeaderText = "Masa"
    ''    s_masa.Width = 80
    ''    table_style.GridColumnStyles.Add(s_masa)

    ''    ' The column is a string.
    ''    Dim s_r As New DataGridTextBoxColumn
    ''    s_r.Alignment = HorizontalAlignment.Center
    ''    s_r.MappingName = "R"
    ''    s_r.HeaderText = "R"
    ''    s_r.Width = 20
    ''    table_style.GridColumnStyles.Add(s_r)
