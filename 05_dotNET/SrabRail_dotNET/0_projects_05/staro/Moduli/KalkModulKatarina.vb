...
Module KalkModuleKatarina             '05.2011
    Public Sub bNadjiPrevozninuROKP(ByRef kPrevoznina As Decimal, ByRef kPovVrROKP As String)
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                'k1NadjiSveKomPovl(mBrojUg, Aneks, mDatumKalk, kSifTar, bVrstaSaobracaja, kVlasn, KolaZ, kStatus, OdStan, DoStan, kNacinObrac, bValuta, _
                        ...
                        If NHMRed.Item("IndBrojKola") = IBK Then
                            ...
                            ElseIf kNacinObrac = 2 Then
                                ...
                                If mVrstaPrevoza = "V" Then
                                    ...
                                    NHMRed.Item("VozarinskiStavNHM") = Voz
                                    NHMRed.Item("RacMasaNHM") = MasaTempT * 1000
                                End If
                                ' Testiraj na minimalnu prevozninu  
                                If PrevozninaPoUg <= bMinPrevoznina Then
                                    PrevozninaPoUg = bMinPrevoznina
                                ...
                                'kPrevoznina = PrevozninaPoUg
                                KolaRed.Item("RacunskaMasa") = MasaTempT * 1000
                                KolaRed.Item("VozarinskiStav") = bVozarinskiStavPoKolima
