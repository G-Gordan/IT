...
Module KalkModulCO
        ...
        Else
            ...
            ElseIf ((Microsoft.VisualBasic.Right(mBrojUg, 2) = "01") Or _
                ...
                Else                                 ' UVOZ_IZVOZ
                    ...
                    bNadjiPrevozninu00COUI(mTabelaCena, mPrevoznina)
                End If
            ElseIf Microsoft.VisualBasic.Right(mBrojUg, 2) = "05" Then  ' vozovi izvoz Prodos
                bNadjiPrevozninu05COUI(mTabelaCena, mPrevoznina)
            ElseIf Microsoft.VisualBasic.Right(mBrojUg, 2) = "92" Or Microsoft.VisualBasic.Right(mBrojUg, 2) = "93" Then ' TEA tarifa + TEA prazna kola za ug. 160993
                bValuta = "17"
                If Not (bKontejneri) Then
            ...
            ElseIf Microsoft.VisualBasic.Right(mBrojUg, 2) = "22" Or _
                   mBrojUg = "300823" Or mBrojUg = "300824" Or mBrojUg = "300923" Or mBrojUg = "300924" Or _
                   mBrojUg = "301023" Or mBrojUg = "301024" Or mBrojUg = "301123" Or mBrojUg = "301124" Then   ' Kontenerski voz Prodos i ostali konteneri
            ...
            ElseIf mBrojUg = "300899" Or mBrojUg = "300888" Or _
                   mBrojUg = "300999" Or mBrojUg = "301099" Or _
                   mBrojUg = "301199" Then                                                   ' Militzer

                bNadjiPrevozninuMil99(mPrevoznina)
    ...
    Public Sub bNadjiPrevozninu00CO(ByRef Prevoznina As Decimal)
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima 
                ...
                If Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "08" Or _
                    Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "09" Or _
                    Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "10" Or _
                    Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "11" Then
                    Razred = "0"
                End If
                ...
                If Tabela = "173" Then ' PROODOS, SCHENKER, EXPRESS ; 2011:svi
                    ...
                    If mBrojUg = "100700" Or mBrojUg = "110700" Or mBrojUg = "120700" Then
                        Select Case RacMasaPoKolima
                            Case 10000, 15000, 20000, 25000
                                'bNadjiVozarinskiStav(Tabela, mDatumKalk, RacMasa, bTkm, Razred, VozarinskiStav, PV)
                    ...
                    'If mBrojUg = "100800" Then PRETHODNO!

                    If Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "08" Or _
                       Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "09" Or _
                       Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "10" Or _
                       Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "11" Then      '#nesa#
                        ...
                        End Select
                        ' 8605, 8606
                        If Microsoft.VisualBasic.Left(_mNHM, 4) = "8605" Or Microsoft.VisualBasic.Left(_mNHM, 4) = "8606" And _
                                                Microsoft.VisualBasic.Right(mBrojUg, 2) = "00" And _
                                                Vlasnistvo = "P" Then
                            'bNadjiVozarinskiStav(Tabela, mDatumKalk, Masa2, bTkm, Razred, VozarinskiStav2, PV)
                            bNadjiVozarinskiStavCO(mBrojUg, Tabela, mDatumKalk, 45000, mStanica1, mStanica2, ProdosUprava, "0", Razred, VozarinskiStav2, PV)
                            '&&&
                            If VozarinskiStav2 = 0 Then
                                bNadjiVozarinskiStavCO(mBrojUg, Tabela, mDatumKalk, 45000, mStanica1, mStanica2, "00", "0", Razred, VozarinskiStav2, PV)
                            End If
                            '&&&
                ...
                If Tabela = "181" Then  ' JUG-SEVER nnnn69
                ...
                If Tabela = "193" Then  ' JUG-SEVER GRUPE KOLA PRODOS nnnn70
                    If BrOsovina = 2 Then
                        _razred1 = "1"
                    Else
                        _razred1 = "2"
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                If dtNhm.Rows.Count > 0 Then
                    ...
                    If Microsoft.VisualBasic.Left(mBrojUg, 4) = "1008" Or _
                        Microsoft.VisualBasic.Left(mBrojUg, 4) = "1108" Or _
                        Microsoft.VisualBasic.Left(mBrojUg, 4) = "1208" Then
                        If mDatumKalk >= #1/1/2008# And mDatumKalk <= #1/31/2008# Then
                            mDatumKalk = #2/2/2008#
                        End If
                    Else
    ...
    Public Sub bNadjiPrevozninu01CO(ByRef Prevoznina As Decimal)          ' vozovi
        ...
        If Not (bBarIHSH) Then  ' Nije Bar i Albanija
            ...
            End If
            If mBrojUg = "100801" Or mBrojUg = "110801" Or mBrojUg = "120801" Then
                bABCD = 2601 'Tumacenje ugovora: uvek vazi cena iz tabele D
            End If
            If mBrojUg = "100901" Or mBrojUg = "100997" Or mBrojUg = "110901" Or mBrojUg = "120901" Then      '#b#
                bABCD = 2001 'Tumacenje ugovora: polazi se od najvise cene                 '#b#
            End If                                                                      '#b#
            ...
            If mBrojUg = "100701" Or mBrojUg = "110701" Or mBrojUg = "120701" Then
                ...
                End If
            End If
            If mBrojUg = "100801" Or mBrojUg = "110801" Or mBrojUg = "120801" Or _
               mBrojUg = "100901" Or mBrojUg = "110901" Or mBrojUg = "120901" Or _
               mBrojUg = "101001" Or mBrojUg = "111001" Or mBrojUg = "121001" Or _
               mBrojUg = "101101" Or mBrojUg = "111101" Or mBrojUg = "121101" Then          '#$#
            ...
            If mBrojUg = "101001" Or mBrojUg = "111001" Or mBrojUg = "121001" Or _
               mBrojUg = "101101" Or mBrojUg = "111101" Or mBrojUg = "121101" Then
                ...
                End If
            End If
            If (mBrojUg = "050801") Then
                If (mStanica1 = "12498" And mStanica2 = "11028") Or (mStanica1 = "11028" And mStanica2 = "12498") Then
                    bNadjiBrutoMasu(mBrutoMasaPoPosiljci, bPKolKoef)
                    If mBrutoMasaPoPosiljci > 1160000 Then
                        mPrevoznina = mPrevoznina * mBrutoMasaPoPosiljci / 1160000
        ...
        For Each KolaRed In dtKola.Rows    ' petlja po kolima
            ...
            For Each NHMRed In dtNhm.Rows   '  petlja po robi
                If NHMRed.Item("IndBrojKola") = IBK Then
                    ...
                    '    'If (ugTipCene = 2) Or (ugTipCene = 4) Then
                ...
                Else                    '   relacija ne postoji, pa je prema 2.   ( TRANZIT ILI UVOZ-IZVOZ ):
                    ...
                    ElseIf ((bVrstaSaobracaja = 2) Or (bVrstaSaobracaja = 3)) Then ' UVOZ, IZVOZ
                        ...
                        If dtNhm.Rows.Count > 0 Then
                            ...
                            bRacunskaMasaPoKolima = MasaTemp 'PROVERITI
                            bVozarinskiStavPoKolima = VozarinskiStav
                            VozarinskiStav = 0
                            ...
                            'bRacunskaMasaPoKolima = Masa1R '  + Masa2R + Masa3R
                    ...
                    ' ================ COANEKS =========================
                    If ugTipCene <> 10 Then 'minimalna prevoznina
                        If PrevozninaPoKolima <= bMinPrevoznina Then
                            PrevozninaPoKolima = bMinPrevoznina
                        End If
                    End If
    ...
    Public Sub bNadjiPrevozninu22CO(ByRef Prevoznina As Decimal)          ' Proodos kontejnerski vozovi
        ...
        If mVrstaPrevoza = "V" And Not (mBrojUg = "300824" Or mBrojUg = "300924" Or mBrojUg = "301024" Or mBrojUg = "301124") Then              ' kontejnerski voz Proodos
            'bNadjiSveIzZSKoefPos(bVrstaSaobracaja, mTarifa, bVrstaPosiljke, bVrstaStanice, Vlasnistvo, _
            '       TovarenaPrazna, bMinPrevoznina, bDodPrevoznina, bKoef, bKoefNak, bKoefInd, bKoefInd1, bKoefRid, _
            '       bPouzece, bPredujam, mDatumKalk, bRedovanOrocen, bValuta, bRetVal)
        ...
        Else
            bNadjiPrevozninuKontTEA("133", mPrevoznina)
    ...
    Public Sub bNadjiNaftu(ByVal inNHM As String, ByVal intkm As Integer, _
        ...
        If ((NHM14 = 2709) Or (NHM14 = 2710) Or (NHM14 = 2711)) Or ((NHM14 >= 2721) And (NHM14 <= 2749)) Then
            If Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "08" Then
                If intkm < 101 Then outDodatak = 53
                If (intkm > 100) And (intkm < 351) Then outDodatak = 162
                If intkm > 350 Then outDodatak = 201
            ElseIf Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "09" Then
                If Microsoft.VisualBasic.Left(mBrojUg, 2) = "02" Or Microsoft.VisualBasic.Left(mBrojUg, 2) = "10" Or Microsoft.VisualBasic.Left(mBrojUg, 2) = "11" Or Microsoft.VisualBasic.Left(mBrojUg, 2) = "12" Then
                ...
                Else
                    ...
                    If intkm > 350 Then outDodatak = 201
                End If
            ElseIf Microsoft.VisualBasic.Mid(mBrojUg, 3, 2) = "10" Then     '#$#
    ...
    Public Sub bKorigujPoAneksu(ByVal inVrstaKorekcije As Integer, ByVal inPrevoznina As Decimal, ByVal inKoeficijent As Decimal, ByVal inRacunskaMasa As Decimal, _
       ByVal inCena As Decimal, ByVal inStvarnaMasa As Integer, ByVal intkm As Integer, ByVal inDodatak As Decimal, ByRef outIzlaz As Decimal)
        ...
        Select Case inVrstaKorekcije
            ...
            Case 9
                ' cena po kontejneru; duzine kontejnera se uzimaju iz tonskog stava
    ...
    Public Sub bNadjiRacMasuZaAneks(ByVal inIBK As String, ByVal inVrstaKorekcije As Integer, ByRef outRacunskaMasa As Integer)
        ...
        Select Case inVrstaKorekcije
            ...
            Case 2, 13
                ...
                Next
                ''MasaPoPosiljci = MasaPoPosiljci + MasaPoKolima
                ''Next
            ...
            Case 12
                ' isto kao pod 2, samo za stvarnu masu, zbog aneksa T518 za 090801, gde je "stvarna masa kola"
                ''For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ''IBK = KolaRed.Item("IndBrojKola")
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                If dtNhm.Rows.Count > 0 Then
                    ...
                    If mBrojUg = "100805" Then
                        '---------Procedura za cene Prodos 100805

                        If mStanica2 = "11028" Or mStanica2 = "12498" Then
                            If Vlasnistvo = "Z" Then
                                If mStanica1 = "23005" Then         '   Žabalj
                                    VozarinskiStav = 22.2
                                ElseIf mStanica1 = "24203" Then     '   Crvenka
                                    VozarinskiStav = 22.8
                                    'ElseIf mStanica1 = "22501" Then     '   Zrenjanin fabrika
                                    '    VozarinskiStav = 14.0
                                    'ElseIf mStanica1 = "22006" Then     '   Kovacica
                                    '    VozarinskiStav = 10.8
                                    'ElseIf mStanica1 = "23306" Then     '   Vrbas
                                    '    VozarinskiStav = 12.6
                                    'ElseIf mStanica1 = "25304" Then     '   Bac
                                    '    VozarinskiStav = 13.5
                                    'ElseIf mStanica1 = "23801" Then     '   Senta
                                    '    VozarinskiStav = 14.9
                                End If
                            ElseIf Vlasnistvo = "P" Then
                                ...
                                ElseIf mStanica1 = "24203" Then     '   Crvenka
                                    ...
                                    '    VozarinskiStav = 12.7
                                    'ElseIf mStanica1 = "23801" Then     '   Senta
                                    '    VozarinskiStav = 14.10
                                End If
                            End If

                            PrevozninaPoKolima = Masa1R * bStavKoef * VozarinskiStav * KolKoef / 1000
                            bVozarinskiStavPoKolima = VozarinskiStav

                            ''PrevozninaPoKolima = Prev1R * bPrevozninaKoef
    ...
    Public Sub bNadjiPrevozninuMil99(ByRef Prevoznina As Decimal)    ' Militzer za USSteel
        ...
        If dtKola.Rows.Count > 0 Then
            ...
            For Each KolaRed In dtKola.Rows    ' petlja po kolima
                ...
                Dim TipCene As Integer = 2
                NadjiAneks(mBrojUg, IzborSaobracaja, mStanica1, mStanica2, BrOsovina, mVrstaPrevoza, _
                           Vlasnistvo, Vrsta, mDatumKalk, (Microsoft.VisualBasic.Left(NHM, 4)), 1, VozarinskiStav, TipCene, PV)

                'NadjiAneks("300899", IzborSaobracaja, mStanica1, mStanica2, BrOsovina, mVrstaPrevoza, _
                '                            Vlasnistvo, Vrsta, mDatumKalk, (Microsoft.VisualBasic.Left(NHM, 4)), 1, VozarinskiStav, TipCene, PV)
    ...
    Public Sub bNadjiPrevozninu835753(ByRef Prevoznina As Decimal) ' AdriaKombi marš.vozovi
        ...
        ' 
        ' - u cenu ulaze: 
        '   1. - fiksni iznos za voz ( CenaPoVozu  )
        '   2. - naknada za zel. kola ( po kolima ) - dodaje se van ove kalkulacije
        '   
        ' - uracunati minimalnu prevozninu ?
        ...
        ''1.  900,  4780, 50,  950,   0
        ''2. 1190,  4780, 50, 1240, 215 
        ''3. 1250,  4995, 50, 1290,   0
