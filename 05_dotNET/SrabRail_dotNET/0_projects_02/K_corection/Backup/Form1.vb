...
Public Class Form1
    ...
    Dim SumUpPoTL As Decimal = 0
    Dim NakUp As Decimal = 0
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtBrPr As System.Windows.Forms.TextBox
    Friend WithEvents txtStanPr As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtBrPr = New System.Windows.Forms.TextBox
        Me.txtStanPr = New System.Windows.Forms.TextBox
        ...
        Me.GroupBox1.Controls.Add(Me.txtBrPr)
        Me.GroupBox1.Controls.Add(Me.txtStanPr)
        ...
        'txtBrPr
        '
        Me.txtBrPr.BackColor = System.Drawing.SystemColors.ControlDark
        Me.txtBrPr.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(238, Byte))
        Me.txtBrPr.Location = New System.Drawing.Point(408, 72)
        Me.txtBrPr.Name = "txtBrPr"
        Me.txtBrPr.TabIndex = 5
        Me.txtBrPr.Text = ""
        '
        'txtStanPr
        '
        Me.txtStanPr.BackColor = System.Drawing.SystemColors.ControlDark
        Me.txtStanPr.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(238, Byte))
        Me.txtStanPr.Location = New System.Drawing.Point(144, 72)
        Me.txtStanPr.Name = "txtStanPr"
        Me.txtStanPr.TabIndex = 4
        Me.txtStanPr.Text = ""
        '
        'TextBox4
        '
        ...
        Me.TextBox4.Location = New System.Drawing.Point(416, 32)
        ...
        Me.TextBox3.Location = New System.Drawing.Point(320, 32)
        ...
        Me.TextBox2.Location = New System.Drawing.Point(224, 32)
        ...
        Me.Label3.Text = "Otpravna uprava / Stanica / Broj  :"
        '
        'GroupBox2
        '
        ...
        Me.GroupBox3.Text = "BEOGRAD                                                                  Novo sta" & _
        "nje                               Prethodno stanje                              " & _
        " Razlika                                        "
        '
        'TextBox29
        '
        ...
        'TextBox44
        '
        Me.TextBox44.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
        ...
        'txtManjak
        '
        Me.txtManjak.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
        ...
        'TextBox42
        '
        Me.TextBox42.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
        ...
        'TextBox41
        '
        Me.TextBox41.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
        ...
        'txtVisak
        '
        Me.txtVisak.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
        ...
        'TextBox39
        '
        Me.TextBox39.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
        ...
        'txtNakSpN
        '
        Me.txtNakSpN.BackColor = System.Drawing.SystemColors.ControlDark
        ...
        'txtNovo
        '
        Me.txtNovo.BackColor = System.Drawing.SystemColors.ControlDark
        ...
        'TextBox20
        '
        Me.TextBox20.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
        ...
        'txtZaracTL
        '
        Me.txtZaracTL.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
        ...
        'TextBox50
        '
        Me.TextBox50.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(255, Byte), CType(192, Byte))
...
#End Region
    ...
    Private Sub txtBrPr_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtBrPr.Validating
        ...
        Upit0 = "SELECT RecID, OtpUprava, OtpStanica, OtpBroj, PrStanica, PrBroj, PrDatum, ObrGodina, Ugovor, TkmZS, rSumaUpDin,  " & _
                "tlPrevUpDin, tlSumaUpDin, tlPrevFrDin, tlNakUpDin, tlValuta " & _
                "FROM SlogKalk " & _
                "WHERE PrStanica='" & PrStan & "' and PrBroj='" & PrBroj & "'"
        ...
        Try
            With dsNadji.Tables(0)
                ...
                OtpUpr = .Rows(intCounter0).Item("OtpUprava")
                OtpStan = .Rows(intCounter0).Item("OtpStanica")
                BrOtp = .Rows(intCounter0).Item("OtpBroj")
                ...
                SumUpPoTL = .Rows(intCounter0).Item("tlSumaUpDin")
                Valuta = .Rows(intCounter0).Item("tlValuta")
                Tkm = .Rows(intCounter0).Item("TkmZS")
                NakUp = .Rows(intCounter0).Item("tlNakUpDin")
                RazlUp = .Rows(intCounter0).Item("RSumaUpDin")
            End With
        ...
        TextBox10.Text = SumUpPoTL + RazlUp
        TextBox11.Text = Valuta
        TextBox13.Text = Tkm
        txtNakSpN.Text = NakUp
        RaspN = UpPoTL + NakUp
        TextBox50.Text = SumUpPoTL + RazlUp
        txtPred.Text = Pred
        TextBox33.Text = PredN
        txtTrGot.Text = TrGot
        TextBox36.Text = TrGotN

        txtZaracTL.Text = SumUpPoTL + RazlUp
    ...
    Private Sub MenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem1.Click
        ...
        Dim CRIzv As New kkkorekc3p ' kkkorekc3
    ...
    Private Sub txtBrPr_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtBrPr.KeyPress
    ...
    Private Sub txtStanPr_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtStanPr.KeyPress
        If e.KeyChar() = Microsoft.VisualBasic.ChrW(13) Then
            e.Handled = True
            SendKeys.Send(Chr(9))
        End If
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        Try
            FIzv.CrystalReportViewer1.SelectionFormula = "{Korekcija.Korisnik}=('" & User & " ')"
        ...
        With dsKorisnik.Tables(0)
            ...
            For intCounterK = 0 To .Rows.Count - 1
                ...
                If Stanica = "" Or BrPred = "" Then
                    PovVrednost = "Podaci nisu potpuni. Brisanje neæe izvršeno u potpunosti!"
                End If
                If Trim(Korisnik) = User Then
                    'Stanica = 0
                    Dim Brisi As DataRow = BrisiKorekcija(Korisnik, RedBR, Stanica, PrBroj, BrPred, Visak, VisakN, V, Manjak, ManjakN, M, PZORazl, CPRazl, Nak, TruGot, Preduj, Uk, PovVrednost)
                End If
            Next
        End With
        If PovVrednost <> "" Then
