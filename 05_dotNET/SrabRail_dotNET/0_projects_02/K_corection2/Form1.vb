...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Button6.Size = New System.Drawing.Size(84, 40)
        ...
        Me.Label1.Location = New System.Drawing.Point(554, 23)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(70, 13)
        Me.Label1.TabIndex = 16
        Me.Label1.Text = "Izvoz 3.1.'13."
...
#End Region
    ...
    MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            With dsKorisnik.Tables(0)
                ...
                For intCounterK = 0 To .Rows.Count - 1
                    ...
                    If Trim(Korisnik) = User Then
                        ...
                        Dim Brisi As DataRow = BrisiKorekcija(Korisnik, PovVrednost)
                        If PovVrednost <> "" Then
                            MsgBox(PovVrednost)
            ...
            If PovVrednost <> "" Then
                MsgBox(PovVrednost)
            Else : MsgBox("Ovaj korisnik nije imao unetu ni jednu korekciju.")
            End If
        Else
        End If
