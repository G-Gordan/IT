...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'txtBrOtp
        '
        Me.txtBrOtp.BackColor = System.Drawing.SystemColors.ControlDark
        ...
        Me.txtBrOtp.Location = New System.Drawing.Point(408, 72)
        ...
        'txtStanOtp
        '
        Me.txtStanOtp.BackColor = System.Drawing.SystemColors.ControlDark
        ...
        Me.txtStanOtp.Location = New System.Drawing.Point(144, 72)
...
#End Region
    ...
    Private Sub txtBrPr_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtBrOtp.Validating
        ...
        Try
            With dsNadji.Tables(0)
                ...
                OtpBroj = .Rows(intCounter0).Item("OtpBroj")
    ...
    Private Sub MenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem1.Click
        ...
        Try
            FIzv.CrystalReportViewer1.SelectionFormula = "{SlogKalk.PrBroj}= " & PrBroj & " and {SlogRoba.KolaStavka}= " & UkBr & " and {SlogKalk.OtpBroj}=" & OtpBroj & "And {SlogKalk.OtpStanica}=('" & OtpStan & "')"
            'param1 = OtpStan
            'param2 = BrOtp
            'param3 = CType(txtNovo.Text, Decimal)
            'param4 = CType(txtNakSpN.Text, Decimal)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Stanica = a
        RedBR = 1
        UpisKorekcija(Korisnik, RedBR, Stanica, OtpBroj, BrPred, Visak, VisakN, V, Manjak, ManjakN, M, PZORazl, CPRazl, Nak, TruGot, Preduj, Uk, PovVrednost)
        If PovVrednost <> "" Then
            MsgBox(PovVrednost)
        End If
        Dim FIzv As New Form2
        ...
        Try
            ...
            FIzv.CrystalReportViewer1.SelectionFormula = "{SlogKalk.PrBroj}= " & PrBroj & " and {SlogRoba.KolaStavka}= " & UkBr & " and {SlogKalk.OtpBroj}=" & OtpBroj & " And {SlogKalk.OtpStanica}=('" & OtpStan & "')"
            'FIzv.CrystalReportViewer1.SelectionFormula = "{SlogKalk.PrStanica}=" & PrStan & " and {SlogKalk.PrBroj}= " & PrBroj & " and {SlogRoba.KolaStavka}= " & UkBr & " and {SlogKalk.OtpBroj}=" & OtpBroj & ""
            CRIzv.SetParameterValue(0, param1)
            CRIzv.SetParameterValue(1, param2)
            CRIzv.SetParameterValue(2, param3)
            CRIzv.SetParameterValue(3, param4)
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        If MessageBox.Show(" Da li ste sigurni da želite da izbrišete sve unete korekcije?", "Upozorenje", _
    MessageBoxButtons.YesNo, MessageBoxIcon.Question) _
= DialogResults.Yes Then

            UpitK = "Select * " & _
                       "FROM dbo.KorekcijaIzv where Korisnik = '" & User & "'"
        ...
        With dsKorisnik.Tables(0)
            ...
            For intCounterK = 0 To .Rows.Count - 1
                ...
                OtpBroj = .Rows(intCounterK).Item("OtpBroj")
                ...
                If Stanica = "" Or BrPred = "" Then
                    PovVrednost = "Podaci nisu potpuni. Brisanje nee izvršeno u potpunosti!"
                End If
                If Trim(Korisnik) = User Then
                    'Stanica = 0
                        Dim Brisi As DataRow = BrisiKorekcija(Korisnik, RedBR, Stanica, OtpBroj, BrPred, Visak, VisakN, V, Manjak, ManjakN, M, PZORazl, CPRazl, Nak, TruGot, Preduj, Uk, PovVrednost)
                End If
            Next
        End With
        If PovVrednost <> "" Then
