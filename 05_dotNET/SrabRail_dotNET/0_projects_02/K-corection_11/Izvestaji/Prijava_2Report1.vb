...
Public Class Prijava_2Report1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KorekcSped.Prijava_2Report1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Kurs_JZ() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPrijava_2Report1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prijava_2Report1 = New Prijava_2Report1
        rpt.Site = Me.Site
        Return rpt
    End Function
