...
Public Class IzvestajSpedicija1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KorekcSped.IzvestajSpedicija1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Mesec_() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedIzvestajSpedicija1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IzvestajSpedicija1 = New IzvestajSpedicija1
        rpt.Site = Me.Site
        Return rpt
    End Function
