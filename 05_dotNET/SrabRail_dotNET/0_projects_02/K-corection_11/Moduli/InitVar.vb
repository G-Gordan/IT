Module InitVar
    ...
    'Friend Pov As Decimal = 0.0
    'Friend Smanj As Decimal = 0.0
    'Friend Stim As Decimal = 0.0
    ...
    Friend DataGrid4AddList As ArrayList = New ArrayList
    Friend DataGrid4RemoveList As ArrayList = New ArrayList
    Friend dtDataGrid4 As DataTable = New DataTable("DataGrid4")
    Friend Pojj1 As DataColumn = dtDataGrid4.Columns.Add("Pojedinacno", Type.GetType("System.Decimal"))
    Friend Grr1 As DataColumn = dtDataGrid4.Columns.Add("Grupa", Type.GetType("System.Decimal"))
    Friend Vozz1 As DataColumn = dtDataGrid4.Columns.Add("Voz", Type.GetType("System.Decimal"))
    ...
    Friend Pojj2 As DataColumn = dtDataGrid5.Columns.Add("Pojedinacno", Type.GetType("System.Decimal"))
    Friend Grr2 As DataColumn = dtDataGrid5.Columns.Add("Grupa", Type.GetType("System.Decimal"))
    Friend Vozz2 As DataColumn = dtDataGrid5.Columns.Add("Voz", Type.GetType("System.Decimal"))
    ''Friend Ugovor As DataColumn = dtDataGrid3.Columns.Add("Ugovor", Type.GetType("System.String"))
