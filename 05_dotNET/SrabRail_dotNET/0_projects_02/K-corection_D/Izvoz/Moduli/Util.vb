...
Module Util
    ...
    Public Function UpdateKorekcija(ByVal Korisnik As String, ByVal RedBr As Int16, ByVal Stanica As String, ByVal PrBroj As String, ByVal BrPred As String, ByVal Visak As Decimal, ByVal VisakN As Decimal, ByVal V As Decimal, ByVal Manjak As Decimal, ByVal ManjakN As Decimal, ByVal M As Decimal, ByVal PZORazl As Decimal, ByVal CPRazl As Decimal, ByVal Nak As Decimal, ByVal TruGot As Decimal, ByVal Preduj As Decimal, ByVal Uk As Decimal, ByRef PovVrednost As String) As Integer
        ...
        Dim PrBrojParm As SqlParameter = command.Parameters.Add("@inPrBroj", SqlDbType.Char, 6)
        PrBrojParm.Direction = ParameterDirection.Input
        PrBrojParm.Value = PrBroj
    ...
    Friend Sub UpisKorekcija(ByVal Korisnik As String, ByVal RedBr As Int16, ByVal Stanica As String, ByVal PrBroj As String, ByVal BrPred As String, ByVal Visak As Decimal, ByVal VisakN As Decimal, ByVal V As Decimal, ByVal Manjak As Decimal, ByVal ManjakN As Decimal, ByVal M As Decimal, ByVal PZORazl As Decimal, ByVal CPRazl As Decimal, ByVal Nak As Decimal, ByVal TruGot As Decimal, ByVal Preduj As Decimal, ByVal Uk As Decimal, ByRef PovVrednost As String)
        ...
        Dim UpisKorekcija As New SqlClient.SqlCommand("KorekcijaIzv", OkpDbVeza)
        UpisKorekcija.CommandType = CommandType.StoredProcedure

        Dim RetVal As SqlClient.SqlParameter = UpisKorekcija.Parameters.Add(New SqlClient.SqlParameter("@RETURN_VALUE", SqlDbType.Int, 5, ParameterDirection.ReturnValue, True, 0, 0, "", DataRowVersion.Current, ""))
        ...
        Dim inPrBroj As SqlClient.SqlParameter = UpisKorekcija.Parameters.Add(New SqlClient.SqlParameter("@inPrBroj", SqlDbType.Char, 6, ParameterDirection.Input, False, 0, 0, "PrBroj", DataRowVersion.Current, PrBroj))
    ...
    Public Function BrisiKorekcija(ByVal Korisnik As String, ByRef RetVal As String) As DataRow

        command = New SqlCommand("roba214kp.KorekcijaBrisiIzv3", OkpDbVeza)
        command.CommandType = CommandType.StoredProcedure
        ...
        Dim outRetVal As SqlClient.SqlParameter = command.Parameters.Add(New SqlClient.SqlParameter("", SqlDbType.VarChar, 20, ParameterDirection.ReturnValue, False, 0, 0, "RetVal", DataRowVersion.Current, ""))
        ...
        Try
            command.ExecuteNonQuery()
        Catch SQLExp As SqlException
            RetVal = SQLExp.Message      'Greska - SQL greska
        Catch Exp As Exception
            RetVal = Err.Description     'Greska - bilo koja
        Finally
            command.Dispose()
        End Try
        Return result
    ...
    Public Function BrisiKorekcija1(ByVal Korisnik As String, ByRef RetVal As String) As DataRow
        'Dim connection As New SqlConnection(ConnectionString)

        Try
            command = New SqlCommand("roba214kp.KorekcijaBrisiIzv1", OkpDbVeza)
            command.CommandType = CommandType.StoredProcedure
            ...
            Dim outRetVal As SqlClient.SqlParameter = command.Parameters.Add(New SqlClient.SqlParameter("@outRetVal", SqlDbType.Int, 5, ParameterDirection.ReturnValue, True, 0, 0, "", DataRowVersion.Current, ""))
            ...
            'Dim inPrBroj As SqlClient.SqlParameter = command.Parameters.Add(New SqlClient.SqlParameter("@inPrBroj", SqlDbType.Char, 6, ParameterDirection.Input, False, 0, 0, "PrBroj", DataRowVersion.Current, PrBroj))
