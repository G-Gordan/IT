...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Unesi broj prispeæa:"
        '
        'Button1
        '
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        PrStan = TextBox1.Text
        PrBroj = TextBox2.Text
        UpitP = "select  Stanica, PrBroj, BrPred, Visak, VisakN, RazlVisak, Manjak, ManjakN, RazlManj, PZO, CP, Naknade, TruGot, Pred, Uk FROM dbo.Korekcija " & _
                "where Korisnik = '" & User & "' and Stanica = '" & PrStan & "' and PrBroj = '" & PrBroj & "'  "
        ...
        Try
            ...
            With dsPregled.Tables(0)
                For intCounterP = 0 To .Rows.Count - 1
                    ...
                    If TextBox1.Text = Trim(PrStan) And TextBox2.Text = PrBroj Then
    ...
    Private Sub btBrisi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btBrisi.Click
        ...
        BrisiKorekcija1(Korisnik, RetVal)
        'BrisiKorekcija1(Korisnik, RedBR, Stanica, PrBroj, BrPred, Visak, VisakN, V, Manjak, ManjakN, M, PZORazl, CPRazl, Nak, TruGot, Preduj, Uk, PovVrednost)
    ...
    Private Sub btIzmena_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btIzmena.Click
        ...
        Korisnik = User
        RedBr = 1
        UpdateKorekcija(Korisnik, RedBr, Stanica, PrBroj, BrPred, Visak, VisakN, V, Manjak, ManjakN, M, PZORazl, CPRazl, Nak, TruGot, Preduj, Uk, PovVrednost)
        'Dim UpdKorekcija As DataRow = UpdateKorekcija(Korisnik, RedBr, Stanica, PrBroj, BrPred, Visak, VisakN, V, Manjak, ManjakN, M, PZORazl, CPRazl, Nak, TruGot, Preduj, Uk, PovVrednost)
        If PovVrednost = "" Then
