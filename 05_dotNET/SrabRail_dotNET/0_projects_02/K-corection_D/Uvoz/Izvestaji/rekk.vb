...
Public Class rekk
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Kor() As CrystalDecisions.[Shared].IParameterField
        Get
