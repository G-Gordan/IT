...
Module DbKonekcija
    ...
    Public ZSWEB_CONNECTION_STRING As String = ""
        ...
        Try
            ...
            Do Until EOF(1)
                ...
                Select Case parNaziv
                    ...
                    Case "ZSWEB_CONNECTION_STRING"
                        ZSWEB_CONNECTION_STRING = parVrednost
                    Case "STANICA"
            ...
            If SQL_CONNECTION_STRING <> "" And CENE_CONNECTION_STRING <> "" Then
                ...
                Dim WebconnRoba As New SqlConnection(ZSWEB_CONNECTION_STRING)
                DbVeza = connRoba
