...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGrid1.PreferredRowHeight = 8
        Me.DataGrid1.ReadOnly = True
        Me.DataGrid1.Size = New System.Drawing.Size(1024, 256)
        ...
        Me.ClientSize = New System.Drawing.Size(1024, 256)
...
#End Region
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '    ElseIf Microsoft.VisualBasic.Mid(StanicaUnosa, 9, 1) = "5" Then
        '        'sql_UpitPregled = "SELECT TOP 100 PERCENT dbo.UserTab.Naziv AS REFERENT, COUNT(dbo.UserTab.Naziv) AS [OBRADJENO] , dbo.slogKalk.DatumObrade AS [DATUM] " & _
        '        '  "FROM    dbo.SlogKalk INNER JOIN " & _
        '        '  "dbo.UserTab ON dbo.SlogKalk.Referent1 = dbo.UserTab.UserID " & _
        '        '  "WHERE (dbo.SlogKalk.DatumObrade = " & "'" & Today.Month.ToString & "." & Today.Day.ToString & "." & Today.Year.ToString & "') AND dbo.SlogKalk.Stanica = '00005' AND dbo.UserTab.Grupa = '" & bUserIDGrupa & "'" & _
        '        '  "GROUP BY dbo.SlogKalk.Referent1, dbo.SlogKalk.DatumObrade, dbo.UserTab.Naziv "
        ...
        '              "FROM    dbo.SlogKalk INNER JOIN " & _
        '              "dbo.UserTab ON dbo.SlogKalk.Referent1 = dbo.UserTab.UserID " & _
        '              "WHERE dbo.SlogKalk.Stanica = '00005' AND (dbo.SlogKalk.ObrGodina = '" & qObrGodina & "') AND (dbo.SlogKalk.ObrMesec = '" & qObrMesec & "') " & _
        '              "GROUP BY dbo.SlogKalk.Referent1, dbo.SlogKalk.DatumObrade, dbo.UserTab.Naziv "
        '        Else
        '            sql_UpitPregled = "SELECT TOP 100 PERCENT dbo.UserTab.Naziv AS REFERENT, COUNT(dbo.UserTab.Naziv) AS [OBRADJENO] , dbo.slogKalk.DatumObrade AS [DATUM] " & _
        '              "FROM    dbo.SlogKalk INNER JOIN " & _
        '              "dbo.UserTab ON dbo.SlogKalk.Referent1 = dbo.UserTab.UserID " & _
        '              "WHERE dbo.SlogKalk.Stanica = '00005' AND (dbo.SlogKalk.ObrGodina = '" & qObrGodina & "') AND (dbo.SlogKalk.ObrMesec = '" & qObrMesec & "') AND dbo.UserTab.Grupa = '" & bUserIDGrupa & "'" & _
        '              "GROUP BY dbo.SlogKalk.Referent1, dbo.SlogKalk.DatumObrade, dbo.UserTab.Naziv "
        '        End If
        ...
        If DatumPrikaza = "Mesecni" Then
            Me.DataGrid1.CaptionText = "Uneto tekuceg obracunskog meseca"
            'If Microsoft.VisualBasic.Left(bUserIDGrupa, 5) = "Admin" Then
            If bAdmin Then
                sql_UpitPregled = "SELECT TOP 100 PERCENT dbo.UserTab.Naziv AS REFERENT, COUNT(dbo.UserTab.Naziv) AS [UKUPNO TL] , SUM(dbo.SlogKalk.UkupnoKola) AS [UKUPNO KOLA],dbo.slogKalk.DatumObrade AS [DATUM] " & _
                  "FROM    dbo.SlogKalk INNER JOIN " & _
                  "dbo.UserTab ON dbo.SlogKalk.Referent1 = dbo.UserTab.UserID " & _
                  "WHERE dbo.SlogKalk.Stanica = '00005' AND (dbo.SlogKalk.ObrGodina = '" & qObrGodina & "') AND (dbo.SlogKalk.ObrMesec = '" & qObrMesec & "') " & _
                  "GROUP BY dbo.SlogKalk.Referent1, dbo.SlogKalk.DatumObrade, dbo.UserTab.Naziv "
            Else
                sql_UpitPregled = "SELECT TOP 100 PERCENT dbo.UserTab.Naziv AS REFERENT, COUNT(dbo.UserTab.Naziv) AS [UKUPNO TL] ,SUM(dbo.SlogKalk.UkupnoKola) AS [UKUPNO KOLA], dbo.slogKalk.DatumObrade AS [DATUM] " & _
                  ...
                  "GROUP BY dbo.SlogKalk.Referent1, dbo.SlogKalk.DatumObrade, dbo.UserTab.Naziv "
            End If
        ElseIf DatumPrikaza = "MesecniSve" Then
            Me.DataGrid1.CaptionText = "Uneto tekuceg obracunskog meseca"
            'If Microsoft.VisualBasic.Left(bUserIDGrupa, 5) = "Admin" Then
            If bAdmin Then
                sql_UpitPregled = "SELECT TOP 100 PERCENT dbo.UserTab.Naziv AS [REFERENT 1], COUNT(dbo.UserTab.Naziv) AS [UKUPNO TL], SUM(dbo.SlogKalk.UkupnoKola) AS [UKUPNO KOLA] " & _
                  "FROM    dbo.SlogKalk INNER JOIN " & _
                  "dbo.UserTab ON dbo.SlogKalk.Referent1 = dbo.UserTab.UserID " & _
                  "WHERE dbo.SlogKalk.Stanica = '00005' AND (dbo.SlogKalk.ObrGodina = '" & qObrGodina & "') AND (dbo.SlogKalk.ObrMesec = '" & qObrMesec & "') " & _
                  "GROUP BY dbo.SlogKalk.Referent1, dbo.UserTab.Naziv, dbo.UserTab.Grupa ORDER BY dbo.UserTab.Grupa"
            Else
                sql_UpitPregled = "SELECT TOP 100 PERCENT dbo.UserTab.Naziv AS [REFERENT 1], COUNT(dbo.UserTab.Naziv) AS [UKUPNO TL], SUM(dbo.SlogKalk.UkupnoKola) AS [UKUPNO KOLA]" & _
                  "FROM    dbo.SlogKalk INNER JOIN " & _
                  "dbo.UserTab ON dbo.SlogKalk.Referent1 = dbo.UserTab.UserID " & _
        ...
        ElseIf DatumPrikaza = "Dnevni" Then
        Me.DataGrid1.CaptionText = "Uneto danas"
        'If Microsoft.VisualBasic.Left(bUserIDGrupa, 5) = "Admin" Then
        If bAdmin Then
                sql_UpitPregled = "SELECT TOP 100 PERCENT dbo.UserTab.Naziv AS [REFERENT 1], COUNT(dbo.UserTab.Naziv) AS [UKUPNO TL] , SUM(dbo.SlogKalk.UkupnoKola) AS [UKUPNO KOLA],dbo.slogKalk.DatumObrade AS [DATUM] " & _
                  "FROM    dbo.SlogKalk INNER JOIN " & _
                  "dbo.UserTab ON dbo.SlogKalk.Referent1 = dbo.UserTab.UserID " & _
                  "WHERE dbo.SlogKalk.Stanica = '00005' AND (DatumObrade = " & "'" & Today.Month.ToString & "." & Today.Day.ToString & "." & Today.Year.ToString & "')" & _
                  "GROUP BY dbo.SlogKalk.Referent1, dbo.SlogKalk.DatumObrade, dbo.UserTab.Naziv "
            Else
                sql_UpitPregled = "SELECT TOP 100 PERCENT dbo.UserTab.Naziv AS [REFERENT 1], COUNT(dbo.UserTab.Naziv) AS [UKUPNO TL] , SUM(dbo.SlogKalk.UkupnoKola) AS [UKUPNO KOLA],dbo.slogKalk.DatumObrade AS [DATUM] " & _
                  "FROM    dbo.SlogKalk INNER JOIN " & _
                  "dbo.UserTab ON dbo.SlogKalk.Referent1 = dbo.UserTab.UserID " & _
                  "WHERE dbo.SlogKalk.Stanica = '00005' AND (DatumObrade = " & "'" & Today.Month.ToString & "." & Today.Day.ToString & "." & Today.Year.ToString & "')AND  dbo.UserTab.Grupa = '" & bUserIDGrupa & "'" & _
                  "GROUP BY dbo.SlogKalk.Referent1, dbo.SlogKalk.DatumObrade, dbo.UserTab.Naziv "
            End If

        End If

        If bAdmin And bVrstaPregledGrida = "DOtpr" Then
           ''sql_UpitPregled = "SELECT RIGHT(dbo.SlogKalk.OtpStanica, 5) AS [Otp. st.], dbo.SlogKalk.OtpBroj AS [Br. otp.], RIGHT(dbo.SlogKalk.PrStanica, 5) AS [Up. st.], " & _
            ''                  "dbo.SlogKalk.PrBroj AS [Br. pr.], dbo.SlogKalk.ObrMesec AS [Obr. mes.], dbo.SlogKalk.ObrGodina AS [Obr.god.]" & _
            ''                  "FROM dbo.DuplaOtpLokal " & _
            ''                  "INNER JOIN dbo.SlogKalk ON dbo.DuplaOtpLokal.OtpStanica = dbo.SlogKalk.OtpStanica AND dbo.DuplaOtpLokal.OtpBroj = dbo.SlogKalk.OtpBroj"
            sql_UpitPregled = "Select DISTINCT Right(dbo.SlogKalk.OtpStanica,5) AS [ Otp.st. ], dbo.SlogKalk.OtpBroj AS [ Br.otp. ], Right(dbo.SlogKalk.PrStanica,5) AS [ Up.st. ], dbo.SlogKalk.PrBroj AS [ Br.pr. ], dbo.SlogKalk.ObrMesec AS [ Obr.mes. ], dbo.SlogKalk.ObrGodina AS [ Obr.god. ]" & _
                                "FROM dbo.SlogKalk INNER JOIN " & _
                                "dbo.SlogKalk SlogKalk_1 ON dbo.SlogKalk.OtpStanica = SlogKalk_1.OtpStanica AND dbo.SlogKalk.OtpBroj = SlogKalk_1.OtpBroj AND " & _
                                "dbo.SlogKalk.Saobracaj = SlogKalk_1.Saobracaj And dbo.SlogKalk.Stanica = SlogKalk_1.Stanica " & _
                                "GROUP BY dbo.SlogKalk.RecID, dbo.SlogKalk.OtpStanica, dbo.SlogKalk.OtpBroj, SlogKalk_1.OtpStanica, SlogKalk_1.OtpBroj, SlogKalk_1.Saobracaj, " & _
                                "dbo.SlogKalk.ObrMesec, dbo.SlogKalk.PrStanica, dbo.SlogKalk.PrBroj, dbo.SlogKalk.ObrGodina " & _
                                "HAVING (COUNT(dbo.SlogKalk.RecID) > 1) AND (dbo.SlogKalk.OtpStanica = SlogKalk_1.OtpStanica) AND (dbo.SlogKalk.OtpBroj = SlogKalk_1.OtpBroj) AND (SlogKalk_1.Saobracaj = '1') " & _
                                "ORDER BY Right(dbo.SlogKalk.OtpStanica,5), dbo.SlogKalk.OtpBroj"


            Me.DataGrid1.CaptionText = "Dvostruka otpravljanja"
        End If

        If bAdmin And bVrstaPregledGrida = "DPris" Then            
            ''sql_UpitPregled = "SELECT RIGHT(dbo.SlogKalk.OtpStanica, 5) AS [Otp. st.], dbo.SlogKalk.OtpBroj AS [Br. otp.], RIGHT(dbo.SlogKalk.PrStanica, 5) AS [Up. st.], " & _
            ''                             "dbo.SlogKalk.PrBroj AS [Br. pr.], dbo.SlogKalk.ObrMesec AS [Obr. mes.], dbo.SlogKalk.ObrGodina AS [Obr.god.]" & _
            ''                             "FROM dbo.DuplaPrLokal " & _
            ''                             "INNER JOIN dbo.SlogKalk ON dbo.DuplaPrLokal.PrStanica = dbo.SlogKalk.PrStanica AND dbo.DuplaPrLokal.PrBroj = dbo.SlogKalk.PrBroj"
            sql_UpitPregled = "Select DISTINCT Right(dbo.SlogKalk.OtpStanica,5) AS [ Otp.st. ], dbo.SlogKalk.OtpBroj AS [ Br.otp. ], Right(dbo.SlogKalk.PrStanica,5) AS [ Up.st. ], dbo.SlogKalk.PrBroj AS [ Br.pr. ], dbo.SlogKalk.ObrMesec AS [ Obr.mes. ], dbo.SlogKalk.ObrGodina AS [ Obr.god. ]" & _
                                            "FROM dbo.SlogKalk INNER JOIN " & _
                                            "dbo.SlogKalk SlogKalk_1 ON dbo.SlogKalk.PrStanica = SlogKalk_1.PrStanica AND dbo.SlogKalk.PrBroj = SlogKalk_1.PrBroj AND " & _
                                            "dbo.SlogKalk.Saobracaj = SlogKalk_1.Saobracaj And dbo.SlogKalk.Stanica = SlogKalk_1.Stanica " & _
                                            "GROUP BY dbo.SlogKalk.RecID, dbo.SlogKalk.OtpStanica, dbo.SlogKalk.OtpBroj, SlogKalk_1.PrStanica, SlogKalk_1.PrBroj, SlogKalk_1.Saobracaj, " & _
                                            "dbo.SlogKalk.ObrMesec, dbo.SlogKalk.PrStanica, dbo.SlogKalk.PrBroj, dbo.SlogKalk.ObrGodina " & _
                                            "HAVING (COUNT(dbo.SlogKalk.RecID) > 1) AND (dbo.SlogKalk.PrStanica = SlogKalk_1.PrStanica) AND (dbo.SlogKalk.PrBroj = SlogKalk_1.PrBroj) AND (SlogKalk_1.Saobracaj = '1') " & _
                                            "ORDER BY Right(dbo.SlogKalk.OtpStanica,5), dbo.SlogKalk.OtpBroj"
            Me.DataGrid1.CaptionText = "Dvostruka prispeca"
        End If


        If mPregledUnosa = "IBK" Then
            ...
            sql_UpitPregled = "SELECT SlogKalk.OtpDatum, SlogKalk.OtpStanica, SlogKalk.OtpBroj, SlogKalk.PrStanica, SlogKalk.PrBroj, SlogKalk.Ugovor, SlogRoba.NHM, SlogRoba.SMasa " & _
                              ...
                              "WHERE (SlogKola.IBK = '" & mIBK & "') AND (SlogKalk.Saobracaj = 1 )" & _
        ...
        Me.DataGrid1.Name = "DataGrid1"
        If bVrstaPregledGrida = "DOtpr" Or bVrstaPregledGrida = "DPris" Then
