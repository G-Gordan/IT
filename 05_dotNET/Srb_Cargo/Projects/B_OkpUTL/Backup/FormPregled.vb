...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents bPrihvati As System.Windows.Forms.Button
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.bPrihvati = New System.Windows.Forms.Button
        ...
        Me.NumericUpDown2.Maximum = New Decimal(New Integer() {2017, 0, 0, 0})
        Me.NumericUpDown2.Minimum = New Decimal(New Integer() {2011, 0, 0, 0})
        ...
        'bPrihvati
        '
        Me.bPrihvati.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(238, Byte))
        Me.bPrihvati.Image = CType(resources.GetObject("bPrihvati.Image"), System.Drawing.Image)
        Me.bPrihvati.ImageAlign = System.Drawing.ContentAlignment.TopCenter
        Me.bPrihvati.Location = New System.Drawing.Point(328, 320)
        Me.bPrihvati.Name = "bPrihvati"
        Me.bPrihvati.Size = New System.Drawing.Size(77, 64)
        Me.bPrihvati.TabIndex = 5
        Me.bPrihvati.Text = "Prihvati"
        '
        'FormPregledTL
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(528, 396)
        Me.Controls.Add(Me.bPrihvati)
        ...
        Me.Text = "Unesite mesec i godinu"
...
#End Region
    ...
    Private Sub btnPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrihvati.Click
        ...
        bPregledObrMesec = NumericUpDown1.Value
        bPregledObrGodina = NumericUpDown2.Value
        ...
        If rbSve.Checked = True Then
            'sql_UpitPregled = "SELECT OtpUprava, OtpStanica, OtpBroj, OtpDatum, ZsUlPrelaz, UlEtiketa, ZsIzPrelaz, IzEtiketa, PrUprava, PrStanica, Ugovor, Najava, UkupnoKola, tlSumaFr, tlPrevFr, tlNakFr, tlNakCo82, referent1 " & _
            '                             "FROM dbo.SlogKalk " & _
            ...
            'sql_UpitPregled = "SELECT Right(dbo.SlogKalk.OtpStanica,5) AS OtSt, dbo.SlogKalk.OtpBroj AS BrOt, dbo.SlogKalk.OtpDatum AS DatOt, Right(dbo.SlogKalk.PrStanica,5) AS UpSt,dbo.SlogKalk.PrDatum AS DatPr, dbo.SlogKalk.SifraTarife AS Tarifa,Ugovor, Posiljalac, VrPos,Prevoz, Saobracaj, VrSao, VrPrevoza, dbo.SlogKalk.Narpos AS NP,UkupnoKola, dbo.SlogKalk.PrevozniPutZs AS PP,dbo.SlogKalk.TkmZs AS tkm ,dbo.SlogKalk.SkmZS AS skm,dbo.SlogKalk.SifraIzjave AS Izjava, tlSumaFrDin, tlPrevFrDin, tlNakFrDin, tlSumaUpDin, tlPrevUpDin, tlNakUpDin,tlNakCo82, rSumaFrDin, rSumaUpDin, dbo.SlogKalk.referent1 AS R, dbo.SlogKalk.ObrMesec, dbo.SlogKalk.ObrGodina " & _
            '                             "FROM dbo.SlogKalk " & _
            '                             "WHERE (Saobracaj = '" & IzborSaobracaja & "') AND (ObrGodina = '" & qObrGodina & "') AND (ObrMesec = '" & qObrMesec & "') " & _
            '                             "ORDER BY OtpStanica, OtpBroj, Ugovor"


            sql_UpitPregled = "SELECT Right(dbo.SlogKalk.OtpStanica,5) AS OtSt, dbo.SlogKalk.OtpBroj AS BrOt, dbo.SlogKalk.OtpDatum AS DatOt, Right(dbo.SlogKalk.PrStanica,5) AS UpSt,dbo.SlogKalk.PrDatum AS DatPr, dbo.SlogKalk.SifraTarife AS Tarifa,Ugovor, Posiljalac, VrPos,Prevoz, Saobracaj, VrSao, VrPrevoza, dbo.SlogKalk.Narpos AS NP,UkupnoKola, dbo.SlogKalk.PrevozniPutZs AS PP,dbo.SlogKalk.TkmZs AS tkm ,dbo.SlogKalk.SkmZS AS skm,dbo.SlogKalk.SifraIzjave AS Izjava, tlSumaFrDin, tlPrevFrDin, tlNakFrDin, tlSumaUpDin, tlPrevUpDin, tlNakUpDin,tlNakCo82, rSumaFrDin, rSumaUpDin, dbo.SlogKalk.referent1 AS R , dbo.SlogKalk.RecID , dbo.SlogKalk.ObrMesec, dbo.SlogKalk.ObrGodina " & _
                                         "FROM dbo.SlogKalk " & _
        ...
        If rbUgovori.Checked = True Then
            sql_UpitPregled = "SELECT Ugovor, Najava, OtpUprava, OtpStanica, OtpBroj, OtpDatum, ZsUlPrelaz, UlEtiketa, ZsIzPrelaz, IzEtiketa, PrUprava, PrStanica,  UkupnoKola, tlSumaFr, tlPrevFr, tlNakFr, tlNakCo82, referent1 " & _
                                         "FROM dbo.SlogKalk " & _
        ...
        If rbUgovor.Checked = True Then
            If TextBox1.Text <> "" Then
                ...
                If TextBox2.Text <> "" Then
                    ...
                    If Microsoft.VisualBasic.Mid(mNajava, 1, 1) = "X" Then
                        sql_UpitPregled = "SELECT dbo.SlogKalk.Najava, dbo.SlogKalk.OtpUprava, dbo.SlogKalk.OtpStanica, dbo.SlogKalk.OtpBroj, " & _
                                                     "dbo.SlogKalk.ZsUlPrelaz, dbo.SlogKalk.UlEtiketa, dbo.SlogKalk.ZsIzPrelaz, dbo.SlogKalk.IzEtiketa, dbo.SlogKalk.PrUprava, dbo.SlogKalk.PrStanica, " & _
                                                     "UkupnoKola, dbo.SlogKola.IBK, dbo.SlogKola.Tara, dbo.SlogRoba.SMasa, dbo.SlogKalk.rSumaFr, dbo.SlogKalk.rPrevFr, dbo.SlogKalk.rNakFr, referent1 " & _
                    ...
                    Else
                        sql_UpitPregled = "SELECT dbo.SlogKalk.Najava, dbo.SlogKalk.OtpUprava, dbo.SlogKalk.OtpStanica, dbo.SlogKalk.OtpBroj, " & _
                                                     "dbo.SlogKalk.ZsUlPrelaz, dbo.SlogKalk.UlEtiketa, dbo.SlogKalk.ZsIzPrelaz, dbo.SlogKalk.IzEtiketa, dbo.SlogKalk.PrUprava, dbo.SlogKalk.PrStanica, " & _
                                                     "UkupnoKola, dbo.SlogKola.IBK, dbo.SlogKola.Tara, dbo.SlogRoba.SMasa, dbo.SlogKalk.tlSumaFr, dbo.SlogKalk.tlPrevFr, dbo.SlogKalk.tlNakFr, dbo.SlogKalk.tlNakCo82, referent1 " & _
                                                     "FROM dbo.SlogKalk INNER JOIN " & _
                                                     "dbo.SlogKola ON dbo.SlogKalk.RecID = dbo.SlogKola.RecID AND dbo.SlogKalk.Stanica = dbo.SlogKola.Stanica INNER JOIN " & _
                                                     "dbo.SlogRoba ON dbo.SlogKola.RecID = dbo.SlogRoba.RecID AND dbo.SlogKola.Stanica = dbo.SlogRoba.Stanica AND " & _
                                                     "dbo.SlogKola.KolaStavka = dbo.SlogRoba.KolaStavka " & _
                ...
                Else
                    sql_UpitPregled = "SELECT OtpUprava, OtpStanica, OtpBroj, OtpDatum, ZsUlPrelaz, UlEtiketa, ZsIzPrelaz, IzEtiketa, PrUprava, PrStanica, Najava, UkupnoKola, tlSumaFr, tlPrevFr, tlNakFr, tlNakCo82, referent1 " & _
                                                 "FROM dbo.SlogKalk " & _
                                                 "WHERE (Saobracaj = '" & IzborSaobracaja & "') AND (ObrGodina = '" & qObrGodina & "') AND (ObrMesec = '" & qObrMesec & "')  " & _
    ...
    Private Sub btnPrihvati_MouseUp1(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles btnPrihvati.MouseUp
        If EventsActived = True Then
            ...
            Dim Form2 As New PregledTL      ' podeseno za unutrasnji
    ...
    Private Sub FormPregledTL_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        gbSaobracaj.Visible = False
        GroupBox1.Visible = False
    End Sub

    Private Sub bPrihvati_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bPrihvati.Click
        Dim qObrMesec As String
        Dim qObrGodina As String
        ...
        'bPrihvati_MouseUp1(Me, Nothing)

        _OpenForm = "MesecGodina"
        Me.Close()
