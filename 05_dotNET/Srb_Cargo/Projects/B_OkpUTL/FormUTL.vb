...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'Button9
        '
        Me.Button9.Font = New System.Drawing.Font("Microsoft Sans Serif", 6.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(238, Byte))
        Me.Button9.Location = New System.Drawing.Point(448, 776)
        Me.Button9.Name = "Button9"
        Me.Button9.Size = New System.Drawing.Size(144, 16)
        Me.Button9.TabIndex = 499
        Me.Button9.Text = "Naèin plaæanja prevoznine"
        ...
        Me.GroupBox7.Location = New System.Drawing.Point(-12, 13004)
        ...
        'Button13
        '
        Me.Button13.Font = New System.Drawing.Font("Microsoft Sans Serif", 6.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(238, Byte))
        Me.Button13.Location = New System.Drawing.Point(24, 64)
        Me.Button13.Name = "Button13"
        Me.Button13.Size = New System.Drawing.Size(176, 16)
        Me.Button13.TabIndex = 4903
        Me.Button13.Text = "Naplaæeno na blagajni uz CO"
        ...
        Me.ClientSize = New System.Drawing.Size(910, 477)
...
#End Region
    ...
    Private Sub DatumOtp_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles DatumOtp.Validating
        ...
        If mRetVal = "" Then    'ne postoji
            ...
            Else
                If mBrojUg = "200379" Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0787") Then        ' 25.07.2016 za sada; treba ukljuciti da li su cene u RSD ili EURThen
    ...
    Private Sub FormUTL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Else
                ...
                If mBrojUg = "200379" Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0787") Then ' 25.07.2016 za sada; treba ukljuciti da li su cene u RSD ili EUR
...
0:              bNadjiRacunskuMasuPoPosiljciPoRazredima(Rz1, M1, Rz2, M2, Rz3, M3)
                ...
                If mVrstaObracuna = "CO" Then
                    bZaokruziNaDeseteNavise(tmp_suma_f)             ' Mandic, za CO u evrima
                End If
                ...
                If mVrstaObracuna = "CO" Then
                    bZaokruziNaDeseteNavise(tmp_suma_u)             ' Mandic, za CO u evrima
                End If
    ...
    Private Sub ComboBox4_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles ComboBox4.Validating
        ...
        If (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0787") Then
            bVSTemp = bVrstaSaobracaja
            bVrstaSaobracaja = 0
        End If
    ...
    Private Sub tbUgovor_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles tbUgovor.Validating
            ...
            Else
                ...
                If mRetVal = "" Then
                    ...
                    If mBrojUg = "118790" Or mBrojUg = "118791" Or mBrojUg = "118792" Or mBrojUg = "118799" Or _
                        mBrojUg = "118780" Or mBrojUg = "118781" Or mBrojUg = "118782" Or mBrojUg = "118788" Or _
                        mBrojUg = "118770" Or mBrojUg = "118771" Or mBrojUg = "118772" Or mBrojUg = "118777" _
                    Then
                        bCBObracun = True
                    Else
                        bCBObracun = False
        ...
        If (mVrstaObracuna = "CO" Or mVrstaObracuna = "CD") Then
            If bCBObracun = False Then                          ' ( CO ili CD )+ blagajna
                GroupBox6.Visible = False
    ...
    Private Sub UpisLokal()
        ...
        '----------------------------------------------------------------------------------------------------------------------------
        ' promena racunskog meseca za ugovor 1187xx

        If Microsoft.VisualBasic.Left(mBrojUg, 4) = "1187" Then
            Dim RacMesNaTL As New RacunskiMesecNaTL
            RacMesNaTL.ShowDialog()
        End If
        ...
        Try
            ...
            If Not (mVrstaObracuna = "CO") Then
                ...
                Upis.b8UpisSlogKalkLokal(slogTrans, mAkcija, Microsoft.VisualBasic.Mid(StanicaUnosa, 5, 5), "0072", "72" & tbStanicaOtp.Text, _
                                    CType(tbBrojOtp.Text, Int32), DatumOtp.Text, mObrGodina, mObrMesec, "0072", "72" & tbStanicaPr.Text, _
                                    mPrispece, DateTimePicker2.Text, 0, DaPDV, mNajava, mTarifa, bTarifa72, mBrojUg, _
                                    mPosiljalac, mPos2, mPrimalac, mPri2, bVrstaPosiljke, mVrstaPrevoza, "1", _
                                    bVrstaSaobracaja, mVrPrevoza, dtKola.Rows.Count, bNarocitaPosiljka, _
                                    bPrevozniPutZS, bStanicaVia, bTkm, bSkm, mSifraIzjave, bIznosPoIzjavi, mFrRacun, bUkljucujuci, _
                                    "72", 0, bValuta, _
    ...
    Private Sub bNadjiIPrikaziKurseve(ByVal inSifraValute As String)
        ...
        If (mBrojUg = "200379" Or mVrstaObracuna = "CD") Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0787") Then
            bVrstaKursa = "3"
        Else
            bVrstaKursa = "1"
        End If

        If Not (mVrstaObracuna = "CO" Or mVrstaObracuna = "CD") Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0787") Then       ' 25.07.2016 za sada; treba ukljuciti da li su cene u RSD ili EUR
        ...
        If (dtKola.Rows.Count > 0 And cbR4K.Checked = True) Or (bTarifa72 = 94) Then        ' kolske ili doracunska karta
            ...
            If IzborSaobracaja = "1" Then
                ...
                If M1 > 0 Then
                    tbR54_1.Text = Rz1
                    'tbR57_1.Text = Format(M1, "###,###,##0.00")
                    tbR57_1.Text = Format(M1, "###,###,##0")
                End If
                If M2 > 0 Then
                    tbR54_2.Text = Rz2
                    'tbR57_2.Text = Format(M2, "###,###,##0.00")
                    tbR57_2.Text = Format(M2, "###,###,##0")
                End If
                If M3 > 0 Then
                    tbR54_3.Text = Rz3
                    'tbR57_3.Text = Format(M3, "###,###,##0.00")
                    tbR57_3.Text = Format(M3, "###,###,##0")
                End If
                ...
                If Not (bIzTBPrevoznina = True And bTarifa72 = 91) Then
                    ...
                    '    bZaokruziNaDeseteNavise(tmp_pdv_f)                         ' pa 24.11.2016, Mandic, 028600 - PDV ne treba da se zaokruzuje 
                    'End If
                    tbPdvIznosF.Text = Format(tmp_pdv_f, "###,###,##0.00")
                End If
                ...
                If Not (bIzTBPrevoznina = True And bTarifa72 = 91) Then
                    ...
                    '    bZaokruziNaDeseteNavise(tmp_pdv_u)     ' pa 24.11.2016, Mandic, 028600 - PDV ne treba da se zaokruzuje 
                    'End If
                    tbPdvIznosU.Text = Format(tmp_pdv_u, "###,###,##0.00")
                End If
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        Dim FormVOP As New NacinPlacanjaPrev
        FormVOP.ShowDialog()
    End Sub

    Private Sub Button13_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button13.Click
        Dim FormCoBlag As New BlagajnaSaCO
        FormCoBlag.ShowDialog()
    End Sub
End Class
