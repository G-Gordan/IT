...
#End Region
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        Dim sql_UpitPregled As String = " SELECT CoAneksi.Ugovor, Komitent.Naziv, dbo.CoAneksi.Tg AS [Telegram br], dbo.CoAneksiNhm.NHM, dbo.CoAneksi.DatumOd, dbo.CoAneksi.DatumDo, " & _
                                        " dbo.CoAneksi.Saobracaj,  dbo.ZsStanice.Naziv AS StanicaOd, ZsStanice_1.Naziv AS StanicaDo " & _
                                        " FROM         Komitent INNER JOIN  " & _
                                        " dbo.Ugovori ON Komitent.Sifra = dbo.Ugovori.SifraKorisnika INNER JOIN " & _
                                        " dbo.CoAneksi INNER JOIN  " & _
                                        " dbo.CoAneksiNhm ON dbo.CoAneksi.RecID = dbo.CoAneksiNhm.RecID ON dbo.Ugovori.BrojUgovora = dbo.CoAneksi.Ugovor INNER JOIN " & _
                                        " dbo.ZsStanice ON dbo.CoAneksi.StanicaOd = dbo.ZsStanice._SifraStanice INNER JOIN " & _
                                        " dbo.ZsStanice ZsStanice_1 ON dbo.CoAneksi.StanicaDo = ZsStanice_1._SifraStanice " & _
                                        " GROUP BY dbo.CoAneksiNhm.NHM, dbo.CoAneksi.Tg, dbo.CoAneksi.Ugovor, dbo.CoAneksi.DatumOd, dbo.CoAneksi.DatumDo, Komitent.Naziv, dbo.Ugovori.VrstaObracuna, " & _
                                        " dbo.CoAneksi.Saobracaj, dbo.CoAneksi.StanicaOd, dbo.CoAneksi.StanicaDo, ZsStanice_1.Naziv, dbo.ZsStanice.Naziv " & _
                                        " HAVING      (dbo.CoAneksi.Ugovor = '" & RTrim(TextBox1.Text) & "') AND (Ugovori.VrstaObracuna <> 'RO') " & nmIzborSaobracaja & _
    ...
    Private Sub DataGrid1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.Click
        ...
        Dim ii2 As Int32 = 0
        Dim string2 As String = "SELECT TOP 100 PERCENT CASE dbo.CoAneksi.VlasnistvoKola WHEN '1' THEN 'Sve vrste' ELSE dbo.CoAneksi.VlasnistvoKola END AS [Vlasnistvo], dbo.CoAneksi.VrstaPrevoza, " & _
