...
Module Upis 
    ...
    Friend Sub UpdateMesecUnosa(ByVal ipTrans As SqlTransaction, ByVal mAkcija As String, ByVal _Saobracaj As String, ByVal _Mesec As String, ByVal _Godina As String, ByRef opPovVrednost As String)
        ...
        End Try
    End Sub
    Friend Sub bKorekcijaPoNajaviSlogKalk(ByVal ipTrans As SqlTransaction, ByVal _Akcija As String, _
                                 ByVal _RecID As Integer, _
                                 ByVal _ObrGodina As String, ByVal _ObrMesec As String, _
                                 ByVal _PrevozninaRSD As Decimal, ByVal _PrevozninaEUR As Decimal, _
                                 ByVal _SumaRSD As Decimal, ByVal _SumaEUR As Decimal, _
                                 ByVal _ImaPDV As String, ByVal _PDV As Decimal, _
                                 ByRef opPovVrednost As String)
        ...
        Dim uspKorPoNajaviSlogKalk As New SqlClient.SqlCommand("roba1708.bspKorekcijaPoNajaviSlogKalk", OkpDbVeza)
        uspKorPoNajaviSlogKalk.CommandType = CommandType.StoredProcedure


        Dim inAkcija As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inAkcija", SqlDbType.VarChar, 3, ParameterDirection.Input, False, 0, 0, "", DataRowVersion.Current, _Akcija))
        Dim inRecID As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inRecID", SqlDbType.Int, 1, ParameterDirection.Input, False, 0, 0, "RecID", DataRowVersion.Current, _RecID))
        Dim inObrGodina As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inObrGodina", SqlDbType.Char, 4, ParameterDirection.Input, False, 0, 0, "ObrGodina", DataRowVersion.Current, _ObrGodina))
        Dim inObrMesec As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inObrMesec", SqlDbType.Char, 2, ParameterDirection.Input, False, 0, 0, "ObrMesec", DataRowVersion.Current, _ObrMesec))
        Dim inPrevozninaRSD As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inPrevozninaRSD", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 12, 2, "tlPrevFrDIN", DataRowVersion.Current, _PrevozninaRSD))
        Dim inPrevozninaEUR As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inPrevozninaEUR", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 12, 2, "tlPrevFr", DataRowVersion.Current, _PrevozninaEUR))
        Dim inSumaRSD As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inSumaRSD", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 12, 2, "tlSumaFrDIN", DataRowVersion.Current, _SumaRSD))
        Dim inSumaEUR As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inSumaEUR", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 12, 2, "tlSumaFr", DataRowVersion.Current, _SumaEUR))
        Dim inImaPDV As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inImaPDV", SqlDbType.Char, 1, ParameterDirection.Input, False, 0, 0, "BrojVoza", DataRowVersion.Current, _ImaPDV))
        Dim inPDV As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@inPDV", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 12, 2, "tlNakCO82", DataRowVersion.Current, _PDV))
        Dim RetVal As SqlClient.SqlParameter = uspKorPoNajaviSlogKalk.Parameters.Add(New SqlClient.SqlParameter("@RETURN_VALUE", SqlDbType.Int, 5, ParameterDirection.ReturnValue, True, 0, 0, "", DataRowVersion.Current, ""))

        uspKorPoNajaviSlogKalk.Transaction = ipTrans

        Try
            uspKorPoNajaviSlogKalk.ExecuteNonQuery()
            If uspKorPoNajaviSlogKalk.Parameters("@RETURN_VALUE").Value = 0 Then opPovVrednost = "Ništa nije upisano u tabelu SlogKalk!"
        Catch SQLExp As SqlException
            opPovVrednost = SQLExp.Message      'Greska - SQL greska
        Catch Exp As Exception
            opPovVrednost = Err.Description     'Greska - bilo koja
        Finally
            uspKorPoNajaviSlogKalk.Dispose()
        End Try
    End Sub
    Friend Sub bKorekcijaPoNajaviSlogRoba(ByVal ipTrans As SqlTransaction, ByVal _Akcija As String, _
                                    ByVal _RecID As Integer, ByVal _KolaStavka As Integer, ByVal _RobaStavka As Integer, _
                                    ByVal _RacunskaMasaNHM As Decimal, ByVal _VozarinskiStav As Decimal, _
                                    ByRef opPovVrednost As String)
        ...
        Dim uspKorPoNajaviSlogRoba As New SqlClient.SqlCommand("roba1708.bspKorekcijaPoNajaviSlogRoba", OkpDbVeza)
        uspKorPoNajaviSlogRoba.CommandType = CommandType.StoredProcedure


        Dim inAkcija As SqlClient.SqlParameter = uspKorPoNajaviSlogRoba.Parameters.Add(New SqlClient.SqlParameter("@inAkcija", SqlDbType.VarChar, 3, ParameterDirection.Input, False, 0, 0, "", DataRowVersion.Current, _Akcija))
        Dim inRecID As SqlClient.SqlParameter = uspKorPoNajaviSlogRoba.Parameters.Add(New SqlClient.SqlParameter("@inRecID", SqlDbType.Int, 1, ParameterDirection.Input, False, 0, 0, "RecID", DataRowVersion.Current, _RecID))
        Dim inKolaStavka As SqlClient.SqlParameter = uspKorPoNajaviSlogRoba.Parameters.Add(New SqlClient.SqlParameter("@inKolaStavka", SqlDbType.Int, 1, ParameterDirection.Input, False, 0, 0, "KolaStavka", DataRowVersion.Current, _KolaStavka))
        Dim inRobaStavka As SqlClient.SqlParameter = uspKorPoNajaviSlogRoba.Parameters.Add(New SqlClient.SqlParameter("@inRobaStavka", SqlDbType.Int, 1, ParameterDirection.Input, False, 0, 0, "RobaStavka", DataRowVersion.Current, _RobaStavka))
        Dim inRacunskaMasaNHM As SqlClient.SqlParameter = uspKorPoNajaviSlogRoba.Parameters.Add(New SqlClient.SqlParameter("@inRacunskaMasa", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 12, 2, "RMasa", DataRowVersion.Current, _RacunskaMasaNHM))
        Dim inVozarinskiStav As SqlClient.SqlParameter = uspKorPoNajaviSlogRoba.Parameters.Add(New SqlClient.SqlParameter("@inVozarinskiStav", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 12, 2, "VozStav", DataRowVersion.Current, _VozarinskiStav))
        Dim RetVal As SqlClient.SqlParameter = uspKorPoNajaviSlogRoba.Parameters.Add(New SqlClient.SqlParameter("@RETURN_VALUE", SqlDbType.Int, 5, ParameterDirection.ReturnValue, True, 0, 0, "", DataRowVersion.Current, ""))

        uspKorPoNajaviSlogRoba.Transaction = ipTrans

        Try
            uspKorPoNajaviSlogRoba.ExecuteNonQuery()
            If uspKorPoNajaviSlogRoba.Parameters("@RETURN_VALUE").Value = 0 Then opPovVrednost = "Ništa nije upisano u tabelu SlogRoba!"
        Catch SQLExp As SqlException
            opPovVrednost = SQLExp.Message      'Greska - SQL greska
        Catch Exp As Exception
            opPovVrednost = Err.Description     'Greska - bilo koja
        Finally
            uspKorPoNajaviSlogRoba.Dispose()
        End Try
    End Sub
    Friend Sub bKorekcijaPoNajaviSlogKalkPDV(ByVal inTrans As SqlTransaction, ByVal inmAkcija As String, ByVal inRecID As Int32, _
                        ByVal inPDV1 As Decimal, ByVal inPDV2 As Decimal, _
                        ByRef outPovVrednost As String)
        ...
        Dim uspUpisSlogKalkPDV As New SqlClient.SqlCommand("roba1708.bspKorekcijaPoNajaviSlogKalkPDV", OkpDbVeza)
        ...
        Dim ulAkcija As SqlClient.SqlParameter = uspUpisSlogKalkPDV.Parameters.Add(New SqlClient.SqlParameter("@inAkcija", SqlDbType.VarChar, 3, ParameterDirection.Input, False, 0, 0, "", DataRowVersion.Current, mAkcija))
        Dim ulopRecID As SqlClient.SqlParameter = uspUpisSlogKalkPDV.Parameters.Add(New SqlClient.SqlParameter("@inRecID", SqlDbType.Int, 4, ParameterDirection.Input, False, 0, 0, "RecID", DataRowVersion.Current, inRecID))        
        Dim ulPDV1 As SqlClient.SqlParameter = uspUpisSlogKalkPDV.Parameters.Add(New SqlClient.SqlParameter("@inPDV1", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 0, 0, "PDV1", DataRowVersion.Current, inPDV1))
        Dim ulPDV2 As SqlClient.SqlParameter = uspUpisSlogKalkPDV.Parameters.Add(New SqlClient.SqlParameter("@inPDV2", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 0, 0, "PDV2", DataRowVersion.Current, inPDV2))
    ...
    Friend Sub bNadjiSlogKalkPDV(ByVal inTrans As SqlTransaction, ByVal inRecID As Int32, _
                          ByRef outPovVrednost As String)
        ...
        Dim uspUpisSlogKalkPDV As New SqlClient.SqlCommand("roba1708.bspNadjiSlogKalkPDV", OkpDbVeza)
    ...
    End Sub
    Friend Sub bUpisBlagajnaSaCO(ByVal inTrans As SqlTransaction, ByVal inAkcija As String, ByVal inRecID As Int32, ByVal inStanicaUnosa As String, _
                               ByVal inIznos1 As Decimal, ByVal inIznos2 As Decimal, ByVal inIznos3 As Decimal, ByVal Iznos4 As Decimal, _
                               ByRef opPovVrednost As String)
        ...
        Dim uspUpisBlagajnaSaCO As New SqlClient.SqlCommand("roba1708.bUpisBlagajnaSaCO", OkpDbVeza)

        uspUpisBlagajnaSaCO.CommandType = CommandType.StoredProcedure

        Dim izlRetVal As SqlClient.SqlParameter = uspUpisBlagajnaSaCO.Parameters.Add(New SqlClient.SqlParameter("@RETURN_VALUE", SqlDbType.Int, 5, ParameterDirection.ReturnValue, True, 0, 0, "", DataRowVersion.Current, ""))
        Dim ulAkcija As SqlClient.SqlParameter = uspUpisBlagajnaSaCO.Parameters.Add(New SqlClient.SqlParameter("@inAkcija", SqlDbType.VarChar, 3, ParameterDirection.Input, False, 0, 0, "", DataRowVersion.Current, mAkcija))

        Dim ulRecID As SqlClient.SqlParameter = uspUpisBlagajnaSaCO.Parameters.Add(New SqlClient.SqlParameter("@inRecID", SqlDbType.Int, 4, ParameterDirection.Input, False, 0, 0, "RecID", DataRowVersion.Current, inRecID))
        Dim ulStanicaUnosa As SqlClient.SqlParameter = uspUpisBlagajnaSaCO.Parameters.Add(New SqlClient.SqlParameter("@inStanicaUnosa", SqlDbType.Char, 5, ParameterDirection.Input, False, 0, 0, "Stanica", DataRowVersion.Current, inStanicaUnosa))
        Dim ulIznos1 As SqlClient.SqlParameter = uspUpisBlagajnaSaCO.Parameters.Add(New SqlClient.SqlParameter("@inIznos1", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 0, 0, "Iznos1", DataRowVersion.Current, inIznos1))
        Dim ulIznos2 As SqlClient.SqlParameter = uspUpisBlagajnaSaCO.Parameters.Add(New SqlClient.SqlParameter("@inIznos2", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 0, 0, "Iznos2", DataRowVersion.Current, inIznos1))
        Dim ulIznos3 As SqlClient.SqlParameter = uspUpisBlagajnaSaCO.Parameters.Add(New SqlClient.SqlParameter("@inIznos3", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 0, 0, "Iznos3", DataRowVersion.Current, inIznos1))
        Dim ulIznos4 As SqlClient.SqlParameter = uspUpisBlagajnaSaCO.Parameters.Add(New SqlClient.SqlParameter("@inIznos4", SqlDbType.Decimal, 9, ParameterDirection.Input, False, 0, 0, "Iznos4", DataRowVersion.Current, inIznos1))

        'Dim inStavkaK211 As SqlClient.SqlParameter = uspUpisSlogKola.Parameters.Add(New SqlClient.SqlParameter("@inStavka", SqlDbType.Int, 4, ParameterDirection.Input, False, 0, 0, "Stavka", DataRowVersion.Current, _mStavka))
        'Dim inSifraK211 As SqlClient.SqlParameter = uspUpisSlogKola.Parameters.Add(New SqlClient.SqlParameter("@inSifraK211", SqlDbType.Int, 4, ParameterDirection.Input, False, 0, 0, "SifraK211", DataRowVersion.Current, _mSifraK211))
        'stara verzija polje je bio char(2)
        'Dim inSifraK211 As SqlClient.SqlParameter = uspUpisSlogKola.Parameters.Add(New SqlClient.SqlParameter("@inSifraK211", SqlDbType.Char, 2, ParameterDirection.Input, False, 0, 0, "SifraK211", DataRowVersion.Current, _mSifraK211))
        'Dim inDatumFakturisanja As SqlClient.SqlParameter = uspDatumFakturisanja.Parameters.Add(New SqlClient.SqlParameter("@inDatumFakturisanja", SqlDbType.DateTime, 4, ParameterDirection.Input, False, 0, 0, "DatumFakturisanja", DataRowVersion.Current, _mDatumFakturisanja))

        uspUpisBlagajnaSaCO.Transaction = inTrans

        Try
            uspUpisBlagajnaSaCO.ExecuteNonQuery()
            If uspUpisBlagajnaSaCO.Parameters("@RETURN_VALUE").Value = 0 Then opPovVrednost = "Ništa nije upisano u SlogKalkPlusOKP!"
        Catch SQLExp As SqlException
            opPovVrednost = SQLExp.Message      'Greska - SQL greska
        Catch Exp As Exception
            opPovVrednost = Err.Description     'Greska - bilo koja
        Finally
            uspUpisBlagajnaSaCO.Dispose()
        End Try
