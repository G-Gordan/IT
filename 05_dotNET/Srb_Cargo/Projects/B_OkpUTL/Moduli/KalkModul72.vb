...
Module KalkModul72
    ...
    Public Sub bNadjiPrevozninuCOL(ByRef outPrevoznina As Decimal) 'RSD
        ...
        If ((Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786") Or (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0787")) And _
              ((mStanica1 = "13670" And mStanica2 = "13603") Or (mStanica1 = "13603" And mStanica2 = "13670")) Then
            bHSSmedRadTR = True
        End If
        ...
        If bVrstaSaobracaja = 0 Then                    'RSD
                ...
                If dtKola.Rows.Count > 0 Then
                    ...
                    For Each KolaRed In dtKola.Rows    ' petlja po kolima za RSD
                        ...
                        Else
                            ...
                            'bNadjiMasuIStavGM("122", MasaTemp, bTkm, Razred, MasaTemp, TonskiStav, PV)
                            bNadjiMasuIStavDo25(bStvarnaMasaPoKolima, MasaTemp, TonskiStav)
                            TonskiStavInteger = CType(TonskiStav, Integer)
                        End If
                        ...
                        If (ugRetVal = "") Then
                            ...
                            If mBrojUg = "078600" Or mBrojUg = "078700" Then                  ' dok se ne sredi RSD - EUR cene i vrste obracuna
                                PrevozninaPoKolima = PrevozninaPoKolima * bKurs
                                bZaokruziNaDeseteNavise(PrevozninaPoKolima)
                            End If
                            ...
                            If ugTipCene <> 10 And Not (bSmartCargoSmedRadTR) And Not (bHSSmedRadTR) Then
                                If PrevozninaPoKolima < bMinPrevoznina Then
                                    PrevozninaPoKolima = bMinPrevoznina
                                End If
                            End If
            ...
            ElseIf mVrstaPrevoza = "G" Or mVrstaPrevoza = "V" Then
                ...
                If bNarocitaPosiljka Then
                    ugUslovZaStav = 19
                Else
                    ugUslovZaStav = 1       ' formalno; treba do 25t
                    'bNadjiMasuIStavGM("122", MasaTemp, bTkm, Razred, MasaTemp, TonskiStav, PV)
                    bNadjiMasuIStavDo25(bStvarnaMasaPoPosiljci / dtKola.Rows.Count, MasaTemp, TonskiStav)
                    TonskiStavInteger = CType(TonskiStav, Integer)
                End If
                ...
                If (ugRetVal = "") Then
                    ...
                    ' dok se ne unesu izracunati stavovi za privatna kola
                    If (Microsoft.VisualBasic.Left(mBrojUg, 4) = "0786" Or Microsoft.VisualBasic.Left(mBrojUg, 4) = "0787") And Vlasnistvo = "P" And ugCena <> 0 Then
                        Dim bAneksTg As String = ""
                        Dim ugCena1, ugTipCene1, sqlVlasnistvoKola1 ' formalno
                        Dim nmBMV1 As Int32 = 0
                        ...
                        ' bez poziva na broj Tg
                        'ugCena = 0.9 * ugCena                                  ne treba; uneta cena rucno
                        'bZaokruziNaDeseteNavise(ugCena)
                    End If
                End If
                ...
                If mPrevoznina < bMinPrevoznina * dtKola.Rows.Count And Not (bSmartCargoSmedRadTR) And Not (bHSSmedRadTR) Then              'za vise kola
                ...
                ''''''    'nema ni kola ni prevoznine
                ''''''End If
                Dim RacMasaFormalna As Decimal = (bStvarnaMasaPoPosiljci / dtKola.Rows.Count)

                bZaokruziMasuNa100k(RacMasaFormalna)
                ...
                If dtKola.Rows.Count > 0 Then                             ' ako su ispravno upisana bar jedna kola
                    For Each KolaRed In dtKola.Rows                            ' petlja po kolima - pocetak
                        ...
                        For Each NHMRed In dtNhm.Rows   '  petlja po robi za racunske mase
                            If NHMRed.Item("IndBrojKola") = IBK Then
                                dtNhm.Rows(0).Item("RacMasaNHM") = 0
                                NHMRed.Item("VozarinskiStavNHM") = 0
                            End If
                        Next
                        'KolaRed.Item("Prevoznina") = outPrevoznina
                        KolaRed.Item("RacunskaMasa") = 0
                ...
                If dtKola.Rows.Count > 0 Then                             ' ako su ispravno upisana bar jedna kola
                    For Each KolaRed In dtKola.Rows                            ' petlja po kolima - pocetak
                        ...
                        For Each NHMRed In dtNhm.Rows   '  petlja po robi za racunske mase
                            If NHMRed.Item("IndBrojKola") = IBK Then
                                dtNhm.Rows(0).Item("RacMasaNHM") = RacMasaZaAneks           ' zaokruzena ukupna samo na prvoj masi
                                NHMRed.Item("VozarinskiStavNHM") = ugCena
                            End If
                        Next
                        'KolaRed.Item("Prevoznina") = outPrevoznina
                        KolaRed.Item("RacunskaMasa") = RacMasaFormalna
                        KolaRed.Item("VozarinskiStav") = ugCena
                    Next                                                        ' petlja po kolima - kraj
                    ...
                    For Each KolaRed In dtKola.Rows    ' petlja po kolima
                        ...
                        For Each NHMRed In dtNhm.Rows   '  petlja po robi
                            If NHMRed.Item("IndBrojKola") = IBK Then
                                ...
                                ' ??? 1.3.2017
                                If MasaTemp <> BrOsovina * 5000 Then
                                    MasaTemp = BrOsovina * 5000
                                End If
                                ' ??? 1.3.2017
                        ...
                        If (Left(mBrojUg, 4) = "0786" Or Left(mBrojUg, 4) = "0787") And Vlasnistvo = "P" And ugCena <> 0 Then
                            Dim bAneksTg As String = ""
                            Dim ugCena1, ugTipCene1, sqlVlasnistvoKola1 ' formalno
                        ...
                        If (ugRetVal = "") Then
                            ...
                            ' ??? 1.3.2017
                            If mBrojUg = "028600" And ugTipCene = 2 Then
                                If RacMasaZaAneks < BrOsovina * 5000 Then
                                    RacMasaZaAneks = BrOsovina * 5000
                                End If
                            End If
                            ' ??? 1.3.2017
                        ...
                        If (ugTipCene <> 5 And ugTipCene <> 10 And ugTipCene <> 15 And ugTipCene <> 26) And Not (bSmartCargoSmedRadTR) And Not (bHSSmedRadTR) Then
                            If PrevozninaPoKolima <= bMinPrevoznina Then
                                PrevozninaPoKolima = bMinPrevoznina
                            End If
                        End If
            ...
            ElseIf mVrstaPrevoza = "G" Or mVrstaPrevoza = "V" Then
                ...
                If (ugRetVal = "") Then
                    ...
                    If Microsoft.VisualBasic.Left(mBrojUg, 4) = "0286" And Vlasnistvo = "P" And ugCena <> 0 Then
                        ...
                        bNadjiTg(mBrojUg, bbbbSaobr, mStanica1, mStanica2, _
                                       BrOsovina, mVrstaPrevoza, Vlasnistvo, bStitna, _
                                       mDatumKalk, nmBMV1, Microsoft.VisualBasic.Left(NHMTemp, 4), _
                                       ugUslovZaStav, ugCena1, ugTipCene1, sqlVlasnistvoKola1, bAneksTg, ugRetVal)
                    ...
                    If mBrojUg = "078601" Or mBrojUg = "078602" Or mBrojUg = "078701" Or mBrojUg = "078702" Or mBrojUg = "028601" Or mBrojUg = "028602" Then
                        RacMasaZaAneks = bStvarnaMasaPoPosiljci
                        bZaokruziMasuNa100k(RacMasaZaAneks)
                    End If
                    ...
                    bRacunskaMasaPoKolima = RacMasaZaAneks / dtKola.Rows.Count
                    bZaokruziMasuNa100k(bRacunskaMasaPoKolima)
    ...
    Public Sub bKorigujPoAneksu(ByVal inVrstaKorekcije As Integer, ByVal inPrevoznina As Decimal, ByVal inKoeficijent As Decimal, _
        ...
        Select Case inVrstaKorekcije
            ...
            Case 2, 3, 12, 13, 26    'Cena po toni, Cena po toni za stvarnu masu, cena po tonskom stavu                              
