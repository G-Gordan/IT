...
Public Class Unut26
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IzvestajiOKP.Unut2.6..rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_računski_mesec() As CrystalDecisions.[Shared].IParameterField
        Get
