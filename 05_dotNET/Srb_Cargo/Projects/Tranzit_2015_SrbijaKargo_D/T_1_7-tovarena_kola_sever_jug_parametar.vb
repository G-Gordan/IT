...
Public Class T_1_7_tovarena_kola_sever_jug_parametar
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "T_1_7-tovarena_kola_sever_jug_parametar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Stanice.T_1_7-tovarena_kola_sever_jug_parametar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Godina() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ugovor() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RacMesec2() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_godina2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedT_1_7_tovarena_kola_sever_jug_parametar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As T_1_7_tovarena_kola_sever_jug_parametar = New T_1_7_tovarena_kola_sever_jug_parametar
        rpt.Site = Me.Site
        Return rpt
    End Function
