...
Public Class Pogresan_unos_ili_obradapodataka_v
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Pogresan unos ili obradapodataka_v.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Stanice.Pogresan unos ili obradapodataka_v.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Mesec1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPogresan_unos_ili_obradapodataka_v
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pogresan_unos_ili_obradapodataka_v = New Pogresan_unos_ili_obradapodataka_v
        rpt.Site = Me.Site
        Return rpt
    End Function
