...
Public Class T_DATUMI_OBRADE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Stanice.T_DATUMI OBRADE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedT_DATUMI_OBRADE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As T_DATUMI_OBRADE = New T_DATUMI_OBRADE
        rpt.Site = Me.Site
        Return rpt
    End Function
