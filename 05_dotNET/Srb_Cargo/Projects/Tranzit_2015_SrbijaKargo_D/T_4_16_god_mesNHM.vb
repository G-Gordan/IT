...
Public Class T_4_16_god_mesNHM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Stanice.T_4_16_god_mesNHM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedT_4_16_god_mesNHM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As T_4_16_god_mesNHM = New T_4_16_god_mesNHM
        rpt.Site = Me.Site
        Return rpt
    End Function
