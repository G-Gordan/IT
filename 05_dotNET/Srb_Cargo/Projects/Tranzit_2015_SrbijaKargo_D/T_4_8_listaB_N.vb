...
Public Class T_4_8_listaB_N
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Stanice.T_4_8_listaB_N.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedT_4_8_listaB_N
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As T_4_8_listaB_N = New T_4_8_listaB_N
        rpt.Site = Me.Site
        Return rpt
    End Function
