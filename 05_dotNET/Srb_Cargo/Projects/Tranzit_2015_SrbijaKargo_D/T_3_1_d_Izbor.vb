...
Public Class T_3_1_d_Izbor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Stanice.T_3_1_d_Izbor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedT_3_1_d_Izbor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As T_3_1_d_Izbor = New T_3_1_d_Izbor
        rpt.Site = Me.Site
        Return rpt
    End Function
