...
Public Class IzvozVanRaspnnn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UnK140K165.IzvozVanRaspnnn.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_God() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedIzvozVanRaspnnn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IzvozVanRaspnnn = New IzvozVanRaspnnn
        rpt.Site = Me.Site
        Return rpt
    End Function
