...
Select *into PrivTabDatumM from TabDatumM where left(Ugovor,4)='3406'
Select * from PrivTabDatumM

Update PrivTabDatumM
Set Ugovor ='580600',DatumOD='01/01/2006',DatumDo='1/31/2007'
Select * from PrivTabDatumM
...
Select * from TabDatumM where left(Ugovor,4)='5806'
--uklanjanje privremene tabele
...
Select * from TabMase where Ugovor='340602' and siftab='191'
Select *into PrivTabMase from TabMase where Ugovor='340602' and siftab='191'
...
--!!! Treba izvrsiti samo ovaj kod
	Insert into TabMase
	Select * from PrivTabMase
Select * from TabMase where Ugovor = '580602'
--uklanjanje privremene tabele
Drop table PrivTabMase


--5. Izmena podataka u tabeli TabRel
Select * into PrivTabRel from TabRel where Ugovor='340602' and siftab='191'
...
Select * from TabRel where Ugovor = '080668'


--6. Izmena podataka u tabeli TabStavR

Select * into PrivTabStavR from TabStavR where Ugovor='340601' and siftab='211'
