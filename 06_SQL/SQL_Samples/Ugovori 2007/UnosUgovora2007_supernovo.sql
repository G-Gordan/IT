...
Select * into _TabNaziv from TabNaziv where Substring(Ugovor,1,4)= '0507'
...
Select * into _SifTabCen from SifTabCen where Substring(Ugovor,1,4)='0507'
...
Select * into _TabDatumM from TabDatumM where Substring(Ugovor,1,4)='0507'
...
Drop table _TabMase
Select * into _TabMase from TabMase where Substring(Ugovor,1,4)= '0507'
