SELECT     TOP 100 PERCENT dbo.SlogKalk.Najava AS NAJAVA, dbo.SlogKalk.Ugovor AS UGOVOR, SUM(dbo.SlogKalk.tlPrevFr) AS PREVOZNINA, 
                      ...
                      AS NETO, COUNT(dbo.SlogKola.KolaStavka) AS KOLA, dbo.SlogKalk.ZsUlPrelaz, dbo.SlogKalk.ZsIzPrelaz
...
GROUP BY dbo.SlogKalk.ObrMesec, dbo.SlogKalk.Najava, dbo.SlogKalk.Ugovor, dbo.SlogKalk.ZsUlPrelaz, dbo.SlogKalk.ZsIzPrelaz
