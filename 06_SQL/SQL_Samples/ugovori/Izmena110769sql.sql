...
Select * from TabNaziv where Ugovor ='110669'
Select * into PrivTabNaziv from TabNaziv where Ugovor='100769'
...
Select * from TabNaziv where Ugovor='110769'
...
Select *into PrivSifTabCen from SifTabCen where Ugovor='100769'--Substring(ugovor,1,4)=1006
Select * from PrivSifTabCen

Update PrivSifTabCen
Set Ugovor ='110769',VaziOD='01/01/2007',VaziDo='12/31/2007'
Select * from PrivSifTabCen
	--!!! Treba izvrsiti samo ovaj kod
	Insert into SifTabCen
	Select * from PrivSifTabCen 
--provera upisa podataka
Select * from SifTabCen where Ugovor='110769'
--uklanjanje privremene tabele
Drop table PrivSifTabCen

--3. Izmena podataka u tabeli TabDatumM
--Select * from TabDatumM where Ugovor='110600'
Select *into PrivTabDatumM from TabDatumM where Ugovor='100769'--Substring(ugovor,1,4)=1006
Select * from PrivTabDatumM

Update PrivTabDatumM
Set Ugovor ='110769',DatumOD='01/01/2007',DatumDo='12/31/2007'
Select * from PrivTabDatumM
...
Select * from TabDatumM where Ugovor='110769'
--uklanjanje privremene tabele
Drop table PrivTabDatumM

--4. Izmena podataka u tabeli TabMase
Select * from TabMase where Ugovor='110669'
Select *into PrivTabMase from TabMase where Ugovor='100769'--Substring(ugovor,1,4)=1006
...
kod
	Insert into TabMase
	Select * from PrivTabMase
Select * from TabMase where Ugovor = '110769'
--uklanjanje privremene tabele
Drop table PrivTabMase


--5. Izmena podataka u tabeli TabRel
Select *into PrivTabRel from TabRel where Ugovor='100769'--substring(ugovor,1,4)=1006
...
Select * from TabRel where Ugovor = '110769'


--6. Izmena podataka u tabeli TabStavR

Select *into PrivTabStavR from TabStavR where Ugovor='100769'--Substring(ugovor,1,4)=1006
