...
Select * from TabNaziv where Ugovor ='120669'
...
Select * from TabNaziv where Ugovor='120769'
...
Set Ugovor ='120769',VaziOD='01/01/2007',VaziDo='12/31/2007'
Select * from PrivSifTabCen
	--!!! Treba izvrsiti samo ovaj kod
	Insert into SifTabCen
	Select * from PrivSifTabCen 
--provera upisa podataka
Select * from SifTabCen where Ugovor='120769'
--uklanjanje privremene tabele
...
Set Ugovor ='120769',DatumOD='01/01/2007',DatumDo='12/31/2007'
Select * from PrivTabDatumM
...
Select * from TabDatumM where Ugovor='120769'
--uklanjanje privremene tabele
Drop table PrivTabDatumM

--4. Izmena podataka u tabeli TabMase
Select * from TabMase where Ugovor='120669'
...
kod
	Insert into TabMase
	Select * from PrivTabMase
Select * from TabMase where Ugovor = '120769'
--uklanjanje privremene tabele
...
Select * from TabRel where Ugovor = '120769'
