...
Select * into PrivTabNaziv from TabNaziv where Ugovor='110600'
...
Select * from TabNaziv where Ugovor='120700'
...
Set Ugovor ='120700',VaziOD='01/01/2007',VaziDo='12/31/2007'
Select * from PrivSifTabCen
	--!!! Treba izvrsiti samo ovaj kod
	Insert into SifTabCen
	Select * from PrivSifTabCen 
--provera upisa podataka
Select * from SifTabCen where Ugovor='120700'
--uklanjanje privremene tabele
...
Set Ugovor ='120700',DatumOD='01/01/2007',DatumDo='12/31/2007'
Select * from PrivTabDatumM
...
Select * from TabDatumM where Ugovor='120700'
--uklanjanje privremene tabele
Drop table PrivTabDatumM

--4. Izmena podataka u tabeli TabMase
Select * from TabMase where Ugovor='120600'
...
kod
	Insert into TabMase
	Select * from PrivTabMase
Select * from TabMase where Ugovor = '120700'
--uklanjanje privremene tabele
...
Select * from TabRel where Ugovor = '120700'
...
--!!! Treba izvrsiti samo ovaj kod
	...
	Select * from PrivTabStavR
Select * from TabStavR where Ugovor='120700'
